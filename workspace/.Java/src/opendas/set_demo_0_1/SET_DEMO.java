...
/**
 * Job: SET_DEMO Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class SET_DEMO implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (hostActiveMQ != null) {

				this.setProperty("hostActiveMQ", hostActiveMQ.toString());
		...
		public String hostActiveMQ;

		public String getHostActiveMQ() {
			return this.hostActiveMQ;
		}
	...
	private final String jobName = "SET_DEMO";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SET_DEMO.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_OPENDAS_SET_DEMO = new byte[0];
		static byte[] commonByteArray_OPENDAS_SET_DEMO = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_OPENDAS_SET_DEMO.length) {
					if (length < 1024
							&& commonByteArray_OPENDAS_SET_DEMO.length == 0) {
						commonByteArray_OPENDAS_SET_DEMO = new byte[1024];
					} else {
						commonByteArray_OPENDAS_SET_DEMO = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_OPENDAS_SET_DEMO, 0, length);
				strReturn = new String(commonByteArray_OPENDAS_SET_DEMO, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_OPENDAS_SET_DEMO) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "/home/opendas/workspace/opendas/talend/Jobs/config/SET_demo.conf";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/home/opendas/workspace/opendas/talend/Jobs/config/SET_demo.conf",
								"ISO-8859-15", ";", "\n", true, 0, 0, -1, -1,
								false);
							...
							if (tmp_key_tContextLoad_1 != null) {
								try {
									if (key_tContextLoad_1 != null
										...
										context.hostActiveMQ = value_tContextLoad_1;
									}
					...
					if (!((Object) ("/home/opendas/workspace/opendas/talend/Jobs/config/SET_demo.conf") instanceof java.io.InputStream)) {
	...
	public static class picking_in_validStruct implements
			routines.system.IPersistableRow<picking_in_validStruct> {
		final static byte[] commonByteArrayLock_OPENDAS_SET_DEMO = new byte[0];
		static byte[] commonByteArray_OPENDAS_SET_DEMO = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(picking_in_validStruct other) {
	...
	public static class signinoutStruct implements
			routines.system.IPersistableRow<signinoutStruct> {
		final static byte[] commonByteArrayLock_OPENDAS_SET_DEMO = new byte[0];
		static byte[] commonByteArray_OPENDAS_SET_DEMO = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(signinoutStruct other) {
	...
	public static class picking_out_validStruct implements
			routines.system.IPersistableRow<picking_out_validStruct> {
		final static byte[] commonByteArrayLock_OPENDAS_SET_DEMO = new byte[0];
		static byte[] commonByteArray_OPENDAS_SET_DEMO = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(picking_out_validStruct other) {
	...
	public static class picking_out_qty_validStruct implements
			routines.system.IPersistableRow<picking_out_qty_validStruct> {
		final static byte[] commonByteArrayLock_OPENDAS_SET_DEMO = new byte[0];
		static byte[] commonByteArray_OPENDAS_SET_DEMO = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(picking_out_qty_validStruct other) {
	...
	public void tMomObjectInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				picking_in_validStruct picking_in_valid = new picking_in_validStruct();
				row3Struct row3 = new row3Struct();
				signinoutStruct signinout = new signinoutStruct();
				row2Struct row2 = new row2Struct();
				picking_out_validStruct picking_out_valid = new picking_out_validStruct();
				row4Struct row4 = new row4Struct();
				picking_out_qty_validStruct picking_out_qty_valid = new picking_out_qty_validStruct();
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("picking_in_valid"
								+ iterateId, 0, 0);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("signinout" + iterateId,
								0, 0);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("picking_out_valid"
								+ iterateId, 0, 0);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("picking_out_qty_valid"
								+ iterateId, 0, 0);
				...
				signinoutStruct signinout_tmp = new signinoutStruct();
				picking_in_validStruct picking_in_valid_tmp = new picking_in_validStruct();
				picking_out_validStruct picking_out_valid_tmp = new picking_out_validStruct();
				picking_out_qty_validStruct picking_out_qty_valid_tmp = new picking_out_qty_validStruct();
				// ###############################
				...
				while ((message_tMomObjectInput_1 = consumer_tMomObjectInput_1
					...
					{ // start of Var scope
						...
						signinout = null;
						picking_in_valid = null;
						picking_out_valid = null;
						picking_out_qty_valid = null;

						// # Output table : 'signinout'
						// # Filter conditions
						if (

						"signinout".equals(row6.title)

						) {
							signinout_tmp.title = row6.title;
							signinout_tmp.sendUrl = row6.sendUrl;
							signinout_tmp.fromUrl = row6.fromUrl;
							signinout_tmp.sendedDate = row6.sendedDate;
							signinout_tmp.attachement = row6.attachement;
							signinout_tmp.station = row6.station;
							signinout_tmp.title_out = row6.title_out;
							signinout_tmp.send_out = row6.send_out;
							signinout_tmp.from_out = row6.from_out;
							signinout_tmp.sendedDate_out = row6.sendedDate_out;
							signinout_tmp.attachement_out = row6.attachement_out;
							signinout_tmp.station_out = row6.station_out;
							signinout = signinout_tmp;
						} // closing filter/reject

						// # Output table : 'picking_in_valid'
						// # Filter conditions
						if (

						"picking_in_valid".equals(row6.title)

						) {
							picking_in_valid_tmp.title = row6.title;
							picking_in_valid_tmp.sendUrl = row6.sendUrl;
							picking_in_valid_tmp.fromUrl = row6.fromUrl;
							picking_in_valid_tmp.sendedDate = row6.sendedDate;
							picking_in_valid_tmp.attachement = row6.attachement;
							picking_in_valid_tmp.station = row6.station;
							picking_in_valid_tmp.title_out = row6.title_out;
							picking_in_valid_tmp.send_out = row6.send_out;
							picking_in_valid_tmp.from_out = row6.from_out;
							picking_in_valid_tmp.sendedDate_out = row6.sendedDate_out;
							picking_in_valid_tmp.attachement_out = row6.attachement_out;
							picking_in_valid_tmp.station_out = row6.station_out;
							picking_in_valid = picking_in_valid_tmp;
						} // closing filter/reject

						// # Output table : 'picking_out_valid'
						// # Filter conditions
						if (

						"picking_out_valid".equals(row6.title)

						) {
							picking_out_valid_tmp.title = row6.title;
							picking_out_valid_tmp.sendUrl = row6.sendUrl;
							picking_out_valid_tmp.fromUrl = row6.fromUrl;
							picking_out_valid_tmp.sendedDate = row6.sendedDate;
							picking_out_valid_tmp.attachement = row6.attachement;
							picking_out_valid_tmp.station = row6.station;
							picking_out_valid_tmp.title_out = row6.title_out;
							picking_out_valid_tmp.send_out = row6.send_out;
							picking_out_valid_tmp.from_out = row6.from_out;
							picking_out_valid_tmp.sendedDate_out = row6.sendedDate_out;
							picking_out_valid_tmp.attachement_out = row6.attachement_out;
							picking_out_valid_tmp.station_out = row6.station_out;
							picking_out_valid = picking_out_valid_tmp;
						} // closing filter/reject

						// # Output table : 'picking_out_qty_valid'
						// # Filter conditions
						if (

						"picking_out_qty_valid".equals(row6.title)

						) {
							picking_out_qty_valid_tmp.title = row6.title;
							picking_out_qty_valid_tmp.sendUrl = row6.sendUrl;
							picking_out_qty_valid_tmp.fromUrl = row6.fromUrl;
							picking_out_qty_valid_tmp.sendedDate = row6.sendedDate;
							picking_out_qty_valid_tmp.attachement = row6.attachement;
							picking_out_qty_valid_tmp.station = row6.station;
							picking_out_qty_valid_tmp.title_out = row6.title_out;
							picking_out_qty_valid_tmp.send_out = row6.send_out;
							picking_out_qty_valid_tmp.from_out = row6.from_out;
							picking_out_qty_valid_tmp.sendedDate_out = row6.sendedDate_out;
							picking_out_qty_valid_tmp.attachement_out = row6.attachement_out;
							picking_out_qty_valid_tmp.station_out = row6.station_out;
							picking_out_qty_valid = picking_out_qty_valid_tmp;
						} // closing filter/reject
							// ###############################
					 ...
					 * [tMap_179 main ] stop
					 */
					// Start of branch "picking_in_valid"
					if (picking_in_valid != null) {
						...
						consoleOut_tXMLRPCOpenDAS_2.println("tXMLRPCOpenDAS_2"
								+ " received parameters : "
								+ picking_in_valid.toString());
						consoleOut_tXMLRPCOpenDAS_2.flush();

						// Retrieving input parameters (These parameters come
						// from tMomObjectInput)
						String title_tXMLRPCOpenDAS_2 = picking_in_valid.title;
						String sendUrl_tXMLRPCOpenDAS_2 = picking_in_valid.sendUrl;
						String fromUrl_tXMLRPCOpenDAS_2 = picking_in_valid.fromUrl;
						Date sendedDate_tXMLRPCOpenDAS_2 = picking_in_valid.sendedDate;
						String station_tXMLRPCOpenDAS_2 = picking_in_valid.station;
						java.util.Map checkingMap = (java.util.Map) picking_in_valid.attachement;
						...
						for (int i = 0; i < tab.length; i++) {
							...
							if ("product".equals(tab[i])) {
								vals.put("product_ids", checkingMap.get(tab[i]));
							}
						}
						...
						try {
							...
							redstone.xmlrpc.XmlRpcStruct responsetXMLRPCOpenDAS_2 = (redstone.xmlrpc.XmlRpcStruct) connexiontXMLRPCOpenDAS_2
									.exec("stock.picking", "talend_picking_in",
											vals, context_search);
						...
						for (int i_tXMLRPCOpenDAS_2 = 0; i_tXMLRPCOpenDAS_2 < results_tXMLRPCOpenDAS_2.length; i_tXMLRPCOpenDAS_2++) {
							...
							if (0 < results_tXMLRPCOpenDAS_2.length
								...
								row3.title = (String) results_tXMLRPCOpenDAS_2[0];
							...
							if (1 < results_tXMLRPCOpenDAS_2.length
								...
								row3.sendUrl = (String) results_tXMLRPCOpenDAS_2[1];
							...
							if (2 < results_tXMLRPCOpenDAS_2.length
								...
								row3.fromUrl = (String) results_tXMLRPCOpenDAS_2[2];
							...
							if (3 < results_tXMLRPCOpenDAS_2.length
								...
								row3.sendedDate = (Date) results_tXMLRPCOpenDAS_2[3];
							...
							if (4 < results_tXMLRPCOpenDAS_2.length
								...
								row3.attachement = (Object) results_tXMLRPCOpenDAS_2[4];
							...
							if (5 < results_tXMLRPCOpenDAS_2.length
								...
								row3.station = (String) results_tXMLRPCOpenDAS_2[5];
							...
							if (6 < results_tXMLRPCOpenDAS_2.length
								...
								row3.title_out = (String) results_tXMLRPCOpenDAS_2[6];
							...
							if (7 < results_tXMLRPCOpenDAS_2.length
								...
								row3.send_out = (String) results_tXMLRPCOpenDAS_2[7];
							...
							if (8 < results_tXMLRPCOpenDAS_2.length
								...
								row3.from_out = (String) results_tXMLRPCOpenDAS_2[8];
							...
							if (9 < results_tXMLRPCOpenDAS_2.length
								...
								row3.sendedDate_out = (Date) results_tXMLRPCOpenDAS_2[9];
							...
							if (10 < results_tXMLRPCOpenDAS_2.length
								...
								row3.attachement_out = (Object) results_tXMLRPCOpenDAS_2[10];
							...
							if (11 < results_tXMLRPCOpenDAS_2.length
								...
								row3.station_out = (String) results_tXMLRPCOpenDAS_2[11];
					...
					} // End of branch "picking_in_valid"

					// Start of branch "signinout"
					if (signinout != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection("signinout"
									+ iterateId, 1, 1);
						}
						...
						// Retrieving input parameters (These parameters come
						// from tMomObjectInput)
						String title_tXMLRPCOpenDAS_1 = signinout.title;
						String sendUrl_tXMLRPCOpenDAS_1 = signinout.sendUrl;
						String fromUrl_tXMLRPCOpenDAS_1 = signinout.fromUrl;
						Date sendedDate_tXMLRPCOpenDAS_1 = signinout.sendedDate;
						String station_tXMLRPCOpenDAS_1 = signinout.station;
						java.util.Map checkingMap = (java.util.Map) signinout.attachement;

						Object[] tab = checkingMap.keySet().toArray();
						redstone.xmlrpc.XmlRpcStruct vals = new redstone.xmlrpc.XmlRpcStruct();
						for (int i = 0; i < tab.length; i++) {
							if ("employee".equals(tab[i])) {
					...
					} // End of branch "signinout"

					// Start of branch "picking_out_valid"
					if (picking_out_valid != null) {
						...
						consoleOut_tXMLRPCOpenDAS_3.println("tXMLRPCOpenDAS_3"
								+ " received parameters : "
								+ picking_out_valid.toString());
						consoleOut_tXMLRPCOpenDAS_3.flush();

						// Retrieving input parameters (These parameters come
						// from tMomObjectInput)
						String title_tXMLRPCOpenDAS_3 = picking_out_valid.title;
						String sendUrl_tXMLRPCOpenDAS_3 = picking_out_valid.sendUrl;
						String fromUrl_tXMLRPCOpenDAS_3 = picking_out_valid.fromUrl;
						Date sendedDate_tXMLRPCOpenDAS_3 = picking_out_valid.sendedDate;
						String station_tXMLRPCOpenDAS_3 = picking_out_valid.station;
						java.util.Map checkingMap = (java.util.Map) picking_out_valid.attachement;
					...
					} // End of branch "picking_out_valid"

					// Start of branch "picking_out_qty_valid"
					if (picking_out_qty_valid != null) {
						...
						// picking_out_qty_valid
						// picking_out_qty_valid

						if (execStat) {
							runStat.updateStatOnConnection(
									"picking_out_qty_valid" + iterateId, 1, 1);
						}
						...
						consoleOut_tXMLRPCOpenDAS_4.println("tXMLRPCOpenDAS_4"
								+ " received parameters : "
								+ picking_out_qty_valid.toString());
						consoleOut_tXMLRPCOpenDAS_4.flush();

						// Retrieving input parameters (These parameters come
						// from tMomObjectInput)
						String title_tXMLRPCOpenDAS_4 = picking_out_qty_valid.title;
						String sendUrl_tXMLRPCOpenDAS_4 = picking_out_qty_valid.sendUrl;
						String fromUrl_tXMLRPCOpenDAS_4 = picking_out_qty_valid.fromUrl;
						Date sendedDate_tXMLRPCOpenDAS_4 = picking_out_qty_valid.sendedDate;
						String station_tXMLRPCOpenDAS_4 = picking_out_qty_valid.station;
						java.util.Map checkingMap = (java.util.Map) picking_out_qty_valid.attachement;
						...
						for (int i = 0; i < tab.length; i++) {
							...
							if ("product_qty".equals(tab[i])) {
								vals.put("product_qty", checkingMap.get(tab[i]));
							}
						}
						// Initialization output parameters
						...
						Object[] results_tXMLRPCOpenDAS_4 = {
								...
								picking_out_qty_valid.attachement,
					...
					} // End of branch "picking_out_qty_valid"
	...
	public static void main(String[] args) {
		final SET_DEMO SET_DEMOClass = new SET_DEMO();

		int exitCode = SET_DEMOClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SET_DEMO.class.getClassLoader()
					.getResourceAsStream(
							"opendas/set_demo_0_1/contexts/" + contextStr
									+ ".properties");
			...
			context.hostActiveMQ = (String) context.getProperty("hostActiveMQ");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("hostActiveMQ")) {
				context.hostActiveMQ = (String) parentContextMap
						.get("hostActiveMQ");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SET_DEMO");
		}
...
/************************************************************************************************
 * 185471 characters generated by Talend Open Studio for Data Integration on the
 * 2 mars 2015 14:40:50 CET
 ************************************************************************************************/
