...
public class GET implements TalendJob {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_OPENDAS_GET = new byte[0];
		static byte[] commonByteArray_OPENDAS_GET = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_OPENDAS_GET.length) {
					if (length < 1024
							&& commonByteArray_OPENDAS_GET.length == 0) {
						commonByteArray_OPENDAS_GET = new byte[1024];
					} else {
						commonByteArray_OPENDAS_GET = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_OPENDAS_GET, 0, length);
				strReturn = new String(commonByteArray_OPENDAS_GET, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_OPENDAS_GET) {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("bl_odoo_report"
								+ iterateId, 0, 0);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("odoo_dt" + iterateId,
								0, 0);
				...
				while ((message_tMomObjectInput_1 = consumer_tMomObjectInput_1
					...
					if (getWsGenericsExt != null) {
						...
						if (magento_dt != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection("magento_dt"
										+ iterateId, 1, 1);
							}
						...
						if (odoo_dt != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection("odoo_dt"
										+ iterateId, 1, 1);
							}
...
/************************************************************************************************
 * 494231 characters generated by Talend Open Studio for Data Integration on the
 * 29 septembre 2014 15:06:19 CEST
 ************************************************************************************************/
