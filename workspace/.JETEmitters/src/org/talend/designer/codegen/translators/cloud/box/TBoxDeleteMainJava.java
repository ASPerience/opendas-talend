...
public class TBoxDeleteMainJava
{
  ...
  protected final String TEXT_39 = "_boxItem = null;" + NL + "\t\t";
  protected final String TEXT_40 = "_boxItem = searchItem(";
  protected final String TEXT_41 = "_client, ";
  protected final String TEXT_42 = "_remoteFileName);" + NL + "\t\tif (";
  protected final String TEXT_43 = "_boxItem == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new Exception(\"Nothing found under path \" + ";
  protected final String TEXT_44 = "_filePath);" + NL + "\t\t}" + NL + "\t\tif (";
  protected final String TEXT_45 = "_boxItem.getType().equalsIgnoreCase(\"file\"))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_46 = "_client.getFilesManager().deleteFile(";
  protected final String TEXT_47 = "_boxItem.getId(), null);" + NL + "\t\t}" + NL + "\t\telse if (";
  protected final String TEXT_48 = "_boxItem.getType().equalsIgnoreCase(\"folder\"))" + NL + "\t\t{" + NL + "\t\t\tcom.box.boxjavalibv2.requests.requestobjects.BoxFolderDeleteRequestObject ";
  protected final String TEXT_49 = "_delObject = com.box.boxjavalibv2.requests.requestobjects.BoxFolderDeleteRequestObject.deleteFolderRequestObject(true);" + NL + "\t       \t";
  protected final String TEXT_50 = "_client.getFoldersManager().deleteFolder(";
  protected final String TEXT_51 = "_boxItem.getId(), ";
  protected final String TEXT_52 = "_delObject);" + NL + "\t\t}" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_53 = "_REMOVED_PATH\", getBoxItemPath(";
  protected final String TEXT_54 = "_boxItem));" + NL + "" + NL + "\t\t\t";
