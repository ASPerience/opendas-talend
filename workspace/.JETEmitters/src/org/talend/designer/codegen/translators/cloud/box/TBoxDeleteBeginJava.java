...
public class TBoxDeleteBeginJava
{
  ...
  protected final String TEXT_42 = "_client = null;" + NL + "\tif(globalMap.get(\"delete_";
  ...
  protected final String TEXT_68 = "_map));" + NL + "\t\t\tglobalMap.put(\"delete_";
  protected final String TEXT_69 = "\", ";
  protected final String TEXT_70 = "_client);" + NL + "\t\t}" + NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_71 = "_client = (com.box.boxjavalibv2.BoxClient)globalMap.get(\"delete_";
