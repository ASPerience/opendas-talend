...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_37 = NL + "\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");\t" + NL + "\t";
  ...
  protected final String TEXT_41 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_42 = " + \":\" + ";
  protected final String TEXT_43 = " + \":\" + ";
  protected final String TEXT_44 = ";" + NL + "\t\t";
  protected final String TEXT_45 = NL + "\t\turl_";
  protected final String TEXT_46 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_47 = " + \")(port=\" + ";
  protected final String TEXT_48 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_49 = " + \")))\";" + NL + "\t\t";
  protected final String TEXT_50 = NL + "\t    url_";
  protected final String TEXT_51 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_52 = ";;" + NL + "\t    ";
  protected final String TEXT_53 = NL + "\t    url_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";" + NL + "\t    ";
  protected final String TEXT_56 = NL + "\tString dbUser_";
  ...
  protected final String TEXT_66 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_67 = ")) //get schema from connection" + NL + "\t\t\t{" + NL + "\t\t\tdbschema_";
  protected final String TEXT_68 = "=conn_";
  protected final String TEXT_69 = ".getMetaData().getUserName();" + NL + "\t\t\t}" + NL + "\t" + NL + "\t";
  ...
  protected final String TEXT_96 = NL + "   int batchSize_";
  protected final String TEXT_97 = " = ";
  protected final String TEXT_98 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_99 = "=0;";
  protected final String TEXT_100 = " " + NL;
  protected final String TEXT_101 = NL + "int count_";
  protected final String TEXT_102 = "=0;";
  protected final String TEXT_103 = NL + NL + "if(dbschema_";
  ...
  protected final String TEXT_108 = " = dbschema_";
  protected final String TEXT_109 = " + \".\" + ";
  protected final String TEXT_110 = ";    " + NL + "}";
  protected final String TEXT_111 = NL + "  \ttableName_";
  ...
  protected final String TEXT_119 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_146 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_163 = "\t         " + NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_166 = " + \"]\";" + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_167 = ")== null){";
  protected final String TEXT_168 = "              ";
  protected final String TEXT_169 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_170 = " = conn_";
  protected final String TEXT_171 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_172 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_173 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_174 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_175 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_176 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_247 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_248 = ".execute(\"";
  protected final String TEXT_249 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_250 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_262 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_272 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_273 = ", true);" + NL + "\t\t\t}";
  protected final String TEXT_274 = "            ";
  protected final String TEXT_275 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_276 = " = conn_";
  protected final String TEXT_277 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_281 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_282 = " = conn_";
  protected final String TEXT_283 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_284 = " = stmtTruncCount_";
  protected final String TEXT_285 = ".executeQuery(\"";
  protected final String TEXT_286 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_287 = " = conn_";
  protected final String TEXT_288 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_289 = ".executeUpdate(\"";
  protected final String TEXT_290 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_291 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_292 = " += rsTruncCount_";
  protected final String TEXT_293 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_294 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_295 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_302 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_303 = " = new StringBuffer(insert_";
  protected final String TEXT_304 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_305 = ".insert(insert_";
  protected final String TEXT_306 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_307 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_308 = " =insertStringBuffer_";
  ...
  protected final String TEXT_316 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_317 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_318 = " = conn_";
  protected final String TEXT_319 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_320 = " + \"]\";" + NL + "                \t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_321 = ")== null){" + NL + "                \t\t\tpstmt_";
  protected final String TEXT_322 = " = conn_";
  protected final String TEXT_323 = ".prepareStatement(insert_";
  protected final String TEXT_324 = ");\t\t" + NL + "                \t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_325 = ", pstmt_";
  protected final String TEXT_326 = ");" + NL + "                \t\t}else{" + NL + "                \t\t\tpstmt_";
  protected final String TEXT_327 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_335 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_336 = " = new StringBuffer(update_";
  protected final String TEXT_337 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_338 = ".insert(update_";
  protected final String TEXT_339 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_340 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_341 = " =updateStringBuffer_";
  ...
  protected final String TEXT_345 = ".prepareStatement(update_";
  protected final String TEXT_346 = ");" + NL + "\t    ";
  protected final String TEXT_347 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_348 = " = conn_";
  protected final String TEXT_349 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_366 = ".prepareStatement(insert_";
  protected final String TEXT_367 = ");" + NL + "\t    String update_";
  protected final String TEXT_368 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_369 = " + \" SET ";
  protected final String TEXT_370 = " WHERE ";
  protected final String TEXT_371 = "\";" + NL + "\t    ";
  protected final String TEXT_372 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_373 = " = new StringBuffer(update_";
  protected final String TEXT_374 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_375 = ".insert(update_";
  protected final String TEXT_376 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_377 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_378 = " =updateStringBuffer_";
  protected final String TEXT_379 = ".toString(); ";
  protected final String TEXT_380 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_381 = " = conn_";
  protected final String TEXT_382 = ".prepareStatement(update_";
  ...
  protected final String TEXT_387 = " WHERE ";
  protected final String TEXT_388 = "\";" + NL + "\t   \t";
  protected final String TEXT_389 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_390 = " = new StringBuffer(update_";
  protected final String TEXT_391 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_392 = ".insert(update_";
  protected final String TEXT_393 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_394 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_395 = " =updateStringBuffer_";
  protected final String TEXT_396 = ".toString(); ";
  protected final String TEXT_397 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_405 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_406 = " = new StringBuffer(insert_";
  protected final String TEXT_407 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_408 = ".insert(insert_";
  protected final String TEXT_409 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_410 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_411 = " =insertStringBuffer_";
  protected final String TEXT_412 = ".toString(); ";
  protected final String TEXT_413 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_414 = " = conn_";
  protected final String TEXT_415 = ".prepareStatement(insert_";
  protected final String TEXT_416 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_417 = NL + "\t    String delete_";
  protected final String TEXT_418 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_419 = " + \" WHERE ";
  protected final String TEXT_420 = "\";" + NL + "\t    ";
  protected final String TEXT_421 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_422 = " = new StringBuffer(delete_";
  protected final String TEXT_423 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_424 = ".insert(delete_";
  protected final String TEXT_425 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_426 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_427 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_431 = ".prepareStatement(delete_";
  protected final String TEXT_432 = ");" + NL + "\t    ";
  protected final String TEXT_433 = NL + "        StringBuffer query_";
  protected final String TEXT_434 = " = null;" + NL + "\t   ";
  protected final String TEXT_435 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_436 = " = insert_";
  protected final String TEXT_437 = ".split(\"\\\\?\");";
  protected final String TEXT_438 = NL + "\t\t\tupdate_";
  protected final String TEXT_439 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_440 = " = update_";
  protected final String TEXT_441 = ".split(\"\\\\?\");";
  protected final String TEXT_442 = NL + "\t\t\tupdate_";
  protected final String TEXT_443 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_444 = " = update_";
  protected final String TEXT_445 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_446 = " = insert_";
  protected final String TEXT_447 = ".split(\"\\\\?\");";
  protected final String TEXT_448 = NL + "\t\t\tdelete_";
  protected final String TEXT_449 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_450 = " = delete_";
  protected final String TEXT_451 = ".split(\"\\\\?\");";
  protected final String TEXT_452 = NL + "\t\t\treplace_";
  protected final String TEXT_453 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_454 = " = replace_";
  protected final String TEXT_455 = ".split(\"\\\\?\");";
  protected final String TEXT_456 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_457 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_458 = " = insertIgnore_";
  protected final String TEXT_459 = ".split(\"\\\\?\");";
  protected final String TEXT_460 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_461 = " = insert_";
  protected final String TEXT_462 = ".split(\"\\\\?\");";
  protected final String TEXT_463 = NL + "\t   ";
  protected final String TEXT_464 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_465 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_466 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_467 = " = true;" + NL + "    \t";
  protected final String TEXT_468 = NL + "\tclass XMLTypeUtil_";
  protected final String TEXT_469 = " {" + NL + "\t\tpublic oracle.sql.CLOB getCLOB(String xmlData, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t  oracle.sql.CLOB tempClob = null;" + NL + "\t\t  try{" + NL + "\t\t    // If the temporary CLOB has not yet been created, create one" + NL + "\t\t    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION); " + NL + "\t\t " + NL + "\t\t    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t    tempClob.open(oracle.sql.CLOB.MODE_READWRITE); " + NL + "\t\t    // Get the output stream to write" + NL + "\t\t    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream(); " + NL + "\t\t    // Write the data into the temporary CLOB" + NL + "\t\t    tempClobWriter.write(xmlData); " + NL + "\t\t " + NL + "\t\t    // Flush and close the stream" + NL + "\t\t    tempClobWriter.flush();" + NL + "\t\t    tempClobWriter.close(); " + NL + "\t\t " + NL + "\t\t    // Close the temporary CLOB " + NL + "\t\t    tempClob.close();    " + NL + "\t\t  } catch( java.sql.SQLException sqlexp){" + NL + "\t\t    tempClob.freeTemporary(); " + NL + "\t\t    sqlexp.printStackTrace();" + NL + "\t\t  } catch(Exception exp){" + NL + "\t\t    tempClob.freeTemporary(); " + NL + "\t\t    exp.printStackTrace();" + NL + "\t\t  }" + NL + "\t\t  return tempClob; " + NL + "\t\t}" + NL + "\t}" + NL + "\tXMLTypeUtil_";
  protected final String TEXT_470 = " xmlTypeUtil_";
  protected final String TEXT_471 = " = null;" + NL + "\txmlTypeUtil_";
  protected final String TEXT_472 = " = new XMLTypeUtil_";
  protected final String TEXT_473 = "();";
  protected final String TEXT_474 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_475 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_476 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_477 = " =null;";
  protected final String TEXT_478 = NL + NL + NL + NL;
