...
public class TELTTeradataOutputMainJava
{
  ...
  protected final String TEXT_25 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_26 = " =null;" + NL + "" + NL + "java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_27 = " =null;" + NL + "" + NL + "java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_31 = NL + NL + "\tString tableName_";
  protected final String TEXT_32 = " = ";
  protected final String TEXT_33 = ";";
  protected final String TEXT_34 = "\t" + NL + "\t" + NL + "\t" + NL + "String insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_35 = "+\" (";
  protected final String TEXT_36 = ") \"+select_query;" + NL + "pstmt_";
  protected final String TEXT_37 = " = conn_";
  protected final String TEXT_38 = ".prepareStatement(insertQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_39 = NL + NL + "String updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_40 = "+\" FROM (\" + select_query + \") src SET ";
  ...
  protected final String TEXT_45 = ".prepareStatement(updateQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_46 = NL + NL + "String insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_47 = "+\" (";
  protected final String TEXT_48 = ") \"+select_query;" + NL + "pstmt_";
  protected final String TEXT_49 = " = conn_";
  protected final String TEXT_50 = ".prepareStatement(insertQuery);" + NL + "" + NL + "String updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_51 = "+\" SET (";
  protected final String TEXT_52 = ") = (\"+select_query+\") \"";
  protected final String TEXT_53 = NL + "+\"  WHERE \" + ";
  protected final String TEXT_54 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_55 = " = conn_";
  protected final String TEXT_56 = ".prepareStatement(updateQuery);" + NL + "\t\t" + NL + "\t";
  protected final String TEXT_57 = NL + NL + "String updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_58 = "+\" SET (";
  protected final String TEXT_59 = ") = (\"+select_query+\") \"";
  protected final String TEXT_60 = NL + "+\"  WHERE \" + ";
  protected final String TEXT_61 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_62 = " = conn_";
  protected final String TEXT_63 = ".prepareStatement(updateQuery);" + NL + "\t\t\t\t" + NL + "String insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_64 = "+\" (";
  protected final String TEXT_65 = ") \"+select_query;" + NL + "pstmt_";
  protected final String TEXT_66 = " = conn_";
  protected final String TEXT_67 = ".prepareStatement(insertQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_68 = NL + "\t" + NL + "String deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_69 = "+\" WHERE EXISTS (\"+select_query+\") \" ";
  protected final String TEXT_70 = NL + "+\"  AND \" + ";
  protected final String TEXT_71 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_72 = " = conn_";
  protected final String TEXT_73 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_79 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "nb_line_inserted_";
  protected final String TEXT_80 = " = pstmt_";
  protected final String TEXT_81 = ".executeUpdate();" + NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_82 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_83 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "nb_line_update_";
  ...
  protected final String TEXT_87 = NL + "\ttry{" + NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "\t\tnb_line_inserted_";
  protected final String TEXT_88 = " = pstmtInsert_";
  protected final String TEXT_89 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_90 = " + \" rows inserted. \\n\");" + NL + "\t" + NL + "\t}catch(Exception e){" + NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "\t\tnb_line_update_";
  protected final String TEXT_91 = " = pstmtUpdate_";
  protected final String TEXT_92 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_93 = " + \" rows updated. \\n\");" + NL + "\t}";
  protected final String TEXT_94 = NL + "\ttry{" + NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "\t\tnb_line_update_";
  protected final String TEXT_95 = " = pstmtUpdate_";
  protected final String TEXT_96 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_97 = " + \" rows updated. \\n\");" + NL + "\t}catch(Exception e){" + NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "\t\tnb_line_inserted_";
  ...
  protected final String TEXT_101 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_102 = " = pstmt_";
  protected final String TEXT_103 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_104 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_105 = NL + NL + "if(pstmtUpdate_";
  protected final String TEXT_106 = " != null){" + NL + "" + NL + "\tpstmtUpdate_";
  protected final String TEXT_107 = ".close();" + NL + "\t" + NL + "}else if(pstmt_";
  ...
  protected final String TEXT_113 = NL + "    if(conn_";
  protected final String TEXT_114 = " != null && conn_";
  protected final String TEXT_115 = ".isClosed()) {" + NL + "        conn_";
