...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_367 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_377 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_382 = NL + "    \t\t////////////////////////////" + NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_383 = " = insertedCount_";
  protected final String TEXT_384 = " + pstmt_";
  protected final String TEXT_385 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_386 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_397 = NL + "                        rejectedCount_";
  protected final String TEXT_398 = " = rejectedCount_";
  protected final String TEXT_399 = " + 1;";
  protected final String TEXT_400 = NL + "                        ";
  protected final String TEXT_401 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_402 = ";";
  protected final String TEXT_403 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_410 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_423 = NL + "                        query_";
  protected final String TEXT_424 = " = ";
  protected final String TEXT_425 = ";";
  protected final String TEXT_426 = NL + "                globalMap.put(\"";
  protected final String TEXT_427 = "_QUERY\", query_";
  protected final String TEXT_428 = ".toString().trim());";
  protected final String TEXT_429 = NL + "    \t\t";
  protected final String TEXT_430 = NL + "\t    \t\tpstmt_";
  protected final String TEXT_431 = ".addBatch();" + NL + "\t    \t\tnb_line_";
  protected final String TEXT_432 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_434 = "++;" + NL + "\t    \t\t";
  protected final String TEXT_435 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_436 = NL + "    \t\t//////////////////////////////////////" + NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_437 = " = updatedCount_";
  protected final String TEXT_438 = " + pstmt_";
  protected final String TEXT_439 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_440 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_451 = NL + "                        rejectedCount_";
  protected final String TEXT_452 = " = rejectedCount_";
  protected final String TEXT_453 = " + 1;";
  protected final String TEXT_454 = NL + "                        ";
  protected final String TEXT_455 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_456 = ";";
  protected final String TEXT_457 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_458 = NL + "            }" + NL + "            /////////////////////////////////////    \t\t" + NL + "    \t\t";
  ...
  protected final String TEXT_465 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_466 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_467 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_468 = " = rs_";
  protected final String TEXT_469 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_470 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_471 = NL + "                        ";
  protected final String TEXT_472 = NL + "                            query_";
  protected final String TEXT_473 = " = ";
  protected final String TEXT_474 = ";";
  protected final String TEXT_475 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_476 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_477 = ".";
  protected final String TEXT_478 = ", pstmtUpdate_";
  ...
  protected final String TEXT_487 = NL + "                            query_";
  protected final String TEXT_488 = " = ";
  protected final String TEXT_489 = ";";
  protected final String TEXT_490 = NL + "                    globalMap.put(\"";
  protected final String TEXT_491 = "_QUERY\", query_";
  protected final String TEXT_492 = ".toString().trim());";
  protected final String TEXT_493 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_494 = " = updatedCount_";
  protected final String TEXT_495 = " + pstmtUpdate_";
  protected final String TEXT_496 = ".executeUpdate();" + NL + "    \t\t\t} catch(Exception e) {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_497 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_498 = NL + "    \t                throw(e);" + NL + "    \t                ";
  ...
  protected final String TEXT_507 = NL + "    \t                    rejectedCount_";
  protected final String TEXT_508 = " = rejectedCount_";
  protected final String TEXT_509 = " + 1;" + NL + "    \t                    ";
  protected final String TEXT_510 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_511 = ";" + NL + "    \t                    ";
  protected final String TEXT_512 = NL + "    \t                    System.err.print(e.getMessage());" + NL + "    \t                    ";
  protected final String TEXT_513 = NL + "    \t\t\t}" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_520 = ", pstmtInsert_";
  ...
  protected final String TEXT_526 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_527 = " = insertedCount_";
  protected final String TEXT_528 = " + pstmtInsert_";
  protected final String TEXT_529 = ".executeUpdate();" + NL + "    \t\t\t} catch(Exception e) {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_530 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_531 = NL + "    \t                throw(e);" + NL + "    \t                ";
  ...
  protected final String TEXT_545 = NL + "    \t                    System.err.print(e.getMessage());" + NL + "    \t                    ";
  protected final String TEXT_546 = NL + "    \t\t\t}" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_547 = "++;" + NL + "    \t\t";
  protected final String TEXT_548 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_554 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_555 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_556 = ".";
  protected final String TEXT_557 = ", pstmtUpdate_";
  ...
  protected final String TEXT_572 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_573 = "=pstmtUpdate_";
  protected final String TEXT_574 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_575 = " = updatedCount_";
  protected final String TEXT_576 = " + updateFlag_";
  protected final String TEXT_577 = ";" + NL + "        \t} catch(Exception e) {" + NL + "        \t    whetherReject_";
  protected final String TEXT_578 = " = true;" + NL + "        \t    ";
  ...
  protected final String TEXT_595 = NL + "        \t}" + NL + "        \tif(updateFlag_";
  protected final String TEXT_596 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_597 = NL + "\t\t\t\tquery_";
  protected final String TEXT_598 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_599 = NL + "                        ";
  protected final String TEXT_600 = NL + "                            query_";
  protected final String TEXT_601 = " = ";
  protected final String TEXT_602 = ";";
  protected final String TEXT_603 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_604 = ".";
  protected final String TEXT_605 = ", pstmtInsert_";
  protected final String TEXT_606 = ", ";
  protected final String TEXT_607 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_608 = NL + "                    globalMap.put(\"";
  protected final String TEXT_609 = "_QUERY\", query_";
  protected final String TEXT_610 = ".toString().trim());";
  protected final String TEXT_611 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_612 = " = insertedCount_";
  protected final String TEXT_613 = " + pstmtInsert_";
  protected final String TEXT_614 = ".executeUpdate();" + NL + "        \t\t} catch(Exception e) {" + NL + "        \t\t    whetherReject_";
  protected final String TEXT_615 = " = true;" + NL + "        \t\t    ";
  ...
  protected final String TEXT_631 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_632 = NL + "        \t\t}" + NL + "        \t} " + NL + "        \tnb_line_";
  ...
  protected final String TEXT_648 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_649 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_650 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_651 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_652 = NL + "    \t\t//////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_653 = " = deletedCount_";
  ...
  protected final String TEXT_656 = " = true;" + NL + "    \t\t    ";
  ...
  protected final String TEXT_687 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_688 = " <= batchSizeCounter_";
  protected final String TEXT_689 = ") {                ";
  protected final String TEXT_690 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_691 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_692 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_693 = " += pstmt_";
  protected final String TEXT_694 = ". getUpdateCount();" + NL + "            \t    \t";
  ...
  protected final String TEXT_698 = NL + "            \t    \t    deletedCount_";
  ...
  protected final String TEXT_702 = " = 0;             \t                \t                \t" + NL + "                }catch(java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_703 = NL + "\t\t\t\t\tjava.sql.SQLException e2 = e;" + NL + "\t\t\t\t\twhile (e2 != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(e.getMessage());" + NL + "\t\t\t\t\t\te2 = e2.getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_704 = NL + "                \t";
  protected final String TEXT_705 = NL + "                \tboolean isFailure = false;" + NL + "            \t    while(e != null){" + NL + "            \t    \tif(e.getErrorCode() == -2801){" + NL + " \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "            \t    \t\te.printStackTrace();" + NL + "            \t    \t\tSystem.out.println();" + NL + "            \t    \t}" + NL + "            \t    \telse if(e.getErrorCode() == 1339){" + NL + "            \t    \t\tisFailure = true;" + NL + "            \t    \t}" + NL + "            \t    \telse{" + NL + " \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "            \t    \t\te.printStackTrace();" + NL + "            \t    \t}" + NL + "            \t    \te = e.getNextException();" + NL + "            \t    }" + NL + "            \t    if(isFailure){" + NL + "\t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "\t\t\t\t            e.printStackTrace();" + NL + "            \t    }" + NL + "            \t\t";
  protected final String TEXT_706 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_707 = "  " + NL + "                }";
  protected final String TEXT_708 = "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_709 = NL + "                commitCounter_";
  protected final String TEXT_710 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_711 = " <= commitCounter_";
  protected final String TEXT_712 = ") {" + NL + "                " + NL + "                \t";
  protected final String TEXT_713 = NL + "\t\t                try {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_714 = NL + "    \t\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_715 = " > 0 ) {" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_716 = NL + "\t\t                \t\t    pstmt_";
  protected final String TEXT_717 = ".executeBatch();" + NL + "\t\t            \t    \t";
  protected final String TEXT_718 = NL + "\t\t            \t    \t\tinsertedCount_";
  protected final String TEXT_719 = " += pstmt_";
  protected final String TEXT_720 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_721 = "            \t    \t\t" + NL + "\t\t            \t    \t\tupdatedCount_";
  protected final String TEXT_722 = " += pstmt_";
  protected final String TEXT_723 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  protected final String TEXT_724 = NL + "\t\t            \t    \t    deletedCount_";
  ...
  protected final String TEXT_729 = "\t" + NL + "\t\t\t\t\t\t\t\t                " + NL + "\t\t                \tconn_";
  protected final String TEXT_730 = ".commit();" + NL + "\t\t                \t" + NL + "\t\t                \tcommitCounter_";
  protected final String TEXT_731 = " = 0;" + NL + "\t\t                \t";
  protected final String TEXT_732 = NL + "\t\t                \tbatchSizeCounter_";
  protected final String TEXT_733 = " = 0;  " + NL + "\t\t                \t";
  protected final String TEXT_734 = NL + "\t\t                }catch(java.sql.SQLException e){" + NL + "\t\t                \t";
  protected final String TEXT_735 = NL + "\t\t\t\t\t\t\tjava.sql.SQLException e2 = e;" + NL + "\t\t\t\t\t\t\twhile (e2 != null) {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println(e.getMessage());" + NL + "\t\t\t\t\t\t\t\te2 = e2.getNextException();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_736 = NL + "\t\t                \t";
  protected final String TEXT_737 = NL + "\t\t                \t boolean isFailure = false;" + NL + "\t\t                \t    while(e != null){" + NL + "\t\t                \t    \tif(e.getErrorCode() == -2801){" + NL + "\t\t     \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "\t\t                \t    \t\te.printStackTrace();" + NL + "\t\t                \t    \t\tSystem.out.println();" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \telse if(e.getErrorCode() == 1339){" + NL + "\t\t                \t    \t\tisFailure = true;" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \telse{" + NL + "\t\t     \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "\t\t                \t    \t\te.printStackTrace();" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \te = e.getNextException();" + NL + "\t\t                \t    }" + NL + "\t\t                \t    if(isFailure){" + NL + "\t\t \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "\t\t                \t    \te.printStackTrace();" + NL + "\t\t                \t    }" + NL + "\t\t                \t    " + NL + "\t\t                \t";
  protected final String TEXT_738 = NL + "\t\t                        System.out.println(e.getMessage());" + NL + "\t\t                \t";
