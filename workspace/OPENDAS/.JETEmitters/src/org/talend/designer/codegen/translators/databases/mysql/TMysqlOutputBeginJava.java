...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_133 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_134 = " = conn_";
  protected final String TEXT_135 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_136 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  protected final String TEXT_137 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_138 = " + \"]\" );" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_139 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_140 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_165 = ".equalsIgnoreCase(";
  protected final String TEXT_166 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_167 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_237 = ", true);" + NL + "\t\t\t}";
  ...
  protected final String TEXT_261 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_262 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_263 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_264 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_265 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_266 = ".append (\"`\" +  ";
  protected final String TEXT_267 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_268 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_269 = ".append (";
  protected final String TEXT_270 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_271 = NL + "\t\t\t\t       ";
  protected final String TEXT_272 = NL + "\t\t        String insert_";
  protected final String TEXT_273 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_274 = " + \"` (";
  protected final String TEXT_275 = ") VALUES (";
  protected final String TEXT_276 = ")\";";
  protected final String TEXT_277 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_278 = " += \tduplidateClause_";
  protected final String TEXT_279 = ".toString();";
  protected final String TEXT_280 = NL + "\t\t\t\t";
  protected final String TEXT_281 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_282 = " = new StringBuffer(insert_";
  protected final String TEXT_283 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_284 = ".insert(insert_";
  protected final String TEXT_285 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_286 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_287 = " =insertStringBuffer_";
  protected final String TEXT_288 = ".toString(); ";
  protected final String TEXT_289 = "    " + NL;
  protected final String TEXT_290 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_291 = " = conn_";
  protected final String TEXT_292 = ".prepareStatement(insert_";
  protected final String TEXT_293 = ");";
  protected final String TEXT_294 = NL + "                        ";
  protected final String TEXT_295 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_296 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_297 = " = conn_";
  protected final String TEXT_298 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_299 = " + \"]\";" + NL + "                \t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_300 = ")== null){" + NL + "                \t\t\tpstmt_";
  protected final String TEXT_301 = " = conn_";
  protected final String TEXT_302 = ".prepareStatement(insert_";
  protected final String TEXT_303 = ");\t\t" + NL + "                \t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_304 = ", pstmt_";
  protected final String TEXT_305 = ");" + NL + "                \t\t}else{" + NL + "                \t\t\tpstmt_";
  protected final String TEXT_306 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_307 = ");\t\t\t\t" + NL + "                \t\t}";
  protected final String TEXT_308 = NL + "\t        \t        ";
  protected final String TEXT_309 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_310 = " {" + NL + "    \t            ";
  protected final String TEXT_311 = NL + "                            ";
  protected final String TEXT_312 = " ";
  protected final String TEXT_313 = ";                ";
  protected final String TEXT_314 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_315 = "(";
  protected final String TEXT_316 = NL + "                                ,";
  protected final String TEXT_317 = NL + "                            ";
  protected final String TEXT_318 = " ";
  protected final String TEXT_319 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_320 = NL + "                                this.";
  protected final String TEXT_321 = " = ";
  protected final String TEXT_322 = ";              ";
  protected final String TEXT_323 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_324 = "> exInsertColValueList";
  protected final String TEXT_325 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_326 = " exInsertColValue";
  protected final String TEXT_327 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_328 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_329 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_330 = ".append(\"(";
  protected final String TEXT_331 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_332 = "-1) extendInsertValueStmt_";
  protected final String TEXT_333 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_334 = " = \"INSERT INTO `\"+";
  protected final String TEXT_335 = "+\"` (";
  protected final String TEXT_336 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_337 = ".toString();";
  protected final String TEXT_338 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_339 = " += \tduplidateClause_";
  ...
  protected final String TEXT_355 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_356 = " =  \"";
  protected final String TEXT_357 = "\"; " + NL + "\t            int rowCount";
  ...
  protected final String TEXT_367 = NL + "\t\t        int batchSize_";
  protected final String TEXT_368 = " = ";
  protected final String TEXT_369 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_370 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_371 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_372 = " = new StringBuffer(insert_";
  protected final String TEXT_373 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_374 = ".insert(insert_";
  protected final String TEXT_375 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_376 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_377 = " =insertStringBuffer_";
  ...
  protected final String TEXT_384 = " = \"UPDATE `\" + ";
  protected final String TEXT_385 = " + \"` SET ";
  protected final String TEXT_386 = " WHERE ";
  protected final String TEXT_387 = "\";" + NL + "\t    ";
  protected final String TEXT_388 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_389 = " = new StringBuffer(update_";
  protected final String TEXT_390 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_391 = ".insert(update_";
  protected final String TEXT_392 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_393 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_394 = " =updateStringBuffer_";
  ...
  protected final String TEXT_398 = ".prepareStatement(update_";
  protected final String TEXT_399 = ");" + NL + "\t    ";
  protected final String TEXT_400 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_401 = " = conn_";
  protected final String TEXT_402 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  ...
  protected final String TEXT_409 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_410 = " = new StringBuffer(insert_";
  protected final String TEXT_411 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_412 = ".insert(insert_";
  protected final String TEXT_413 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_414 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_415 = " =insertStringBuffer_";
  protected final String TEXT_416 = ".toString(); ";
  protected final String TEXT_417 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_421 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_438 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_450 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_458 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_459 = " = new StringBuffer(insert_";
  protected final String TEXT_460 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_461 = ".insert(insert_";
  protected final String TEXT_462 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_463 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_464 = " =insertStringBuffer_";
  protected final String TEXT_465 = ".toString(); ";
  protected final String TEXT_466 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_467 = " = conn_";
  protected final String TEXT_468 = ".prepareStatement(insert_";
  protected final String TEXT_469 = ");\t\t\t\t" + NL + "\t    ";
  protected final String TEXT_470 = NL + "\t    String delete_";
  protected final String TEXT_471 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_472 = " + \"` WHERE ";
  protected final String TEXT_473 = "\";" + NL + "\t    ";
  protected final String TEXT_474 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_475 = " = new StringBuffer(delete_";
  protected final String TEXT_476 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_477 = ".insert(delete_";
  protected final String TEXT_478 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_479 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_480 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_486 = NL + "\t    String replace_";
  protected final String TEXT_487 = " = \"REPLACE INTO `\" + ";
  ...
  protected final String TEXT_492 = ".prepareStatement(replace_";
  protected final String TEXT_493 = ");" + NL + "\t    ";
  protected final String TEXT_494 = NL + "\t    String insertIgnore_";
  protected final String TEXT_495 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_496 = " + \"` (";
  protected final String TEXT_497 = ") VALUES (";
  protected final String TEXT_498 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_499 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_500 = " = conn_";
  protected final String TEXT_501 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_502 = ");" + NL + "\t    ";
  protected final String TEXT_503 = NL + "\t    String insert_";
  protected final String TEXT_504 = " = \"INSERT IGNORE INTO `\" + ";
  ...
  protected final String TEXT_520 = NL + "        StringBuffer query_";
  protected final String TEXT_521 = " = null;" + NL + "       \t";
  ...
  protected final String TEXT_532 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_533 = " = insert_";
  protected final String TEXT_534 = ".split(\"\\\\?\");";
  protected final String TEXT_535 = NL + "\t\t\tdelete_";
  protected final String TEXT_536 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_537 = " = delete_";
  protected final String TEXT_538 = ".split(\"\\\\?\");";
  protected final String TEXT_539 = NL + "\t\t\treplace_";
  protected final String TEXT_540 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_541 = " = replace_";
  protected final String TEXT_542 = ".split(\"\\\\?\");";
  protected final String TEXT_543 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_544 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_545 = " = insertIgnore_";
  ...
  protected final String TEXT_550 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_551 = " {" + NL + "    \t            ";
  protected final String TEXT_552 = NL + "                            ";
  protected final String TEXT_553 = " ";
  protected final String TEXT_554 = ";                ";
  protected final String TEXT_555 = NL + "\t\t\t\tDynamic ";
  ...
  protected final String TEXT_562 = NL + "\t\t\t\t, Dynamic ";
  ...
  protected final String TEXT_576 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_577 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_578 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_579 = "=1;";
  protected final String TEXT_580 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_583 = " =null;" + NL + "\tint batchSizeCounter_";
  protected final String TEXT_584 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_585 = "=0;" + NL + "\tint rowCount";
