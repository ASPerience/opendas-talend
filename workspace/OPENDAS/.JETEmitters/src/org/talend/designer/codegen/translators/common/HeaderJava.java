...
public class HeaderJava
{
  ...
  protected final String TEXT_70 = NL + "\tLogCatcherUtils ";
  protected final String TEXT_71 = " = new LogCatcherUtils();";
  protected final String TEXT_72 = NL + "\tStatCatcherUtils ";
  protected final String TEXT_73 = " = new StatCatcherUtils(\"";
  protected final String TEXT_74 = "\", \"";
  protected final String TEXT_75 = "\");";
  protected final String TEXT_76 = NL + "\tMetterCatcherUtils ";
  protected final String TEXT_77 = " = new MetterCatcherUtils(\"";
  protected final String TEXT_78 = "\", \"";
  protected final String TEXT_79 = "\");";
  protected final String TEXT_80 = NL + "\tAssertCatcherUtils ";
  protected final String TEXT_81 = " = new AssertCatcherUtils();";
  protected final String TEXT_82 = NL + NL + "private final java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();" + NL + "private final java.io.PrintStream errorMessagePS = new java.io.PrintStream(new java.io.BufferedOutputStream(baos));" + NL + "" + NL + "public String getExceptionStackTrace() {" + NL + "\tif (\"failure\".equals(this.getStatus())) {" + NL + "\t\terrorMessagePS.flush();" + NL + "\t\treturn baos.toString();" + NL + "\t}" + NL + "\treturn null;" + NL + "}" + NL + "" + NL + "private Exception exception = null;" + NL + "" + NL + "public Exception getException() {" + NL + "\tif (\"failure\".equals(this.getStatus())) {" + NL + "\t\treturn this.exception;" + NL + "\t}" + NL + "\treturn null;" + NL + "}" + NL + "" + NL + "private class TalendException extends Exception {" + NL + "\tprivate java.util.Map<String, Object> globalMap = null;" + NL + "\tprivate Exception e = null;" + NL + "\tprivate String currentComponent = null;" + NL + "" + NL + "\tprivate TalendException(Exception e, String errorComponent, final java.util.Map<String, Object> globalMap) {" + NL + "\t\tthis.currentComponent= errorComponent;" + NL + "\t\tthis.globalMap = globalMap;" + NL + "\t\tthis.e = e;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void printStackTrace() {" + NL + "\t\tif (!(e instanceof TalendException || e instanceof TDieException)) {" + NL + "\t\t\t globalMap.put(currentComponent+\"_ERROR_MESSAGE\",e.getMessage());" + NL + "\t\t\tSystem.err.println(\"Exception in component \" + currentComponent);" + NL + "\t\t}" + NL + "\t\tif (!(e instanceof TDieException)) {" + NL + "\t\t\tif(e instanceof TalendException){" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t} else {" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t\te.printStackTrace(errorMessagePS);" + NL + "\t\t\t\t";
  protected final String TEXT_83 = ".this.exception = e;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif (!(e instanceof TalendException)) {" + NL + "\t\ttry {" + NL + "\t\t\tfor (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {" + NL + "\t\t\t\tif (m.getName().compareTo(currentComponent + \"_error\") == 0) {" + NL + "\t\t\t\t\tm.invoke(";
  protected final String TEXT_84 = ".this, new Object[] { e , currentComponent, globalMap});" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tif(!(e instanceof TDieException)){";
  protected final String TEXT_85 = NL + "\t\t\t\t";
  protected final String TEXT_86 = ".addMessage(\"Java Exception\", currentComponent, 6, e.getClass().getName() + \":\" + e.getMessage(), 1);";
  protected final String TEXT_87 = NL + "\t\t\ttry{";
  protected final String TEXT_88 = NL + "\t\t\t\t";
  protected final String TEXT_89 = "Process(globalMap);";
  protected final String TEXT_90 = NL + "\t\t\t}finally{";
  protected final String TEXT_91 = NL + "\t\t\t\t";
  protected final String TEXT_92 = "Process(globalMap);";
  protected final String TEXT_93 = NL + "\t\t\t}";
  protected final String TEXT_94 = NL + "\t\t\t}" + NL + "\t\t} catch (java.lang.SecurityException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.IllegalArgumentException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.IllegalAccessException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t} catch (java.lang.reflect.InvocationTargetException e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t}";
  protected final String TEXT_95 = NL + "\t\t\t\tcatch (TalendException e) {" + NL + "\t\t\t\t\t// do nothing" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t}" + NL + "\t}" + NL + "}" + NL;
  protected final String TEXT_97 = NL + "\t\t\tpublic void ";
  protected final String TEXT_98 = "_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {" + NL + "\t\t\t\tend_Hash.put(\"";
  protected final String TEXT_99 = "\", System.currentTimeMillis());" + NL + "\t\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\t\t\t\t\tif(!(exception instanceof TDieException)){" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_101 = ".addMessage(pid, projectName, jobName, \"java\", null, \"Failed\", \"Job execution error\", exception.getMessage());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_102 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_103 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_104 = ".addMessage(\"failure\",\"";
  protected final String TEXT_105 = "\", end_Hash.get(\"";
  protected final String TEXT_106 = "\")-start_Hash.get(\"";
  protected final String TEXT_107 = "\"));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_108 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_109 = NL + "\t\t\t\t\t\ttry {" + NL + "" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_110 = NL + "\t\t\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", null);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_111 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"end\");" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_112 = NL + "\t\t\t\t\t\t\t\terrorCode = null;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_113 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\tstatus=\"end\";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_114 = NL + NL + "\t\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_115 = NL + "\t\t\t\t";
  protected final String TEXT_116 = "_onSubJobError(exception, errorComponent, globalMap);" + NL + "" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\tpublic void ";
  protected final String TEXT_118 = "_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {";
  protected final String TEXT_119 = NL + NL + "resumeUtil.addLog(\"SYSTEM_LOG\", \"NODE:\"+ errorComponent, \"\", Thread.currentThread().getId()+ \"\", \"";
  protected final String TEXT_120 = "\", \"\", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),\"\");" + NL;
  protected final String TEXT_121 = NL + "\t\t\t\ttry {";
  protected final String TEXT_122 = NL + "\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", null);" + NL + "\t\t\t\t\t";
  protected final String TEXT_123 = "Process(globalMap);" + NL + "\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"end\");";
  protected final String TEXT_124 = NL + "\t\t\t\t\terrorCode = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_125 = "Process(globalMap);" + NL + "\t\t\t\t\tstatus=\"end\";";
  protected final String TEXT_126 = NL + "\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t}";
...
String talendJobInterfaceName = (talendEsbJob) ? "TalendESBJob" : "TalendJob";
