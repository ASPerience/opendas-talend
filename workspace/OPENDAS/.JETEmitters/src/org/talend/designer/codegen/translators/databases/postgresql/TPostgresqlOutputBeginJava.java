...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_118 = "\t         " + NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  ...
  protected final String TEXT_130 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_158 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_227 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_228 = ", true);" + NL + "\t\t\t}";
  protected final String TEXT_229 = "            ";
  protected final String TEXT_230 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_233 = ".executeUpdate(\"";
  protected final String TEXT_234 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_235 = ".close();";
  protected final String TEXT_236 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_239 = " = stmtTruncCount_";
  protected final String TEXT_240 = ".executeQuery(\"";
  protected final String TEXT_241 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_244 = ".executeUpdate(\"";
  protected final String TEXT_245 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_246 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_247 = " += rsTruncCount_";
  protected final String TEXT_248 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_249 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_250 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_251 = ".close();            ";
  protected final String TEXT_252 = NL + "\t    String insert_";
  protected final String TEXT_253 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_254 = " + \"\\\" (";
  protected final String TEXT_255 = ") VALUES (";
  protected final String TEXT_256 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_257 = " = conn_";
  protected final String TEXT_258 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_264 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_270 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_271 = " + \"\\\" WHERE ";
  protected final String TEXT_272 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_273 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_274 = " + \"\\\" (";
  protected final String TEXT_275 = ") VALUES (";
  protected final String TEXT_276 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_277 = " = conn_";
  protected final String TEXT_278 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_283 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_291 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_298 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_299 = " = conn_";
  protected final String TEXT_300 = ".prepareStatement(insert_";
  protected final String TEXT_301 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_302 = NL + "\t    String delete_";
  protected final String TEXT_303 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_307 = ".prepareStatement(delete_";
  protected final String TEXT_308 = ");" + NL + "\t    ";
  protected final String TEXT_309 = NL + "        StringBuffer query_";
  protected final String TEXT_310 = " = null;" + NL + "       \t";
  protected final String TEXT_311 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_312 = " = insert_";
  protected final String TEXT_313 = ".split(\"\\\\?\");";
  protected final String TEXT_314 = NL + "\t\t\tupdate_";
  protected final String TEXT_315 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_316 = " = update_";
  protected final String TEXT_317 = ".split(\"\\\\?\");";
  protected final String TEXT_318 = NL + "\t\t\tupdate_";
  protected final String TEXT_319 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_320 = " = update_";
  protected final String TEXT_321 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_322 = " = insert_";
  protected final String TEXT_323 = ".split(\"\\\\?\");";
  protected final String TEXT_324 = NL + "\t\t\tdelete_";
  protected final String TEXT_325 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_326 = " = delete_";
  protected final String TEXT_327 = ".split(\"\\\\?\");";
  protected final String TEXT_328 = NL + "\t\t\treplace_";
  protected final String TEXT_329 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_330 = " = replace_";
  protected final String TEXT_331 = ".split(\"\\\\?\");";
  protected final String TEXT_332 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_333 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_334 = " = insertIgnore_";
  ...
  protected final String TEXT_339 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_340 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_341 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_342 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_343 = " = true;" + NL + "    \t";
  protected final String TEXT_344 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_345 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_346 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
