...
public class TMysqlInputBeginJava
{
  ...
  protected final String TEXT_169 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_170 = ".setLength(rsmd_";
  protected final String TEXT_171 = ".getPrecision(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_214 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_215 = ".";
  protected final String TEXT_216 = ", rs_";
  protected final String TEXT_217 = ", fixedColumnCount_";
  protected final String TEXT_218 = ");";
  protected final String TEXT_219 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_220 = ".getObject(";
  protected final String TEXT_221 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_222 = ".";
  protected final String TEXT_223 = " = new Geometry(sb.toString());";
