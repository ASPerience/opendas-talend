...
public class TFileInputMailBeginJava
{
  ...
  protected final String TEXT_128 = ".equals(javax.mail.Part.ATTACHMENT)) || (disposition";
  protected final String TEXT_129 = ".equals(javax.mail.Part.INLINE)))) {" + NL + "                    attachfileName";
  protected final String TEXT_130 = " = mpart";
  protected final String TEXT_131 = ".getFileName();" + NL + "                    " + NL + "                    if (attachfileName";
  protected final String TEXT_132 = ".indexOf(\"=?\") != -1){" + NL + "                      int m_";
  protected final String TEXT_133 = " = 2, n_";
  protected final String TEXT_134 = ";" + NL + "                      n_";
  protected final String TEXT_135 = " = attachfileName";
  protected final String TEXT_136 = ".indexOf(63, m_";
  protected final String TEXT_137 = "); // the first ? location " + NL + "                      String sCharSet_";
  protected final String TEXT_138 = " = attachfileName";
  protected final String TEXT_139 = ".substring(attachfileName";
  protected final String TEXT_140 = ".indexOf(\"=?\") + 2, n_";
  protected final String TEXT_141 = "); // the character set value         " + NL + "                      m_";
  protected final String TEXT_142 = " = n_";
  protected final String TEXT_143 = " + 1;                      " + NL + "                      n_";
  protected final String TEXT_144 = " = attachfileName";
  protected final String TEXT_145 = ".indexOf(63, m_";
  protected final String TEXT_146 = "); // the second ? location                      " + NL + "                      String flag_";
  protected final String TEXT_147 = " = attachfileName";
  protected final String TEXT_148 = ".substring(m_";
  protected final String TEXT_149 = ", n_";
  protected final String TEXT_150 = ");" + NL + "                      m_";
  protected final String TEXT_151 = " = n_";
  protected final String TEXT_152 = " + 1;" + NL + "                      n_";
  protected final String TEXT_153 = " = attachfileName";
  protected final String TEXT_154 = ".indexOf(\"?=\", m_";
  protected final String TEXT_155 = ");                      " + NL + "                      String sNameCode_";
  protected final String TEXT_156 = " = attachfileName";
  protected final String TEXT_157 = ".substring(m_";
  protected final String TEXT_158 = ", n_";
  protected final String TEXT_159 = ");                  " + NL + "                      java.io.ByteArrayInputStream byteArrIS_";
  protected final String TEXT_160 = " = new java.io.ByteArrayInputStream(sNameCode_";
  protected final String TEXT_161 = ".getBytes());                      " + NL + "                      Object obj_";
  protected final String TEXT_162 = " = null;" + NL + "                      " + NL + "                      if (flag_";
  protected final String TEXT_163 = ".equalsIgnoreCase(\"B\")) {" + NL + "                        obj_";
  protected final String TEXT_164 = " = new com.sun.mail.util.BASE64DecoderStream(byteArrIS_";
  protected final String TEXT_165 = ");                    " + NL + "                      } else if (flag_";
  protected final String TEXT_166 = ".equalsIgnoreCase(\"Q\")) {" + NL + "                        obj_";
  protected final String TEXT_167 = " = new com.sun.mail.util.QDecoderStream(byteArrIS_";
  protected final String TEXT_168 = ");" + NL + "                      }" + NL + "                      " + NL + "                      if (obj_";
  protected final String TEXT_169 = " != null){" + NL + "                        int k_";
  protected final String TEXT_170 = " = byteArrIS_";
  protected final String TEXT_171 = ".available();" + NL + "                        byte[] arrByte_";
  protected final String TEXT_172 = " = new byte[k_";
  protected final String TEXT_173 = "];" + NL + "                        k_";
  protected final String TEXT_174 = " = ((java.io.InputStream) (obj_";
  protected final String TEXT_175 = ")).read(arrByte_";
  protected final String TEXT_176 = ", 0, k_";
  protected final String TEXT_177 = ");" + NL + "                        attachfileName";
  protected final String TEXT_178 = " = new String(arrByte_";
  protected final String TEXT_179 = ", 0, k_";
  protected final String TEXT_180 = ", sCharSet_";
  protected final String TEXT_181 = ");" + NL + "                      }" + NL + "                    }" + NL + "                    " + NL + "                     if(!(";
  protected final String TEXT_182 = ").endsWith(\"/\")){" + NL + "           \t\t\t\t path";
  protected final String TEXT_183 = " = ";
  protected final String TEXT_184 = " + \"/\";" + NL + "        \t\t\t\t}else" + NL + "        \t\t\t\t{" + NL + "        \t\t\t\t\tpath";
  protected final String TEXT_185 = " =";
  protected final String TEXT_186 = ";" + NL + "        \t\t\t\t}" + NL + "                    path";
  protected final String TEXT_187 = " = path";
  protected final String TEXT_188 = " + attachfileName";
  protected final String TEXT_189 = ";" + NL + "                    java.io.File attachFile  = new java.io.File(path";
  protected final String TEXT_190 = ");" + NL + "                    out";
  protected final String TEXT_191 = " = new java.io.BufferedOutputStream(new java.io.FileOutputStream(attachFile));" + NL + "                    in";
  protected final String TEXT_192 = " = new java.io.BufferedInputStream(mpart";
  protected final String TEXT_193 = ".getInputStream());" + NL + "                    int buffer";
  protected final String TEXT_194 = " = 0;" + NL + "                    while ((buffer";
  protected final String TEXT_195 = " = in";
  protected final String TEXT_196 = ".read()) != -1) {" + NL + "                           out";
  protected final String TEXT_197 = ".write(buffer";
  protected final String TEXT_198 = ");" + NL + "                           out";
  protected final String TEXT_199 = ".flush();" + NL + "                         }   " + NL + "                        out";
  protected final String TEXT_200 = ".close();" + NL + "                        in";
  protected final String TEXT_201 = ".close();    " + NL + "                }" + NL + "            }" + NL + " \t}" + NL + " \t         " + NL + " \t          " + NL + "// for output";
  protected final String TEXT_202 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t" + NL + "\t\t\tif(";
  protected final String TEXT_203 = " < list_";
  protected final String TEXT_204 = ".size() && list_";
  protected final String TEXT_205 = ".get(";
  protected final String TEXT_206 = ")!=null){\t\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\t\t\t";
  protected final String TEXT_208 = ".";
  protected final String TEXT_209 = " = (String)list_";
  protected final String TEXT_210 = ".get(";
  protected final String TEXT_211 = ");";
  protected final String TEXT_212 = NL + "\t\t\t\t\t";
  protected final String TEXT_213 = ".";
  protected final String TEXT_214 = " = ParserUtils.parseTo_Date(list_";
  protected final String TEXT_215 = ".get(";
  protected final String TEXT_216 = "), ";
  protected final String TEXT_217 = ");";
  protected final String TEXT_218 = NL + "\t\t\t\t\t";
  protected final String TEXT_219 = ".";
  protected final String TEXT_220 = " = list_";
  protected final String TEXT_221 = ".get(";
  protected final String TEXT_222 = ").getBytes();";
  ...
  protected final String TEXT_229 = NL + "\t\t\t" + NL + "\t\t\t} else { " + NL + "\t\t\t" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_239 = NL + "catch (Exception e){" + NL + "//nothing to do, ignore the exception if don't die on error" + NL + "System.err.println(\"Exception in component ";
  protected final String TEXT_240 = ": \" + e.getMessage());" + NL + "}";
  protected final String TEXT_241 = NL + NL + "finally{" + NL + "\tif(fileInput";
  protected final String TEXT_242 = "!=null)" + NL + "\t\t\tfileInput";
  protected final String TEXT_243 = ".close();" + NL + "} " + NL + "////////////////////////////";
