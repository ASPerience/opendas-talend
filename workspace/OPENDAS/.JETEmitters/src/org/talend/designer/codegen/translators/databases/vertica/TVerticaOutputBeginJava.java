...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_74 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_75 = " + \"_proj (";
  protected final String TEXT_76 = ") AS SELECT ";
  protected final String TEXT_77 = " FROM \" + tableName_";
  ...
  protected final String TEXT_84 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_85 = " + \"_proj (";
  protected final String TEXT_86 = ") AS SELECT ";
  protected final String TEXT_87 = " FROM \" + tableName_";
  ...
  protected final String TEXT_93 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_94 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_95 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_96 = " = rsTable_";
  protected final String TEXT_97 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_98 = ".equalsIgnoreCase(";
  protected final String TEXT_99 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_100 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_107 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_108 = " + \"_proj (";
  protected final String TEXT_109 = ") AS SELECT ";
  protected final String TEXT_110 = " FROM \" + tableName_";
  ...
  protected final String TEXT_115 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_116 = ".execute(\"";
  protected final String TEXT_117 = "\" + ";
  protected final String TEXT_118 = ");" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "                stmtCreate_";
  protected final String TEXT_121 = ".execute(\"";
  protected final String TEXT_122 = ")\");" + NL + "            \tstmtCreate_";
  protected final String TEXT_123 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_124 = " + \"_proj (";
  protected final String TEXT_125 = ") AS SELECT ";
  protected final String TEXT_126 = " FROM \" + tableName_";
  protected final String TEXT_127 = ");//";
  protected final String TEXT_128 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_129 = " = conn_";
  protected final String TEXT_130 = ".createStatement();" + NL + "            deletedCount_";
  ...
  protected final String TEXT_142 = NL + "        int batchCount_";
  ...
  protected final String TEXT_154 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_167 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_178 = ");" + NL + "        String insert_";
  ...
  protected final String TEXT_186 = NL + "        String delete_";
  protected final String TEXT_187 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_191 = ".prepareStatement(delete_";
  protected final String TEXT_192 = ");";
  protected final String TEXT_193 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_194 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_195 = " = conn_";
  protected final String TEXT_196 = ".createStatement();\t" + NL + "        String template_";
  protected final String TEXT_197 = " = \"COPY \" + tableName_";
  protected final String TEXT_198 = " +\" (";
  protected final String TEXT_199 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_200 = "DIRECT";
  protected final String TEXT_201 = "\";" + NL + "\t\t";
  protected final String TEXT_202 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_207 = NL + "\t\t\tupdate_";
  protected final String TEXT_208 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_209 = " = update_";
  protected final String TEXT_210 = ".split(\"\\\\?\");";
  protected final String TEXT_211 = NL + "\t\t\tupdate_";
  protected final String TEXT_212 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_213 = " = update_";
  protected final String TEXT_214 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_215 = " = insert_";
  protected final String TEXT_216 = ".split(\"\\\\?\");";
  protected final String TEXT_217 = NL + "\t\t\tdelete_";
  protected final String TEXT_218 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_219 = " = delete_";
  protected final String TEXT_220 = ".split(\"\\\\?\");";
  protected final String TEXT_221 = NL + "\t\t\treplace_";
  protected final String TEXT_222 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_223 = " = replace_";
  protected final String TEXT_224 = ".split(\"\\\\?\");";
  protected final String TEXT_225 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_226 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_227 = " = insertIgnore_";
