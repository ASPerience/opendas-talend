...
public class TSalesforceConnectionBeginJava
{
  ...
  protected final String TEXT_28 = " = new org.talend.salesforce.SforceManagementImpl();" + NL + "" + NL + "\tboolean result_";
  protected final String TEXT_29 = " = sfMgr_";
  protected final String TEXT_30 = ".login(";
  protected final String TEXT_31 = ",";
  protected final String TEXT_32 = ", ";
  protected final String TEXT_33 = ",";
  protected final String TEXT_34 = ",";
  protected final String TEXT_35 = ");" + NL + "\tif(!result_";
  protected final String TEXT_36 = "){" + NL + "\t\tthrow new RuntimeException(\"Login failed! Please check the username,password and endpoint\");" + NL + "\t}" + NL + "\t" + NL + "\tglobalMap.put(\"stub_";
  protected final String TEXT_37 = "\", sfMgr_";
  protected final String TEXT_38 = ".getStub());" + NL + "\tglobalMap.put(\"sessionHeader_";
  protected final String TEXT_39 = "\", sfMgr_";
  protected final String TEXT_40 = ".getSessionHeader());";
