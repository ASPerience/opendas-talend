...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_268 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_318 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_358 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_359 = " = buffersSize_";
  protected final String TEXT_360 = ";";
  protected final String TEXT_361 = NL + "        whetherReject_";
  protected final String TEXT_362 = " = false;";
  protected final String TEXT_363 = NL + "                    ";
  protected final String TEXT_364 = NL + "                        query_";
  protected final String TEXT_365 = " = ";
  protected final String TEXT_366 = ";";
  protected final String TEXT_367 = NL + "                            geometryColumnName_";
  protected final String TEXT_368 = " = \"";
  protected final String TEXT_369 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_370 = ") {" + NL + "                                dimension_";
  protected final String TEXT_371 = " = 2;" + NL + "                                " + NL + "                                // A null first geometry will lead to unknown coordinate system  " + NL + "                                if (";
  protected final String TEXT_372 = ".";
  protected final String TEXT_373 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_374 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_375 = " = " + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_376 = ".";
  protected final String TEXT_377 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_378 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_379 = " = refSys_";
  protected final String TEXT_380 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_381 = " = refSys_";
  protected final String TEXT_382 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_383 = " == null || ident_";
  protected final String TEXT_384 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_385 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_386 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_387 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_388 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_389 = " = Integer.parseInt(code_";
  protected final String TEXT_390 = ");" + NL + "                                            }" + NL + "                                        } catch (Exception e) {" + NL + "                                            System.out.println(\"SRID_";
  protected final String TEXT_391 = " could not be determined\");" + NL + "                                            SRID_";
  protected final String TEXT_392 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_393 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_394 = " = false;" + NL + "                                 }" + NL + "                            }";
  ...
  protected final String TEXT_401 = "_QUERY\", query_";
  protected final String TEXT_402 = ".toString().trim());";
  protected final String TEXT_403 = NL + "\t\t\t";
  protected final String TEXT_404 = NL + "    \t\tpstmt_";
  protected final String TEXT_405 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_410 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_411 = " = insertedCount_";
  protected final String TEXT_412 = " + pstmt_";
  protected final String TEXT_413 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_414 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_419 = "Struct();";
  protected final String TEXT_420 = NL + "                            ";
  protected final String TEXT_421 = ".";
  protected final String TEXT_422 = " = ";
  protected final String TEXT_423 = ".";
  protected final String TEXT_424 = ";";
  protected final String TEXT_425 = NL + "                        rejectedCount_";
  protected final String TEXT_426 = " = rejectedCount_";
  protected final String TEXT_427 = " + 1;";
  protected final String TEXT_428 = NL + "                        ";
  protected final String TEXT_429 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_430 = ";";
  protected final String TEXT_431 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_437 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_438 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_454 = NL + "                globalMap.put(\"";
  protected final String TEXT_455 = "_QUERY\", query_";
  protected final String TEXT_456 = ".toString().trim());";
  protected final String TEXT_457 = NL + "    \t\tpstmt_";
  protected final String TEXT_458 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_459 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_460 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_461 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_462 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_463 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_464 = " = updatedCount_";
  protected final String TEXT_465 = " + pstmt_";
  protected final String TEXT_466 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_467 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_468 = " = true;";
  protected final String TEXT_469 = NL + "                    throw(e);";
  protected final String TEXT_470 = NL + "                        ";
  protected final String TEXT_471 = " = new ";
  protected final String TEXT_472 = "Struct();";
  ...
  protected final String TEXT_479 = " = rejectedCount_";
  protected final String TEXT_480 = " + 1;";
  protected final String TEXT_481 = NL + "                        ";
  protected final String TEXT_482 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_489 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_490 = " = pstmt_";
  protected final String TEXT_491 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_492 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_493 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_494 = " = rs_";
  protected final String TEXT_495 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_496 = " > 0) {";
  protected final String TEXT_497 = NL + "                        ";
  protected final String TEXT_498 = NL + "                            query_";
  protected final String TEXT_499 = " = ";
  protected final String TEXT_500 = ";";
  protected final String TEXT_501 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_502 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_503 = ".";
  protected final String TEXT_504 = ", pstmtUpdate_";
  ...
  protected final String TEXT_513 = NL + "                            query_";
  protected final String TEXT_514 = " = ";
  protected final String TEXT_515 = ";";
  protected final String TEXT_516 = NL + "                    globalMap.put(\"";
  protected final String TEXT_517 = "_QUERY\", query_";
  protected final String TEXT_518 = ".toString().trim());";
  protected final String TEXT_519 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_520 = " = updatedCount_";
  protected final String TEXT_521 = " + pstmtUpdate_";
  protected final String TEXT_522 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_527 = "Struct();";
  protected final String TEXT_528 = NL + "                                ";
  protected final String TEXT_529 = ".";
  protected final String TEXT_530 = " = ";
  protected final String TEXT_531 = ".";
  protected final String TEXT_532 = ";";
  protected final String TEXT_533 = NL + "                            rejectedCount_";
  protected final String TEXT_534 = " = rejectedCount_";
  protected final String TEXT_535 = " + 1;";
  protected final String TEXT_536 = NL + "                            ";
  protected final String TEXT_537 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_538 = ";";
  protected final String TEXT_539 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_540 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_541 = NL + "                        ";
  protected final String TEXT_542 = NL + "                            query_";
  protected final String TEXT_543 = " = ";
  protected final String TEXT_544 = ";";
  protected final String TEXT_545 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_551 = "_QUERY\", query_";
  protected final String TEXT_552 = ".toString().trim());";
  protected final String TEXT_553 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_554 = " = insertedCount_";
  protected final String TEXT_555 = " + pstmtInsert_";
  protected final String TEXT_556 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_557 = " = true;";
  protected final String TEXT_558 = NL + "                        throw(e);";
  protected final String TEXT_559 = NL + "                            ";
  protected final String TEXT_560 = " = new ";
  protected final String TEXT_561 = "Struct();";
  protected final String TEXT_562 = NL + "                                ";
  protected final String TEXT_563 = ".";
  protected final String TEXT_564 = " = ";
  protected final String TEXT_565 = ".";
  protected final String TEXT_566 = ";";
  protected final String TEXT_567 = NL + "                            rejectedCount_";
  protected final String TEXT_568 = " = rejectedCount_";
  protected final String TEXT_569 = " + 1;";
  ...
  protected final String TEXT_574 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_575 = "++;";
  protected final String TEXT_576 = NL + "            int updateFlag_";
  protected final String TEXT_577 = "=0;";
  protected final String TEXT_578 = NL + "                    ";
  protected final String TEXT_579 = NL + "                        query_";
  protected final String TEXT_580 = " = ";
  protected final String TEXT_581 = ";";
  protected final String TEXT_582 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_598 = NL + "                globalMap.put(\"";
  protected final String TEXT_599 = "_QUERY\", query_";
  protected final String TEXT_600 = ".toString().trim());";
  protected final String TEXT_601 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_602 = "=pstmtUpdate_";
  protected final String TEXT_603 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_604 = " = updatedCount_";
  protected final String TEXT_605 = "+updateFlag_";
  protected final String TEXT_606 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_607 = " = true;";
  protected final String TEXT_608 = NL + "                    throw(e);";
  protected final String TEXT_609 = NL + "                        ";
  protected final String TEXT_610 = " = new ";
  protected final String TEXT_611 = "Struct();";
  protected final String TEXT_612 = NL + "                            ";
  protected final String TEXT_613 = ".";
  protected final String TEXT_614 = " = ";
  protected final String TEXT_615 = ".";
  protected final String TEXT_616 = ";";
  protected final String TEXT_617 = NL + "                        rejectedCount_";
  protected final String TEXT_618 = " = rejectedCount_";
  ...
  protected final String TEXT_624 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_625 = " == 0) {" + NL + "            \t";
  protected final String TEXT_626 = NL + "\t\t\t\tquery_";
  protected final String TEXT_627 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_628 = NL + "                        ";
  protected final String TEXT_629 = NL + "                            query_";
  protected final String TEXT_630 = " = ";
  protected final String TEXT_631 = ";";
  protected final String TEXT_632 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_633 = ".";
  protected final String TEXT_634 = ", pstmtInsert_";
  protected final String TEXT_635 = ", ";
  protected final String TEXT_636 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_637 = NL + "                    globalMap.put(\"";
  protected final String TEXT_638 = "_QUERY\", query_";
  protected final String TEXT_639 = ".toString().trim());";
  protected final String TEXT_640 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_641 = " = insertedCount_";
  protected final String TEXT_642 = " + pstmtInsert_";
  protected final String TEXT_643 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_644 = " = true;";
  protected final String TEXT_645 = NL + "                        throw(e);";
  protected final String TEXT_646 = NL + "                            ";
  protected final String TEXT_647 = " = new ";
  protected final String TEXT_648 = "Struct();";
  protected final String TEXT_649 = NL + "                                ";
  protected final String TEXT_650 = ".";
  protected final String TEXT_651 = " = ";
  protected final String TEXT_652 = ".";
  protected final String TEXT_653 = ";";
  protected final String TEXT_654 = NL + "                            rejectedCount_";
  protected final String TEXT_655 = " = rejectedCount_";
  protected final String TEXT_656 = " + 1;";
  ...
  protected final String TEXT_661 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_662 = "++;";
  protected final String TEXT_663 = NL + "\t\t\t\t\t";
  protected final String TEXT_664 = NL + "                    \t";
  protected final String TEXT_665 = NL + "\t                        query_";
  ...
  protected final String TEXT_673 = "_QUERY\", query_";
  protected final String TEXT_674 = ".toString().trim());";
  protected final String TEXT_675 = NL + "    \t\tpstmt_";
  protected final String TEXT_676 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_677 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_678 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_679 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_680 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_681 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_682 = " = deletedCount_";
  protected final String TEXT_683 = " + pstmt_";
  protected final String TEXT_684 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_699 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_700 = ";";
  protected final String TEXT_701 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_702 = NL + "            }";
  protected final String TEXT_703 = NL + "            nb_line_";
  protected final String TEXT_704 = "++;";
  protected final String TEXT_705 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_716 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_717 = " <= batchSizeCounter_";
  protected final String TEXT_718 = ") {                ";
  protected final String TEXT_719 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_720 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_721 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_722 = " += pstmt_";
  protected final String TEXT_723 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_724 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_725 = " += pstmt_";
  protected final String TEXT_726 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_727 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_728 = " += pstmt_";
  protected final String TEXT_729 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_730 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_731 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_732 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_733 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_734 = NL + "                }";
  protected final String TEXT_735 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_736 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_737 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_738 = " <= commitCounter_";
  protected final String TEXT_739 = ") {" + NL + "                ";
  protected final String TEXT_740 = NL + "                try {" + NL + "                \t\tpstmt_";
  protected final String TEXT_741 = ".executeBatch();" + NL + "            \t    \t";
  ...
  protected final String TEXT_750 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_751 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_752 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_753 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_754 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_755 = NL + "                \tconn_";
  protected final String TEXT_756 = ".commit();                " + NL + "                \tcommitCounter_";
