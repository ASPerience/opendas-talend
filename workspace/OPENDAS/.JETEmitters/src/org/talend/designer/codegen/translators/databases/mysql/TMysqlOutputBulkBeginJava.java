...
public class TMysqlOutputBulkBeginJava
{
  ...
  protected final String TEXT_26 = NL + "\t\t\t\t" + NL + "\t\tcom.csvreader.CsvWriter csvWriter_";
  protected final String TEXT_27 = " = new com.csvreader.CsvWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        new java.io.FileOutputStream(file_";
  protected final String TEXT_28 = ", ";
  protected final String TEXT_29 = "), ";
  protected final String TEXT_30 = ")), fieldSeparator_";
  protected final String TEXT_31 = ");" + NL + "        " + NL + "        csvWriter_";
  protected final String TEXT_32 = ".setRecordDelimiter(rowSeparator_";
  protected final String TEXT_33 = ");              \t" + NL + "        csvWriter_";
  protected final String TEXT_34 = ".setEscapeMode(escape_mode_";
  protected final String TEXT_35 = ");      \t\t" + NL + "      \tcsvWriter_";
  protected final String TEXT_36 = ".setTextQualifier(textEnclosure_";
  protected final String TEXT_37 = "); " + NL + "      \tcsvWriter_";
  protected final String TEXT_38 = ".setForceQualifier(true);        ";
