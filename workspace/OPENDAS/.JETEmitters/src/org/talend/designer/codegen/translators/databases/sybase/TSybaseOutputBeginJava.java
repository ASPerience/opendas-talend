...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_33 = ";" + NL + "    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");";
  protected final String TEXT_34 = NL + "\t\tString url_";
  protected final String TEXT_35 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_36 = " + \":\" + ";
  protected final String TEXT_37 = " + \"/\" + ";
  protected final String TEXT_38 = "; ";
  protected final String TEXT_39 = NL + "\t\tString url_";
  protected final String TEXT_40 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_60 = " " + NL + "" + NL + "if(dbschema_";
  protected final String TEXT_61 = " != null && dbschema_";
  protected final String TEXT_62 = ".trim().length() != 0) {" + NL + "\ttableName_";
  protected final String TEXT_63 = " = dbschema_";
  protected final String TEXT_64 = " + \".\" + ";
  protected final String TEXT_65 = ";" + NL + "} ";
  protected final String TEXT_66 = NL + "int count_";
  ...
  protected final String TEXT_72 = "\");" + NL + "            stmtDrop_";
  protected final String TEXT_73 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_85 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_107 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_117 = "\t         " + NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  ...
  protected final String TEXT_129 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_155 = ".equalsIgnoreCase(";
  protected final String TEXT_156 = ") " + NL + "\t                \t&& (schema_";
  protected final String TEXT_157 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_227 = ", true);" + NL + "\t\t\t}";
  ...
  protected final String TEXT_254 = ") VALUES (";
  protected final String TEXT_255 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_262 = " WHERE ";
  protected final String TEXT_263 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".prepareStatement(update_";
  protected final String TEXT_266 = ");" + NL + "\t    ";
  protected final String TEXT_267 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_268 = " = conn_";
  protected final String TEXT_269 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_274 = ") VALUES (";
  protected final String TEXT_275 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_282 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_283 = " = conn_";
  protected final String TEXT_284 = ".prepareStatement(update_";
  protected final String TEXT_285 = ");\t" + NL + "\t    ";
  protected final String TEXT_286 = NL + "\t    String update_";
  protected final String TEXT_287 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_288 = " + \" SET ";
  protected final String TEXT_289 = " WHERE ";
  protected final String TEXT_290 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_291 = " = conn_";
  protected final String TEXT_292 = ".prepareStatement(update_";
  protected final String TEXT_293 = ");" + NL + "\t    String insert_";
  protected final String TEXT_294 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_295 = " + \" (";
  protected final String TEXT_296 = ") VALUES (";
  protected final String TEXT_297 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_298 = " = conn_";
  protected final String TEXT_299 = ".prepareStatement(insert_";
  protected final String TEXT_300 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_301 = NL + "\t    String delete_";
  protected final String TEXT_302 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_303 = " + \" WHERE ";
  protected final String TEXT_304 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_305 = " = conn_";
  protected final String TEXT_306 = ".prepareStatement(delete_";
  protected final String TEXT_307 = ");" + NL + "\t    ";
  protected final String TEXT_308 = NL + "        StringBuffer query_";
  protected final String TEXT_309 = " = null;" + NL + "       \t";
  protected final String TEXT_310 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_311 = " = insert_";
  ...
  protected final String TEXT_317 = NL + "\t\t\tupdate_";
  protected final String TEXT_318 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_319 = " = update_";
  protected final String TEXT_320 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_321 = " = insert_";
  protected final String TEXT_322 = ".split(\"\\\\?\");";
  protected final String TEXT_323 = NL + "\t\t\tdelete_";
  protected final String TEXT_324 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_325 = " = delete_";
  protected final String TEXT_326 = ".split(\"\\\\?\");";
  protected final String TEXT_327 = NL + "\t\t\treplace_";
  protected final String TEXT_328 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_329 = " = replace_";
  protected final String TEXT_330 = ".split(\"\\\\?\");";
  protected final String TEXT_331 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_332 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_333 = " = insertIgnore_";
  protected final String TEXT_334 = ".split(\"\\\\?\");";
  protected final String TEXT_335 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_336 = " = insert_";
  protected final String TEXT_337 = ".split(\"\\\\?\");";
  protected final String TEXT_338 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_339 = " = conn_";
  protected final String TEXT_340 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_341 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_342 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_343 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_344 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_345 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
