...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_82 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_83 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_88 = NL + "                if(!whetherExist_";
  protected final String TEXT_89 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_96 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_97 = " = conn_";
  protected final String TEXT_98 = ".createStatement();" + NL + "                    stmtDrop_";
  ...
  protected final String TEXT_103 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_109 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_110 = ".executeUpdate(\"";
  protected final String TEXT_111 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_112 = ".close();";
  protected final String TEXT_113 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_114 = " = conn_";
  protected final String TEXT_115 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_116 = " = stmtTruncCount_";
  protected final String TEXT_117 = ".executeQuery(\"";
  protected final String TEXT_118 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_121 = ".executeUpdate(\"";
  protected final String TEXT_122 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_123 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_124 = " += rsTruncCount_";
  protected final String TEXT_125 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_126 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_127 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_128 = ".close();            ";
  protected final String TEXT_129 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_130 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_131 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_132 = NL;
  protected final String TEXT_133 = NL;
  protected final String TEXT_134 = NL + "        String action_";
  protected final String TEXT_135 = " = \"";
  protected final String TEXT_136 = "\";" + NL + "        java.sql.CallableStatement callStmt_";
  protected final String TEXT_137 = " = null;" + NL + "        String sql_";
  protected final String TEXT_138 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        String param_";
  protected final String TEXT_139 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_140 = " + \"\\\" OF ";
  protected final String TEXT_141 = " DEL MODIFIED BY COLDEL\"+ ";
  protected final String TEXT_142 = " + " + NL + "        \t\t\t\t\" dateformat=\\\"\"+ ";
  protected final String TEXT_143 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_144 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_145 = " +\"\\\" ";
  protected final String TEXT_146 = " \" +" + NL + "        \t\t\t\t action_";
  protected final String TEXT_147 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_148 = " + \"\\\" ";
  protected final String TEXT_149 = "\";     \t\t\t" + NL + "        callStmt_";
  protected final String TEXT_150 = " = conn_";
  protected final String TEXT_151 = ".prepareCall(sql_";
  protected final String TEXT_152 = ");" + NL + "        callStmt_";
  protected final String TEXT_153 = ".setString(1, param_";
  protected final String TEXT_154 = ");" + NL + "        callStmt_";
  protected final String TEXT_155 = ".execute();        " + NL + "        callStmt_";
  protected final String TEXT_156 = ".close();";
  protected final String TEXT_157 = NL + "            int keyCount_";
  protected final String TEXT_158 = " = ";
  protected final String TEXT_159 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_160 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_161 = " = tableName_";
  protected final String TEXT_162 = ";" + NL + "            tableName_";
  protected final String TEXT_163 = " = \"tmp_";
  protected final String TEXT_164 = "\" + \"_\" + pid; " + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_165 = " = conn_";
  protected final String TEXT_166 = ".createStatement();" + NL + "            " + NL + "" + NL + "            " + NL + "            stmtCreateTmp_";
  protected final String TEXT_167 = ".execute(\"";
  protected final String TEXT_168 = "\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_169 = ".close();" + NL + "                        " + NL + "        \tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_170 = " = null;" + NL + "        \tString sql_";
  protected final String TEXT_171 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        \tString param_";
  protected final String TEXT_172 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_173 = ".replace(\"\\\\\",\"/\") + \"\\\" OF ";
  protected final String TEXT_174 = " DEL MODIFIED BY COLDEL\" + ";
  protected final String TEXT_175 = " + " + NL + "        \t\t\t\t\t\t\t\" dateformat=\\\"\"+";
  protected final String TEXT_176 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_177 = "+ \"\\\" timestampformat=\\\"\" + ";
  protected final String TEXT_178 = "+\"\\\"\" + " + NL + "        \t\t\t\t\t\t\t\" ";
  protected final String TEXT_179 = " INSERT INTO \\\"\"  + tableName_";
  protected final String TEXT_180 = " + \"\\\" ";
  protected final String TEXT_181 = "\"; \t        \t\t\t" + NL + "        \t" + NL + "        \tcallStmt_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = ".prepareCall(sql_";
  protected final String TEXT_184 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_185 = ".setString(1, param_";
  protected final String TEXT_186 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_187 = ".execute();        " + NL + "        \tcallStmt_";
  ...
  protected final String TEXT_192 = "\"+ \"_\" + pid;             " + NL + "            java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_197 = ".close();           " + NL + "            " + NL + "            tableName_";
  protected final String TEXT_198 = " = \"tmp_";
  protected final String TEXT_199 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_205 = NL + NL + NL + NL + NL + NL;
