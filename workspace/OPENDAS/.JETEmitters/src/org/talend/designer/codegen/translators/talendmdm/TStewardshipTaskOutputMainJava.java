...
public class TStewardshipTaskOutputMainJava
{
  ...
  protected final String TEXT_10 = "){" + NL + "\t\t\tSystem.err.println(\"Connect server false!\");" + NL + "\t\t}" + NL + "\t}" + NL + "\ttask_";
  protected final String TEXT_11 = " = tasks_";
  protected final String TEXT_12 = ".addTask();" + NL + "\ttask_";
  protected final String TEXT_13 = ".setBasicInfo(";
  ...
  protected final String TEXT_20 = NL + "\ttaskFlag_";
  protected final String TEXT_21 = " = ";
  protected final String TEXT_22 = ";\t" + NL + "}";
  protected final String TEXT_23 = NL + "\t" + NL + "org.talend.stewardship.Record record_";
  protected final String TEXT_24 = " = null;" + NL + "if(";
  protected final String TEXT_25 = ".";
  protected final String TEXT_26 = "){" + NL + "\trecord_";
  protected final String TEXT_27 = " = task_";
  protected final String TEXT_28 = ".addTargetRecord();" + NL + "}else{" + NL + "\trecord_";
  protected final String TEXT_29 = " = task_";
  protected final String TEXT_30 = ".addSourceRecord();";
  protected final String TEXT_31 = "\t" + NL + "\trecord_";
  protected final String TEXT_32 = ".setBasicInfo(";
  protected final String TEXT_33 = ",";
  protected final String TEXT_34 = ",";
  protected final String TEXT_35 = ");";
  protected final String TEXT_36 = NL + "\trecord_";
  protected final String TEXT_37 = ".setBasicInfo(";
  protected final String TEXT_38 = ");";
  protected final String TEXT_39 = "\t";
  protected final String TEXT_40 = NL + "    if(";
  protected final String TEXT_41 = "!=null && !\"\".equals(";
  protected final String TEXT_42 = ")){" + NL + "    \trecord_";
  protected final String TEXT_43 = ".addExtraInfo(";
  protected final String TEXT_44 = ",";
  protected final String TEXT_45 = ",\"";
  protected final String TEXT_46 = "\");" + NL + "    }";
  protected final String TEXT_47 = NL + "}";
  protected final String TEXT_48 = NL + "    \trecord_";
  protected final String TEXT_49 = ".addSrcColumn(\"";
