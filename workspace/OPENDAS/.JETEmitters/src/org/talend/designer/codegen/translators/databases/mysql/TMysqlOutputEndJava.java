...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_138 = "-1);" + NL + "\t\t\t\t\tcount";
  protected final String TEXT_139 = "+=count_dyn_";
  protected final String TEXT_140 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_141 = NL + "\t    " + NL + "\t            row2Count";
  protected final String TEXT_142 = "++;" + NL + "\t        }        " + NL + "\t        insertedCount_";
  protected final String TEXT_143 = " = insertedCount_";
  protected final String TEXT_144 = " + pstmt_";
  protected final String TEXT_145 = ".executeUpdate();" + NL + "\t    }";
  protected final String TEXT_146 = "                                                " + NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_147 = " != 0) {" + NL + "\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_148 = ".executeBatch();                \t" + NL + "\t            \t    \t";
  protected final String TEXT_149 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_150 = " += batchSizeCounter_";
  protected final String TEXT_151 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_152 = "                         \t    \t" + NL + "            \t    \t}" + NL + "            \t    \t\t" + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_153 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_154 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_155 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_156 = " = 0;    ";
  protected final String TEXT_157 = "    \t\t\t" + NL + "    \t\t";
  protected final String TEXT_158 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_159 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_160 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_161 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_162 = ".close();" + NL + "            " + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_163 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_164 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_165 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_166 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_167 = ".close();" + NL + "            " + NL + "        } " + NL + "        if(pstmtInsert_";
  protected final String TEXT_168 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_169 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_170 = NL + "\t";
  protected final String TEXT_171 = "                " + NL + "    try {" + NL + "\t\t\tpstmt_";
  protected final String TEXT_172 = ".executeBatch();                \t" + NL + "\t    \t";
  protected final String TEXT_173 = NL + "\t    \t\tif(pstmt_";
  protected final String TEXT_174 = ".getUpdateCount() != -1)" + NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_175 = " +=pstmt_";
  protected final String TEXT_176 = ".getUpdateCount(); " + NL + "\t    \t";
  protected final String TEXT_177 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_178 = " += pstmt_";
  protected final String TEXT_179 = ".getUpdateCount();" + NL + "\t    \t";
  protected final String TEXT_180 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_181 = " += pstmt_";
  protected final String TEXT_182 = ".getUpdateCount();" + NL + "\t    \t";
  protected final String TEXT_183 = "            \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_184 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_185 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_186 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_187 = "  " + NL + "    " + NL + "        if(pstmt_";
  ...
  protected final String TEXT_197 = NL + NL + "\tnb_line_deleted_";
  protected final String TEXT_198 = "=nb_line_deleted_";
  protected final String TEXT_199 = "+ deletedCount_";
  protected final String TEXT_200 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_201 = "=nb_line_update_";
  protected final String TEXT_202 = " + updatedCount_";
  protected final String TEXT_203 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_204 = "=nb_line_inserted_";
  protected final String TEXT_205 = " + insertedCount_";
  protected final String TEXT_206 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_207 = "=nb_line_rejected_";
  protected final String TEXT_208 = " + rejectedCount_";
  ...
  protected final String TEXT_218 = "_NB_LINE_REJECTED\", nb_line_rejected_";
