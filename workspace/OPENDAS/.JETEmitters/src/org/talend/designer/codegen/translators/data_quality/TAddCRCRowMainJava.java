...
public class TAddCRCRowMainJava
{
  ...
  protected final String TEXT_13 = " = new Long(crc32";
  protected final String TEXT_14 = ".getValue());";
  protected final String TEXT_15 = NL + "        " + NL + "                    crcComputedValue";
  protected final String TEXT_16 = " = new Long(com.dalsemi.onewire.utils.CRC8.compute(strBuffer_";
  protected final String TEXT_17 = ".toString().getBytes())); ";
  protected final String TEXT_18 = "      " + NL + "                    crcComputedValue";
  protected final String TEXT_19 = " = new Long(com.dalsemi.onewire.utils.CRC16.compute(strBuffer_";
