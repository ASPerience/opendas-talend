...
public class TMomInputBeginJava
{
  ...
  protected final String TEXT_178 = "=com.ibm.mq.MQC.MQOO_INPUT_SHARED | com.ibm.mq.MQC.MQOO_FAIL_IF_QUIESCING | com.ibm.mq.MQC.MQOO_INQUIRE;" + NL + "\t\t" + NL + "\t\t\tcom.ibm.mq.MQGetMessageOptions gmo";
  protected final String TEXT_179 = "=new com.ibm.mq.MQGetMessageOptions();" + NL + "\t\t\tgmo";
  protected final String TEXT_180 = ".options=gmo";
  protected final String TEXT_181 = ".options+com.ibm.mq.MQC.MQGMO_SYNCPOINT;" + NL + "\t\t\tgmo";
  protected final String TEXT_182 = ".options=gmo";
  protected final String TEXT_183 = ".options+com.ibm.mq.MQC.";
  protected final String TEXT_184 = "MQGMO_NO_WAIT";
  protected final String TEXT_185 = "MQGMO_WAIT";
  protected final String TEXT_186 = ";" + NL + "\t\t\tgmo";
  protected final String TEXT_187 = ".options=gmo";
  protected final String TEXT_188 = ".options+com.ibm.mq.MQC.MQGMO_FAIL_IF_QUIESCING;" + NL + "\t\t\tgmo";
  protected final String TEXT_189 = ".waitInterval=com.ibm.mq.MQC.MQWI_UNLIMITED;" + NL + "\t\t\tcom.ibm.mq.MQException.log = null;" + NL + "\t\t\tboolean flag";
  protected final String TEXT_190 = "=true;" + NL + "\t\t" + NL + "\t\t\tqMgr";
  protected final String TEXT_191 = "=new com.ibm.mq.MQQueueManager(";
  protected final String TEXT_192 = ",properties";
  protected final String TEXT_193 = ");" + NL + "\t\t\tremoteQ";
  protected final String TEXT_194 = "=qMgr";
  protected final String TEXT_195 = ".accessQueue(";
  protected final String TEXT_196 = ",openOptions";
  protected final String TEXT_197 = ");" + NL + "\t";
  protected final String TEXT_198 = NL + "\t\t\tif(Integer.valueOf(remoteQ";
  protected final String TEXT_199 = ".getCurrentDepth()).equals(0))" + NL + "\t\t\t{" + NL + "\t\t\t\tflag";
  protected final String TEXT_200 = "= false;" + NL + "\t\t\t} \t";
  protected final String TEXT_201 = "\t" + NL + "\t\t\tSystem.out.println(\"Ready to receive message\");" + NL + "\t\t\tSystem.out.println(\"Waiting...\");\t" + NL + "\t\t\twhile(flag";
  protected final String TEXT_202 = "){";
  protected final String TEXT_203 = NL + "\t\t\tif(Integer.valueOf(remoteQ";
  protected final String TEXT_204 = ".getCurrentDepth()).equals(1))" + NL + "\t\t\t{" + NL + "\t\t\t\tflag";
  protected final String TEXT_205 = "= false;" + NL + "\t\t\t} \t\t\t";
  protected final String TEXT_206 = NL + "\t\t\tcom.ibm.mq.MQMessage inMessage";
  protected final String TEXT_207 = "=new com.ibm.mq.MQMessage();";
  protected final String TEXT_208 = NL + "\t\t\tinMessage";
  protected final String TEXT_209 = ".messageId = msgId_";
  protected final String TEXT_210 = ".getBytes(\"ISO-8859-15\");";
  protected final String TEXT_211 = "\t\t" + NL + "\t\t\ttry{" + NL + "\t\t\t\tremoteQ";
  protected final String TEXT_212 = ".get(inMessage";
  protected final String TEXT_213 = ",gmo";
  protected final String TEXT_214 = ");" + NL + "\t\t\t}catch (com.ibm.mq.MQException me_";
  protected final String TEXT_215 = ") {   " + NL + "\t            if (me_";
  protected final String TEXT_216 = ".reasonCode == com.ibm.mq.MQException.MQRC_NO_MSG_AVAILABLE) {" + NL + "\t            \tbreak;   " + NL + "\t            }else{" + NL + "\t            \tthrow me_";
  protected final String TEXT_217 = ";" + NL + "\t            }   " + NL + "\t     \t}";
  protected final String TEXT_218 = NL + "\t\t\tremoteQ";
  protected final String TEXT_219 = ".get(inMessage";
  protected final String TEXT_220 = ",gmo";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL;
  protected final String TEXT_223 = NL + "\t\t//\tString msg_";
  protected final String TEXT_224 = "=inMessage";
  protected final String TEXT_225 = ".readStringOfCharLength(inMessage";
  protected final String TEXT_226 = ".getMessageLength());" + NL + "\t\tString msg_";
  protected final String TEXT_227 = "=inMessage";
  protected final String TEXT_228 = ".readObject().toString();";
  protected final String TEXT_229 = NL + "\t\t\tbyte[] bytesMsgBody_";
  protected final String TEXT_230 = " = new byte[inMessage";
  protected final String TEXT_231 = ".getMessageLength()];" + NL + "\t\t\tinMessage";
  protected final String TEXT_232 = ".readFully(bytesMsgBody_";
  protected final String TEXT_233 = ");" + NL + "\t\t\tString msg_";
  protected final String TEXT_234 = " = new String(bytesMsgBody_";
  protected final String TEXT_235 = ");";
  protected final String TEXT_236 = NL + "\t\t\tjava.util.Map msg_";
  protected final String TEXT_237 = " = (java.util.Map)inMessage";
  protected final String TEXT_238 = ".readObject();\t\t\t  ";
  protected final String TEXT_239 = NL + "\t\t\tqMgr";
  protected final String TEXT_240 = ".commit();";
  protected final String TEXT_241 = NL + "\t\t\t\t\t";
  protected final String TEXT_242 = ".from=";
  protected final String TEXT_243 = ";\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_244 = ".message=msg_";
  protected final String TEXT_245 = ";\t";
  protected final String TEXT_246 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_247 = ".";
  protected final String TEXT_248 = " = (";
  protected final String TEXT_249 = ")msg_";
  protected final String TEXT_250 = ".get(\"";
  protected final String TEXT_251 = "\");" + NL;
  protected final String TEXT_252 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_253 = ".";
  protected final String TEXT_254 = " = inMessage";
  protected final String TEXT_255 = ".";
  protected final String TEXT_256 = ";";
  protected final String TEXT_257 = NL + "\t\t\t\t";
  protected final String TEXT_258 = ".messageid=new String(inMessage";
  protected final String TEXT_259 = ".messageId,\"ISO-8859-15\");\t";
