...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_140 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_141 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_142 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_143 = " + \";HDR=";
  protected final String TEXT_144 = "].[\" + fileName_";
  protected final String TEXT_145 = " + \"]\";";
  protected final String TEXT_146 = NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_147 = " = conn_";
  protected final String TEXT_148 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_149 = ".execute(bulkInsert_";
