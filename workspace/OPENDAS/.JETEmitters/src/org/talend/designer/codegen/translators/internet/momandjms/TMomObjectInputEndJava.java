...
public class TMomObjectInputEndJava
{
  protected static String nl;
  public static synchronized TMomObjectInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMomObjectInputEndJava result = new TMomObjectInputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_13 = ".close();" + NL + "\t\tqMgr";
  protected final String TEXT_14 = ".disconnect();" + NL + "\t" + NL + "\t}" + NL + "\tcatch(com.ibm.mq.MQException ex){" + NL + "\t\tSystem.out.println(\"A WebSphere MQ error occurred : Completion code \" + ex.completionCode + \" Reason code \" + ex.reasonCode);" + NL + "\t\tremoteQ";
