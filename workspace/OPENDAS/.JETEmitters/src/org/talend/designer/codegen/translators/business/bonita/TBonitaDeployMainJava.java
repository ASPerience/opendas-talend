...
public class TBonitaDeployMainJava
{
  ...
  protected final String TEXT_10 = " = new javax.security.auth.login.LoginContext(\"Bonita\", new org.ow2.novabpm.util.SimpleCallbackHandler(";
  protected final String TEXT_11 = ", ";
  protected final String TEXT_12 = "));" + NL + "\t\tloginContext_";
  protected final String TEXT_13 = ".login();" + NL + "\t\tprocess_";
  protected final String TEXT_14 = " = managementAPI_";
  protected final String TEXT_15 = ".deploy(org.ow2.bonita.util.BusinessArchiveFactory.getBusinessArchive(new java.io.File(";
  protected final String TEXT_16 = ").toURI().toURL()));" + NL + "\t\tprocessDefinitionUUID_";
  protected final String TEXT_17 = " = process_";
  protected final String TEXT_18 = ".getUUID().getValue();" + NL + "\t\t" + NL + "\t\tSystem.out.println(\"**** Process \"+ processDefinitionUUID_";
  protected final String TEXT_19 = " + \" deploy successful ****\");" + NL + "" + NL + "\t} catch (javax.security.auth.login.LoginException le_";
  protected final String TEXT_20 = ") {//just login exception";
  protected final String TEXT_21 = NL + "\t\tthrow le_";
  protected final String TEXT_22 = ";\t\t";
  protected final String TEXT_23 = NL + "\t\tSystem.err.println(le_";
  protected final String TEXT_24 = ".getCause().getMessage());";
  ...
  protected final String TEXT_31 = NL + "\t} finally {" + NL + "\t\tloginContext_";
  protected final String TEXT_32 = ".logout();" + NL + "\t}" + NL + "" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_33 = "_ProcessDefinitionUUID\", processDefinitionUUID_";
