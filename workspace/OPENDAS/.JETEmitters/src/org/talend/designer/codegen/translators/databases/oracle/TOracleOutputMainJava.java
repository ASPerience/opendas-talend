...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_69 = "\t         " + NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_70 = " = conn_";
  protected final String TEXT_71 = " + \"[checktable]\" + \"[\" + ";
  ...
  protected final String TEXT_205 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_206 = " + \" (";
  protected final String TEXT_207 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_208 = ".";
  protected final String TEXT_209 = ",\"";
  protected final String TEXT_210 = "\")+\") VALUES (";
  protected final String TEXT_211 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_212 = ".";
  protected final String TEXT_213 = ")+\")\";";
  protected final String TEXT_214 = NL + "\t\t\t\t\t\tString insert_";
  protected final String TEXT_215 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_216 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_217 = ".";
  protected final String TEXT_218 = ", \"";
  protected final String TEXT_219 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_220 = ".";
  protected final String TEXT_221 = ")+\")\";";
  protected final String TEXT_222 = NL + "\t\t\t\t";
  protected final String TEXT_223 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_224 = " = new StringBuffer(insert_";
  protected final String TEXT_225 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_226 = ".insert(insert_";
  protected final String TEXT_227 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_228 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_229 = " =insertStringBuffer_";
  protected final String TEXT_230 = ".toString(); ";
  protected final String TEXT_231 = "    \t    " + NL + "\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_232 = NL + "\t\t\t\t\t\t\t\tpstmt_";
  ...
  protected final String TEXT_237 = NL + "\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_238 = " = null;         " + NL + "\t\t\t\t\t\t\t\t// [%connection%][psmt][tableName]" + NL + "\t\t\t\t\t\t\t\tString keyPsmt_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_241 = " + \"]\";" + NL + "\t\t\t\t\t\t\t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_242 = ")== null){" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".prepareStatement(insert_";
  protected final String TEXT_245 = ");\t\t" + NL + "\t\t\t\t\t\t\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_246 = ", pstmt_";
  protected final String TEXT_247 = ");" + NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\tpstmt_";
  protected final String TEXT_248 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_267 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_268 = " = new StringBuffer(update_";
  protected final String TEXT_269 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_270 = ".insert(update_";
  protected final String TEXT_271 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_272 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_273 = " =updateStringBuffer_";
  protected final String TEXT_274 = ".toString(); ";
  protected final String TEXT_275 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_276 = " = conn_";
  protected final String TEXT_277 = ".prepareStatement(update_";
  protected final String TEXT_278 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_279 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_287 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_288 = ".";
  protected final String TEXT_289 = ", \"";
  protected final String TEXT_290 = "\")+\") VALUES (";
  protected final String TEXT_291 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_292 = ".";
  protected final String TEXT_293 = ")+\")\";";
  protected final String TEXT_294 = NL + "\t\t\t\t\t\tString insert_";
  protected final String TEXT_295 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_296 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_297 = ".";
  protected final String TEXT_298 = ", \"";
  protected final String TEXT_299 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_305 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_312 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_326 = "    " + NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_327 = " = conn_";
  protected final String TEXT_328 = ".prepareStatement(insert_";
  protected final String TEXT_329 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_330 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_331 = " = new StringBuffer(update_";
  protected final String TEXT_332 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_333 = ".insert(update_";
  protected final String TEXT_334 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_335 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_336 = " =updateStringBuffer_";
  ...
  protected final String TEXT_342 = NL + "\t\t\t\t\t\t\tString insert_";
  protected final String TEXT_343 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_344 = " + \" (";
  protected final String TEXT_345 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_346 = ".";
  protected final String TEXT_347 = ", \"";
  protected final String TEXT_348 = "\")+\") VALUES (";
  ...
  protected final String TEXT_357 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_376 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_377 = " = new StringBuffer(update_";
  protected final String TEXT_378 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_379 = ".insert(update_";
  protected final String TEXT_380 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_381 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_382 = " =updateStringBuffer_";
  protected final String TEXT_383 = ".toString(); ";
  protected final String TEXT_384 = NL + "\t\t\t\tpstmtUpdate_";
  protected final String TEXT_385 = " = conn_";
  protected final String TEXT_386 = ".prepareStatement(update_";
  ...
  protected final String TEXT_396 = "    " + NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_397 = " = conn_";
  protected final String TEXT_398 = ".prepareStatement(insert_";
  protected final String TEXT_399 = ");\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_400 = NL + "\t\t\t\tString delete_";
  protected final String TEXT_401 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_402 = " + \" WHERE ";
  protected final String TEXT_403 = "\";" + NL + "\t\t\t\t";
  protected final String TEXT_404 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_405 = " = new StringBuffer(delete_";
  protected final String TEXT_406 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_407 = ".insert(delete_";
  protected final String TEXT_408 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_409 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_410 = " =deleteStringBuffer_";
  protected final String TEXT_411 = ".toString();  ";
  protected final String TEXT_412 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_413 = " = conn_";
  protected final String TEXT_414 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_424 = ".split(\"\\\\?\");";
  protected final String TEXT_425 = NL + "\t\t\tupdate_";
  protected final String TEXT_426 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_427 = " = update_";
  protected final String TEXT_428 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_429 = " = insert_";
  protected final String TEXT_430 = ".split(\"\\\\?\");";
  protected final String TEXT_431 = NL + "\t\t\tdelete_";
  protected final String TEXT_432 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_433 = " = delete_";
  protected final String TEXT_434 = ".split(\"\\\\?\");";
  ...
  protected final String TEXT_439 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_440 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_441 = " = insertIgnore_";
  protected final String TEXT_442 = ".split(\"\\\\?\");";
  protected final String TEXT_443 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_444 = " = insert_";
  ...
  protected final String TEXT_449 = " = new StringBuffer(\"\");";
  protected final String TEXT_450 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_451 = " = buffersSize_";
  protected final String TEXT_452 = ";";
  protected final String TEXT_453 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_454 = " = buffersSize_";
  protected final String TEXT_455 = ";";
  protected final String TEXT_456 = NL + NL + "\t\t";
  protected final String TEXT_457 = NL + "        whetherReject_";
  protected final String TEXT_458 = " = false;";
  protected final String TEXT_459 = NL + "\t\t\t\t\t     \t// TODO unable to parse integer: ";
  protected final String TEXT_460 = NL + "\t\t\t\t\t     \t// TODO error: ";
  protected final String TEXT_461 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_462 = NL + "                    \torg.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_463 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_464 = ".";
  protected final String TEXT_465 = ";" + NL + "\t                    com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_466 = " = tGeometry_";
  protected final String TEXT_467 = "._getInternalGeometry();" + NL + "                    \t" + NL + "                    \tcom.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_468 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_469 = "\");" + NL + "                    \tif (extends_";
  protected final String TEXT_470 = " == null) {" + NL + "                    \t    geometryColumnToExtends.put(\"";
  protected final String TEXT_471 = "\", geometry_";
  protected final String TEXT_472 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "                    \telse {" + NL + "                    \t    extends_";
  protected final String TEXT_473 = ".expandToInclude(geometry_";
  protected final String TEXT_474 = ".getEnvelopeInternal()); " + NL + "                    \t}" + NL + "                    \t" + NL + "\t\t\t\t\t\tString wkt_";
  protected final String TEXT_475 = " = geometry_";
  protected final String TEXT_476 = ".toText();" + NL + "\t\t\t\t\t\toracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_477 = " = new oracle.spatial.util.WKT();" + NL + "\t\t\t\t\t\toracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_478 = " = oracle_wkt_";
  protected final String TEXT_479 = ".toJGeometry(wkt_";
  protected final String TEXT_480 = ".getBytes());" + NL;
  protected final String TEXT_481 = NL + "\t\t\t\t\t\t\tjgeometry_";
  protected final String TEXT_482 = ".setSRID(";
  protected final String TEXT_483 = ");";
  protected final String TEXT_484 = NL + "               \t\tpstmt_";
  protected final String TEXT_485 = ".setObject(";
  protected final String TEXT_486 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_493 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_499 = "_QUERY\", query_";
  protected final String TEXT_500 = ".toString().trim());";
  protected final String TEXT_501 = NL + "    \t\t";
  protected final String TEXT_502 = NL + "    \t\tpstmt_";
  protected final String TEXT_503 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_504 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_505 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_506 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_507 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_508 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_509 = " = insertedCount_";
  protected final String TEXT_510 = " + pstmt_";
  protected final String TEXT_511 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_512 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_513 = " = true;";
  protected final String TEXT_514 = NL + "                    throw(e);";
  protected final String TEXT_515 = NL + "                        ";
  protected final String TEXT_516 = " = new ";
  protected final String TEXT_517 = "Struct();";
  protected final String TEXT_518 = NL + "                            ";
  protected final String TEXT_519 = ".";
  protected final String TEXT_520 = " = ";
  protected final String TEXT_521 = ".";
  protected final String TEXT_522 = ";";
  protected final String TEXT_523 = NL + "                        rejectedCount_";
  protected final String TEXT_524 = " = rejectedCount_";
  protected final String TEXT_525 = " + 1;";
  protected final String TEXT_526 = NL + "                        ";
  protected final String TEXT_527 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_528 = ";";
  protected final String TEXT_529 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_535 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_536 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_537 = ".";
  protected final String TEXT_538 = ", pstmt_";
  protected final String TEXT_539 = ", ";
  protected final String TEXT_540 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_541 = NL + "                    " + NL + "\t\t\t\t\t";
  protected final String TEXT_542 = NL + "                    \t";
  protected final String TEXT_543 = NL + "                        query_";
  ...
  protected final String TEXT_552 = "_QUERY\", query_";
  protected final String TEXT_553 = ".toString().trim());";
  ...
  protected final String TEXT_561 = NL + "             try {" + NL + "                updatedCount_";
  protected final String TEXT_562 = " = updatedCount_";
  protected final String TEXT_563 = " + pstmt_";
  protected final String TEXT_564 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_565 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_589 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_590 = " = pstmt_";
  protected final String TEXT_591 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_592 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_593 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_594 = " = rs_";
  protected final String TEXT_595 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_596 = " > 0) {";
  protected final String TEXT_597 = NL + "                        ";
  protected final String TEXT_598 = NL + "                            query_";
  protected final String TEXT_599 = " = ";
  protected final String TEXT_600 = ";";
  protected final String TEXT_601 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_602 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_619 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_620 = " = updatedCount_";
  protected final String TEXT_621 = " + pstmtUpdate_";
  protected final String TEXT_622 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_640 = NL + "                }" + NL + "    \t\t} else {";
  ...
  protected final String TEXT_653 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_654 = " = insertedCount_";
  protected final String TEXT_655 = " + pstmtInsert_";
  protected final String TEXT_656 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_673 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_674 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_675 = "++;" + NL + "    \t\t";
  protected final String TEXT_676 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_682 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_683 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_684 = ".";
  protected final String TEXT_685 = ", pstmtUpdate_";
  ...
  protected final String TEXT_701 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_702 = " = pstmtUpdate_";
  protected final String TEXT_703 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_704 = " = updatedCount_";
  protected final String TEXT_705 = "+updateFlag_";
  protected final String TEXT_706 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_724 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_725 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_726 = NL + "\t\t\t\tquery_";
  protected final String TEXT_727 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_728 = NL + "                        ";
  protected final String TEXT_729 = NL + "                            query_";
  protected final String TEXT_730 = " = ";
  protected final String TEXT_731 = ";";
  protected final String TEXT_732 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_733 = ".";
  protected final String TEXT_734 = ", pstmtInsert_";
  ...
  protected final String TEXT_740 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_741 = " = insertedCount_";
  protected final String TEXT_742 = " + pstmtInsert_";
  protected final String TEXT_743 = ".executeUpdate();" + NL + "                   " + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_761 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_777 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_778 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_779 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_780 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_781 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_782 = " = deletedCount_";
  ...
  protected final String TEXT_803 = NL + "            nb_line_";
  protected final String TEXT_804 = "++;" + NL + "    \t";
  protected final String TEXT_805 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_816 = "                                                " + NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_817 = " <= batchSizeCounter_";
  protected final String TEXT_818 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_819 = ".executeBatch();" + NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_820 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_821 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_822 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_823 = " = pstmt_";
  protected final String TEXT_824 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  protected final String TEXT_825 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_826 = NL + "        \t    \t";
  protected final String TEXT_827 = NL + "        \t    \t\tupdatedCount_";
  protected final String TEXT_828 = NL + "        \t    \t";
  protected final String TEXT_829 = NL + "        \t    \t    deletedCount_";
  protected final String TEXT_830 = NL + "        \t    \t";
  protected final String TEXT_831 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_832 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_833 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_834 = " = 0;             \t                \t                \t" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_835 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_836 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_837 = " <= commitCounter_";
  protected final String TEXT_838 = ") {" + NL + "                " + NL + "\t                ";
  protected final String TEXT_839 = NL + "\t\t                try {" + NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_840 = ".executeBatch();" + NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_841 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_842 = NL + "\t\t                        System.out.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_843 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_844 = " = pstmt_";
  protected final String TEXT_845 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  protected final String TEXT_846 = NL + "\t\t    \t    \t\tinsertedCount_";
  protected final String TEXT_847 = NL + "\t\t    \t    \t";
  protected final String TEXT_848 = "            \t    \t\t" + NL + "\t\t    \t    \t\tupdatedCount_";
  protected final String TEXT_849 = NL + "\t\t    \t    \t";
  protected final String TEXT_850 = NL + "\t\t    \t    \t    deletedCount_";
  protected final String TEXT_851 = NL + "\t\t    \t    \t";
  protected final String TEXT_852 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_853 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_854 = ":0);" + NL + "\t                ";
  protected final String TEXT_855 = NL + "                \tconn_";
  protected final String TEXT_856 = ".commit();                " + NL + "                \tcommitCounter_";
