...
public class TWebServiceMainJava
{
  ...
  protected final String TEXT_92 = " = returnValuesMap_";
  protected final String TEXT_93 = ".get(\"";
  protected final String TEXT_94 = "\").toString().getBytes();";
  protected final String TEXT_95 = NL + "\t\t\t\t\t";
  protected final String TEXT_96 = ".";
  protected final String TEXT_97 = " = (List<Object>)returnValuesMap_";
