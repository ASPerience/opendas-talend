...
public class TFixedFlowInputEndJava
{
  ...
  protected final String TEXT_3 = NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\tcacheList_";
  protected final String TEXT_4 = ".clear();" + NL + "\tglobalMap.put(\"NB_LINE\", nb_line_";
  protected final String TEXT_5 = ");";
  protected final String TEXT_6 = NL + "\t\t}" + NL + "\t  fid_";
  protected final String TEXT_7 = ".close();" + NL + "\t}" + NL + "" + NL + "\tglobalMap.put(\"NB_LINE\", nb_line_";
