...
public class TFileInputMSDelimitedBeginJava
{
  ...
  protected final String TEXT_176 = ");" + NL + "if ( (rowSeparator_";
  protected final String TEXT_177 = "[0] != '\\n') && (rowSeparator_";
  protected final String TEXT_178 = "[0] != '\\r') )" + NL + "\t";
  protected final String TEXT_179 = "csvReader";
  protected final String TEXT_180 = ".setRecordDelimiter(rowSeparator_";
  protected final String TEXT_181 = "[0]);" + NL;
  protected final String TEXT_182 = NL;
  protected final String TEXT_183 = "csvReader";
  protected final String TEXT_184 = ".setTextQualifier('";
  protected final String TEXT_185 = "');" + NL;
  protected final String TEXT_186 = NL;
  protected final String TEXT_187 = "csvReader";
  protected final String TEXT_188 = ".setEscapeMode(com.csvreader.CsvReader.ESCAPE_MODE_BACKSLASH);";
  protected final String TEXT_189 = NL;
  protected final String TEXT_190 = "csvReader";
  protected final String TEXT_191 = ".setEscapeMode(com.csvreader.CsvReader.ESCAPE_MODE_DOUBLED);";
  protected final String TEXT_192 = NL + "//?????doesn't work for other escapeChar";
  protected final String TEXT_193 = "\t" + NL + "String[] delim_";
  protected final String TEXT_194 = " = new String[]{";
  protected final String TEXT_195 = NL;
  protected final String TEXT_196 = NL + "};" + NL + "" + NL + "//java.io.BufferedReader reader_";
  protected final String TEXT_197 = " = new java.io.BufferedReader(new java.io.FileReader(";
  protected final String TEXT_198 = "));" + NL + "" + NL + "String tmp";
  protected final String TEXT_199 = " = \"\";";
  protected final String TEXT_200 = "      " + NL + "" + NL + "int index_";
  protected final String TEXT_201 = " = Integer.parseInt(";
  protected final String TEXT_202 = ");" + NL + "" + NL + "String[] row";
  protected final String TEXT_203 = "=null;" + NL + "  " + NL + "String temp_";
  protected final String TEXT_204 = " = null;" + NL + "" + NL + "while ( ";
  protected final String TEXT_205 = "csvReader";
  protected final String TEXT_206 = ".readRecord() ) {";
  protected final String TEXT_207 = NL + "\trow";
  protected final String TEXT_208 = "=csvReader";
  protected final String TEXT_209 = ".getValues();" + NL + "\t";
  protected final String TEXT_210 = NL + "\tfor(int ii_";
  protected final String TEXT_211 = "=0;ii_";
  protected final String TEXT_212 = " < row";
  protected final String TEXT_213 = ".length;ii_";
  protected final String TEXT_214 = "++){" + NL + "\t\trow";
  protected final String TEXT_215 = "[ii_";
  protected final String TEXT_216 = "] = row";
  protected final String TEXT_217 = "[ii_";
  protected final String TEXT_218 = "].trim(); " + NL + "\t}" + NL + "\t";
  protected final String TEXT_219 = NL + "\ttmp";
  protected final String TEXT_220 = " = ";
  protected final String TEXT_221 = "csvReader";
  protected final String TEXT_222 = ".getRawRecord();" + NL + "\tfor(int i_";
  protected final String TEXT_223 = "=0; i_";
  protected final String TEXT_224 = "<delim_";
  protected final String TEXT_225 = ".length; i_";
  protected final String TEXT_226 = "++){ //NS000" + NL + "\t\tcom.csvreader.CsvReader csvReader";
  protected final String TEXT_227 = " = new com.csvreader.CsvReader(new java.io.BufferedReader(new java.io.InputStreamReader(" + NL + "\t\t\tnew java.io.ByteArrayInputStream(tmp";
  protected final String TEXT_228 = ".getBytes()), ";
  protected final String TEXT_229 = ")), delim_";
  protected final String TEXT_230 = "[i_";
  protected final String TEXT_231 = "].charAt(0));" + NL + "\t\tif ( (rowSeparator_";
  protected final String TEXT_232 = "[0] != '\\n') && (rowSeparator_";
  protected final String TEXT_233 = "[0] != '\\r') )" + NL + "\t\t\tcsvReader";
  protected final String TEXT_234 = ".setRecordDelimiter(rowSeparator_";
  protected final String TEXT_235 = "[0]);" + NL + "\t\t" + NL + "\t\tcsvReader";
  protected final String TEXT_236 = ".setTextQualifier('";
  protected final String TEXT_237 = "');";
  protected final String TEXT_238 = NL + "\t\tcsvReader";
  protected final String TEXT_239 = ".setEscapeMode(com.csvreader.CsvReader.ESCAPE_MODE_BACKSLASH);";
  protected final String TEXT_240 = NL + "\t\tcsvReader";
  protected final String TEXT_241 = ".setEscapeMode(com.csvreader.CsvReader.ESCAPE_MODE_DOUBLED);";
  protected final String TEXT_242 = NL + "\t\t//?????doesn't work for other escapeChar";
  protected final String TEXT_243 = NL;
  protected final String TEXT_244 = NL + "\t";
  protected final String TEXT_245 = " = null;";
  protected final String TEXT_246 = "\t\t";
  protected final String TEXT_247 = NL + NL + "\t\tif(csvReader";
  protected final String TEXT_248 = ".readRecord()==false) {" + NL + "\t\t\tcsvReader";
  protected final String TEXT_249 = ".close();" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\trow";
  protected final String TEXT_250 = " = csvReader";
  protected final String TEXT_251 = ".getValues();" + NL + "    \t";
  protected final String TEXT_252 = NL + "    \tfor(int ii_";
  protected final String TEXT_253 = "=0;ii_";
  protected final String TEXT_254 = " < row";
  protected final String TEXT_255 = ".length;ii_";
  protected final String TEXT_256 = "++){" + NL + "    \t\trow";
  protected final String TEXT_257 = "[ii_";
  protected final String TEXT_258 = "] = row";
  protected final String TEXT_259 = "[ii_";
  protected final String TEXT_260 = "].trim(); " + NL + "    \t}" + NL + "    \t";
  protected final String TEXT_261 = NL + "\t\tif (row";
  protected final String TEXT_262 = " == null" + NL + "\t\t\t\t|| row";
  protected final String TEXT_263 = ".length <= index_";
  protected final String TEXT_264 = ") {" + NL + "\t\t\tcontinue;" + NL + "\t\t}";
  protected final String TEXT_265 = NL + "\t\ttry{";
  protected final String TEXT_266 = NL + "\t";
  protected final String TEXT_267 = "if((row";
  protected final String TEXT_268 = ".length == 0) ? (\"\".equals(";
  protected final String TEXT_269 = ")) : " + NL + "\t(row";
  protected final String TEXT_270 = "[index_";
  protected final String TEXT_271 = "].equals(";
  protected final String TEXT_272 = ")";
  protected final String TEXT_273 = ")){";
  protected final String TEXT_274 = NL + "\t\tkey_";
  protected final String TEXT_275 = "_";
  protected final String TEXT_276 = "++;";
  protected final String TEXT_277 = NL + "\t\tkey_";
  protected final String TEXT_278 = "_";
  protected final String TEXT_279 = " = (row";
  protected final String TEXT_280 = ".length <= ";
  protected final String TEXT_281 = ") ? \"\" : row";
  protected final String TEXT_282 = "[";
  protected final String TEXT_283 = "];";
  protected final String TEXT_284 = NL + "\t\tif((count_";
  protected final String TEXT_285 = "_";
  protected final String TEXT_286 = " < lowBound_";
  protected final String TEXT_287 = "_";
  protected final String TEXT_288 = ") || (count_";
  protected final String TEXT_289 = "_";
  protected final String TEXT_290 = " > highBound_";
  protected final String TEXT_291 = "_";
  protected final String TEXT_292 = ")){" + NL + "\t\t\tthrow new Exception(\"Data error in file: The cardinality for \" + ";
  protected final String TEXT_293 = " + \" is ";
  protected final String TEXT_294 = ", but we have found \" + count_";
  protected final String TEXT_295 = "_";
  protected final String TEXT_296 = " + \".\");//thow exception............" + NL + "\t\t}" + NL + "\t\tcount_";
  protected final String TEXT_297 = "_";
  protected final String TEXT_298 = " = 0;";
  protected final String TEXT_299 = NL + "\t\tcount_";
  ...
  protected final String TEXT_313 = " + \".\");//thow exception............" + NL + "\t\t}";
  protected final String TEXT_314 = NL + "\t\t";
  protected final String TEXT_315 = " = new ";
  protected final String TEXT_316 = "Struct();";
  protected final String TEXT_317 = NL + "\t\t";
  protected final String TEXT_318 = ".";
  protected final String TEXT_319 = " = String.valueOf(key_";
  protected final String TEXT_320 = "_";
  protected final String TEXT_321 = ");";
  protected final String TEXT_322 = NL + "\t\t";
  protected final String TEXT_323 = ".";
  protected final String TEXT_324 = " = (row";
  protected final String TEXT_325 = ".length <= ";
  protected final String TEXT_326 = ") ? \"\" : row";
  protected final String TEXT_327 = "[";
  protected final String TEXT_328 = "];";
  protected final String TEXT_329 = NL + "\t\ttemp_";
  protected final String TEXT_330 = " = String.valueOf(key_";
  protected final String TEXT_331 = "_";
  protected final String TEXT_332 = ");";
  protected final String TEXT_333 = NL + "\t\ttemp_";
  protected final String TEXT_334 = " = (row";
  protected final String TEXT_335 = ".length <= ";
  protected final String TEXT_336 = ") ? \"\" : row";
  protected final String TEXT_337 = "[";
  protected final String TEXT_338 = "];";
  protected final String TEXT_339 = NL + "\t\tif(temp_";
  protected final String TEXT_340 = ".length() > 0) {";
  protected final String TEXT_341 = NL + "\t\t\t";
  protected final String TEXT_342 = ".";
  protected final String TEXT_343 = " = temp_";
  protected final String TEXT_344 = ".getBytes(";
  protected final String TEXT_345 = ");";
  protected final String TEXT_346 = "\t\t\t";
  protected final String TEXT_347 = ".";
  protected final String TEXT_348 = " = ParserUtils.parseTo_Date(temp_";
  protected final String TEXT_349 = ", ";
  protected final String TEXT_350 = ",false);";
  protected final String TEXT_351 = NL + "\t\t\t";
  protected final String TEXT_352 = ".";
  protected final String TEXT_353 = " = ParserUtils.parseTo_Date(temp_";
  protected final String TEXT_354 = ", ";
  protected final String TEXT_355 = ");";
  protected final String TEXT_356 = NL + "\t\t\t";
  protected final String TEXT_357 = ".";
  protected final String TEXT_358 = " = ParserUtils.parseTo_";
  protected final String TEXT_359 = "(ParserUtils.parseTo_Number(temp_";
  protected final String TEXT_360 = ", ";
  protected final String TEXT_361 = ", ";
  protected final String TEXT_362 = "));";
  protected final String TEXT_363 = NL + "\t\t\t";
  protected final String TEXT_364 = ".";
  protected final String TEXT_365 = " = ParserUtils.parseTo_";
  protected final String TEXT_366 = "(temp_";
  protected final String TEXT_367 = ");";
  protected final String TEXT_368 = NL + "\t\t} else {\t\t\t\t\t\t";
  protected final String TEXT_369 = NL + "\t\t\tthrow new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_370 = "' in '";
  protected final String TEXT_371 = "' connection, value is invalid or this column should be nullable or have a default value.\");";
  protected final String TEXT_372 = "\t\t\t";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = " = ";
  protected final String TEXT_375 = ";";
  protected final String TEXT_376 = "\t\t}";
  protected final String TEXT_377 = NL + "\t\tcsvReader";
  protected final String TEXT_378 = ".close();" + NL + "\t\tbreak;";
