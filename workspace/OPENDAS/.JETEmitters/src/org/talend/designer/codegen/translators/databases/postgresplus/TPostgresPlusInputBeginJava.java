...
public class TPostgresPlusInputBeginJava
{
  ...
  protected final String TEXT_144 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_145 = ".setLength(rsmd_";
  protected final String TEXT_146 = ".getPrecision(i));" + NL + "                \tdcm_";
  protected final String TEXT_147 = ".setPrecision(rsmd_";
  protected final String TEXT_148 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_149 = ".setNullable(rsmd_";
  protected final String TEXT_150 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_151 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_152 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_153 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_154 = ".metadatas.add(dcm_";
  protected final String TEXT_155 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_156 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_157 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_158 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_159 = "++;" + NL + "\t\t        ";
  protected final String TEXT_160 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_171 = " = (List)rs_";
  protected final String TEXT_172 = ".getObject(";
  protected final String TEXT_173 = ");";
  protected final String TEXT_174 = NL + "\t\t                         ";
  protected final String TEXT_175 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_176 = ".getObject(";
  protected final String TEXT_177 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_178 = NL + "                                    ";
  protected final String TEXT_179 = ".";
  protected final String TEXT_180 = " = new Geometry(wktValue);";
  protected final String TEXT_181 = NL + "                                        ";
  protected final String TEXT_182 = ".";
  protected final String TEXT_183 = ".setEPSG(";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_186 = NL + "                                  ";
  protected final String TEXT_187 = ".";
  protected final String TEXT_188 = "=dcg_";
  protected final String TEXT_189 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_190 = ".";
  protected final String TEXT_191 = ", rs_";
  protected final String TEXT_192 = ", fixedColumnCount_";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_195 = ".getObject(";
  protected final String TEXT_196 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_197 = ".";
  protected final String TEXT_198 = " = new Geometry(sb.toString());";
