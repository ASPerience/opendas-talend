...
public class TSalesforceGetServerTimestampBeginJava
{
  ...
  protected final String TEXT_20 = "\");" + NL + "\t\t\t}" + NL + "\t\t\tsfMgr_";
  protected final String TEXT_21 = ".login((com.salesforce.soap.partner.SforceServiceStub)globalMap.get(\"stub_";
  protected final String TEXT_22 = "\"),(com.salesforce.soap.partner.SessionHeader)globalMap.get(\"sessionHeader_";
  protected final String TEXT_23 = "\"));" + NL + "\t\t\t";
  protected final String TEXT_24 = NL + "\t\t\tboolean result_";
  protected final String TEXT_25 = " = sfMgr_";
  protected final String TEXT_26 = ".login(";
  protected final String TEXT_27 = ",";
  protected final String TEXT_28 = ", ";
  protected final String TEXT_29 = ",";
  protected final String TEXT_30 = ",";
  protected final String TEXT_31 = ");" + NL + "\t\t\tif(!result_";
  protected final String TEXT_32 = "){" + NL + "\t\t\t\tthrow new RuntimeException(\"Login failed! Please check the username,password and endpoint\");" + NL + "\t\t\t}" + NL + "\t\t\t";
