...
public class TELTOracleOutputMainJava
{
  ...
  protected final String TEXT_45 = ".put(\"user\",dbUser_";
  protected final String TEXT_46 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_47 = ".put(\"password\",dbPwd_";
  ...
  protected final String TEXT_50 = ".getBytes()));" + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_57 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_58 = " =null;" + NL + "" + NL + "java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_59 = " =null;" + NL + "" + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_60 = " =null;" + NL;
  protected final String TEXT_61 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_62 = " =null;" + NL + "\t";
  protected final String TEXT_63 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_64 = "+\"(";
  protected final String TEXT_65 = ") (\"+select_query+\")\";";
  protected final String TEXT_66 = "\t" + NL + "\t    StringBuffer insertStringBuffer_";
  protected final String TEXT_67 = " = new StringBuffer(insertQuery);" + NL + "\t    insertStringBuffer_";
  protected final String TEXT_68 = ".insert(insertQuery.indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_69 = " + \" \");" + NL + "\t    insertQuery =insertStringBuffer_";
  protected final String TEXT_70 = ".toString(); ";
  protected final String TEXT_71 = "   " + NL + "\tpstmt_";
  protected final String TEXT_72 = " = conn_";
  protected final String TEXT_73 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_74 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  ...
  protected final String TEXT_79 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_80 = " = new StringBuffer(updateQuery);" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_81 = ".insert(updateQuery.indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_82 = "  + \" \");" + NL + "\t    updateQuery =updateStringBuffer_";
  protected final String TEXT_83 = ".toString(); ";
  protected final String TEXT_84 = NL + "\tpstmt_";
  protected final String TEXT_85 = " = conn_";
  protected final String TEXT_86 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_87 = NL + NL + "String insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_88 = "+\"(";
  protected final String TEXT_89 = ") (\"+select_query+\")\";" + NL + "pstmt_";
  protected final String TEXT_90 = " = conn_";
  protected final String TEXT_91 = ".prepareStatement(insertQuery);" + NL + "" + NL + "String updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_92 = "+\" SET (";
  protected final String TEXT_93 = ") = (\"+select_query+\") \"";
  protected final String TEXT_94 = NL + "+\"  WHERE \" + ";
  protected final String TEXT_95 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_96 = " = conn_";
  protected final String TEXT_97 = ".prepareStatement(updateQuery);" + NL + "\t\t" + NL + "\t";
  protected final String TEXT_98 = NL + NL + "String updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_99 = "+\" SET (";
  protected final String TEXT_100 = ") = (\"+select_query+\") \"";
  protected final String TEXT_101 = NL + "+\"  WHERE \" + ";
  protected final String TEXT_102 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_103 = " = conn_";
  protected final String TEXT_104 = ".prepareStatement(updateQuery);" + NL + "\t\t\t\t" + NL + "String insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_105 = "+\"(";
  protected final String TEXT_106 = ") (\"+select_query+\")\";" + NL + "pstmt_";
  protected final String TEXT_107 = " = conn_";
  protected final String TEXT_108 = ".prepareStatement(insertQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_109 = NL + "\t" + NL + "String deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_110 = "+\" WHERE EXISTS (\"+select_query+\") \" ";
  protected final String TEXT_111 = NL + "+\"  AND \" + ";
  protected final String TEXT_112 = NL + ";";
  protected final String TEXT_113 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_114 = " = new StringBuffer(deleteQuery);" + NL + "    deleteStringBuffer_";
  protected final String TEXT_115 = ".insert(deleteQuery.indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_116 = "  + \" \" );" + NL + "    deleteQuery =deleteStringBuffer_";
  protected final String TEXT_117 = ".toString();  ";
  protected final String TEXT_118 = NL + "pstmt_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_121 = NL + "\tString mergeQuery = \"MERGE INTO \"+ tableName_";
  protected final String TEXT_122 = " +\" target\"  + \" USING (\" + select_query + \") source ON (\" +" + NL + "\t" + NL + "\t\t\"";
  protected final String TEXT_123 = "\" + \")\" ;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_124 = NL + "\t\t\tmergeQuery += \" WHEN MATCHED THEN UPDATE SET ";
  protected final String TEXT_125 = " \" ;\t" + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tmergeQuery += \"WHERE \" + \"\";" + NL + "\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\t\tmergeQuery += \"WHERE \" + ";
  protected final String TEXT_128 = ";" + NL + "\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\t\tmergeQuery += \" DELETE WHERE \" + \"\" ;" + NL + "\t\t\t";
  protected final String TEXT_131 = NL + "\t\t\t\t\tmergeQuery += \" DELETE WHERE \" + ";
  protected final String TEXT_132 = " ;" + NL + "\t\t  ";
  protected final String TEXT_133 = NL + "\t\t";
  protected final String TEXT_134 = NL + "\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\tmergeQuery += \" WHEN NOT MATCHED THEN INSERT ( ";
  protected final String TEXT_136 = ") VALUES ( ";
  protected final String TEXT_137 = ") \";" + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\tmergeQuery += \" WHERE \" + \"\";" + NL + "\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\tmergeQuery += \" WHERE \" + ";
  protected final String TEXT_140 = " ;" + NL + "\t\t\t";
  protected final String TEXT_141 = "\t" + NL + " \t\t\tpstmt_";
  protected final String TEXT_142 = " = conn_";
  protected final String TEXT_143 = ".prepareStatement(mergeQuery);" + NL + "\t";
  protected final String TEXT_144 = NL + "int nb_line_";
  protected final String TEXT_145 = " = 0;" + NL + "int nb_line_update_";
  ...
  protected final String TEXT_149 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "nb_line_inserted_";
  protected final String TEXT_150 = " = pstmt_";
  protected final String TEXT_151 = ".executeUpdate();" + NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_152 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_153 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "nb_line_update_";
  protected final String TEXT_154 = " = pstmt_";
  protected final String TEXT_155 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_156 = " + \" rows updated. \\n\");" + NL + "\t";
  protected final String TEXT_157 = NL + "\ttry{" + NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "\t\tnb_line_inserted_";
  protected final String TEXT_158 = " = pstmtInsert_";
  protected final String TEXT_159 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_160 = " + \" rows inserted. \\n\");" + NL + "\t}catch(Exception e){" + NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "\t\tnb_line_update_";
  protected final String TEXT_161 = " = pstmtUpdate_";
  protected final String TEXT_162 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_163 = " + \" rows updated. \\n\");\t" + NL + "\t}";
  protected final String TEXT_164 = NL + "\ttry{" + NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "\t\tnb_line_update_";
  protected final String TEXT_165 = " = pstmtUpdate_";
  protected final String TEXT_166 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_167 = " + \" rows updated. \\n\");\t\t" + NL + "\t}catch(Exception e){" + NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "\t\tnb_line_inserted_";
  protected final String TEXT_168 = " = pstmtInsert_";
  protected final String TEXT_169 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_170 = " + \" rows inserted. \\n\");" + NL + "\t}";
  protected final String TEXT_171 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_172 = " = pstmt_";
  protected final String TEXT_173 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_174 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_175 = "\t" + NL + "\tpstmt_";
  protected final String TEXT_176 = ".executeUpdate();" + NL + "\tSystem.out.println(\"Merge with : \\n\" + mergeQuery +\"\\n\");" + NL + "\t";
  protected final String TEXT_177 = NL + NL + "if(pstmtUpdate_";
  protected final String TEXT_178 = " != null){" + NL + "" + NL + "\tpstmtUpdate_";
  protected final String TEXT_179 = ".close();" + NL + "\t" + NL + "}else if(pstmt_";
  protected final String TEXT_180 = " != null) {" + NL + "" + NL + "\tpstmt_";
  protected final String TEXT_181 = ".close();" + NL + "\t" + NL + "}" + NL;
  protected final String TEXT_182 = NL + "pstmt_";
  ...
  protected final String TEXT_187 = ".isClosed()) {" + NL + "        conn_";
  protected final String TEXT_188 = " .close();" + NL + "    }";
  protected final String TEXT_189 = NL + NL + "globalMap.put(\"";
  protected final String TEXT_190 = "_NB_LINE\",nb_line_";
  protected final String TEXT_191 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_192 = "_NB_LINE_UPDATED\",nb_line_update_";
