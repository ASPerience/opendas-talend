...
public class TOracleSCDBeginJava {
  ...
  protected final String TEXT_12 = NL + "        java.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");";
  ...
  protected final String TEXT_26 = NL + "        String schema_";
  protected final String TEXT_27 = " = ";
  protected final String TEXT_28 = ";";
  protected final String TEXT_29 = NL + "\t\tjava.sql.Connection connection_";
  protected final String TEXT_30 = " = java.sql.DriverManager.getConnection(connectionString_";
  ...
  protected final String TEXT_45 = ".getBytes()));" + NL + "\t\tjava.sql.Connection connection_";
  protected final String TEXT_46 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_47 = ", atnParamsPrope_";
  protected final String TEXT_48 = ");";
  protected final String TEXT_49 = NL + "        ";
  protected final String TEXT_50 = NL + "    String tableName_";
  protected final String TEXT_51 = " = null;" + NL + "    if(schema_";
  protected final String TEXT_52 = " == null || schema_";
  protected final String TEXT_53 = ".trim().length() == 0) {" + NL + "        tableName_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_56 = " = schema_";
  ...
  protected final String TEXT_67 = ".getMetaData();";
  protected final String TEXT_68 = "   " + NL + "\t\t\t\tString dbschemaForSearch_";
  protected final String TEXT_69 = " = null;" + NL + "\t\t\t\tif (schema_";
  protected final String TEXT_70 = " == null" + NL + "\t\t\t\t\t\t|| schema_";
  protected final String TEXT_71 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_72 = " = ((String)";
  protected final String TEXT_73 = ").toUpperCase();" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdbschemaForSearch_";
  protected final String TEXT_74 = " = schema_";
  protected final String TEXT_75 = ".toUpperCase();" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_76 = " = dbMetaData_";
  protected final String TEXT_77 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_78 = ", (";
  protected final String TEXT_79 = ").toUpperCase(), new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  ...
  protected final String TEXT_84 = NL + "\t            java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_101 = NL + "    " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_102 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_103 = " = null;    ";
  protected final String TEXT_104 = NL + "        String searching_";
  ...
  protected final String TEXT_111 = NL + "        String search_";
  ...
  protected final String TEXT_123 = ">();" + NL + "        while(resultSet_";
  ...
  protected final String TEXT_140 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_141 = NL + "                            if(tmpValue_";
  ...
  protected final String TEXT_149 = NL + "                            if((\"\").equals(tmpValue_";
  ...
  protected final String TEXT_155 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_156 = NL + "                    }";
  protected final String TEXT_157 = NL + "                    timestamp_";
  protected final String TEXT_158 = " = resultSet_";
  protected final String TEXT_159 = ".getTimestamp(";
  protected final String TEXT_160 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_161 = " != null) {";
  protected final String TEXT_162 = NL + "                        ";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = " = new java.util.Date(timestamp_";
  protected final String TEXT_165 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_166 = NL + "                        ";
  protected final String TEXT_167 = ".";
  protected final String TEXT_168 = " = null;" + NL + "                    }";
  protected final String TEXT_169 = NL + "                    if(resultSet_";
  protected final String TEXT_170 = ".getObject(";
  protected final String TEXT_171 = ") != null) {";
  protected final String TEXT_172 = NL + "                        ";
  protected final String TEXT_173 = ".";
  protected final String TEXT_174 = " = resultSet_";
  protected final String TEXT_175 = ".get";
  protected final String TEXT_176 = "(";
  protected final String TEXT_177 = ");" + NL + "                    }";
  protected final String TEXT_178 = NL + "            cache_";
  protected final String TEXT_179 = ".put(sk_";
  protected final String TEXT_180 = ", row_";
  protected final String TEXT_181 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_182 = ".close();" + NL + "        statement_";
  protected final String TEXT_183 = ".close();";
  protected final String TEXT_184 = NL + "            System.out.println(\"[";
  protected final String TEXT_185 = "] comparison cache loaded\");";
  protected final String TEXT_186 = NL + "        ";
  protected final String TEXT_187 = " nextSurrogateKey_";
  protected final String TEXT_188 = " = 1;";
  protected final String TEXT_189 = NL + "            if(cache_";
  protected final String TEXT_190 = ".size() > 0) {";
  protected final String TEXT_191 = NL + "        String tmpQuery_";
  protected final String TEXT_192 = " = \"SELECT MAX(";
  protected final String TEXT_193 = ") FROM \" + tableName_";
  protected final String TEXT_194 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_195 = " = connection_";
  protected final String TEXT_196 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_197 = " = tmpStmt_";
  protected final String TEXT_198 = ".executeQuery(tmpQuery_";
  protected final String TEXT_199 = ");";
  protected final String TEXT_200 = NL + "        if(tmpRS_";
  protected final String TEXT_201 = ".next() && tmpRS_";
  protected final String TEXT_202 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_203 = " = tmpRS_";
  protected final String TEXT_204 = ".get";
  protected final String TEXT_205 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_206 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_207 = ".close();";
  protected final String TEXT_208 = NL + "            }            ";
  protected final String TEXT_209 = NL + "    String insertionSQL_";
  protected final String TEXT_210 = " = \"";
  protected final String TEXT_211 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_212 = " = connection_";
  protected final String TEXT_213 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "            insertionStatement_";
  protected final String TEXT_216 = ".setTimestamp(";
  protected final String TEXT_217 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_218 = "\")));";
  protected final String TEXT_219 = NL + "            insertionStatement_";
  protected final String TEXT_220 = ".setNull(";
  protected final String TEXT_221 = ", java.sql.Types.DATE);";
  protected final String TEXT_222 = NL + "            insertionStatement_";
  protected final String TEXT_223 = ".setTimestamp(";
  protected final String TEXT_224 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd\").parse(";
  protected final String TEXT_225 = " + \"-01-01\").getTime()));";
  protected final String TEXT_226 = NL + "        String updateSQLForType1_";
  protected final String TEXT_227 = " = \"";
  protected final String TEXT_228 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_229 = " = connection_";
  protected final String TEXT_230 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_231 = ");        ";
  protected final String TEXT_232 = NL + "        String updateSQLForType2_";
  protected final String TEXT_233 = " = \"";
  protected final String TEXT_234 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_235 = " = connection_";
  protected final String TEXT_236 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_237 = ");";
  protected final String TEXT_238 = NL + "            updateForType2_";
  protected final String TEXT_239 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_240 = "\")));";
  protected final String TEXT_241 = NL + "        String updateSQLForType3_";
  protected final String TEXT_242 = " = \"";
  protected final String TEXT_243 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_244 = " = connection_";
  protected final String TEXT_245 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_246 = ");";
  protected final String TEXT_247 = NL + "    ";
  protected final String TEXT_248 = NL + "        SCDSK_";
  protected final String TEXT_249 = " lookUpKey_";
