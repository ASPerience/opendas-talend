...
public class THashOutputMainJava
{
  ...
  protected final String TEXT_21 = " = (org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<";
  protected final String TEXT_22 = "Struct>)globalMap.get(\"tHashFile_";
  protected final String TEXT_23 = "\");" + NL + "\t\t\tglobalMap.put(\"tHashFile_";
  protected final String TEXT_24 = "\", tHashFile_";
  protected final String TEXT_25 = ");\t\t" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_26 = "Struct oneRow_";
  ...
  protected final String TEXT_34 = NL + "        tHashFile_";
  protected final String TEXT_35 = ".put(oneRow_";
  protected final String TEXT_36 = ");" + NL + "        nb_line_";
