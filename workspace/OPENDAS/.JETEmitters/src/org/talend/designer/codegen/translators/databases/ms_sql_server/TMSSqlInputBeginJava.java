...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_184 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_185 = ".setLength(rsmd_";
  protected final String TEXT_186 = ".getPrecision(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_247 = NL + NL + NL + NL + NL;
