...
public class TDBInputBeginJava
{
  ...
  protected final String TEXT_195 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_196 = ".setLength(rsmd_";
  protected final String TEXT_197 = ".getPrecision(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_226 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_227 = ".getObject(";
  protected final String TEXT_228 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_229 = NL + "                                    ";
  protected final String TEXT_230 = ".";
  protected final String TEXT_231 = " = new Geometry(wktValue);";
  protected final String TEXT_232 = NL + "                                        ";
  protected final String TEXT_233 = ".";
  protected final String TEXT_234 = ".setEPSG(";
