...
public class TSalesforceGetUpdatedBeginJava
{
  ...
  protected final String TEXT_44 = "\t\t\t\t" + NL + "" + NL + "\tcom.salesforce.soap.partner.sobject.SObject[] so_";
  protected final String TEXT_45 = " = null;" + NL + "\tcom.salesforce.soap.partner.ID[] ids_";
  protected final String TEXT_46 = " = sfMgr_";
  protected final String TEXT_47 = ".getUpdated(\"";
  protected final String TEXT_48 = "\", startCal_";
  protected final String TEXT_49 = ", endCal_";
  protected final String TEXT_50 = ");" + NL + "\t" + NL + "\tif(ids_";
  protected final String TEXT_51 = " !=null && ids_";
  protected final String TEXT_52 = ".length > 0){" + NL + "\t\t\t\t\t\t" + NL + "\t\tint newMax_";
  protected final String TEXT_53 = " = 0;" + NL + "\t\tint newBase_";
  protected final String TEXT_54 = " = 0;" + NL + "\t\t" + NL + "\t\twhile (newMax_";
  protected final String TEXT_55 = " < ids_";
  protected final String TEXT_56 = ".length){" + NL + "\t\t" + NL + "\t\t\tnewBase_";
  protected final String TEXT_57 = " = newMax_";
  protected final String TEXT_58 = ";" + NL + "\t\t\tnewMax_";
  protected final String TEXT_59 = " += 2000;" + NL + "\t\t\t" + NL + "\t\t\tif (newMax_";
  protected final String TEXT_60 = " > ids_";
  protected final String TEXT_61 = ".length){" + NL + "\t\t\t\tnewMax_";
  protected final String TEXT_62 = " = ids_";
  protected final String TEXT_63 = ".length;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tcom.salesforce.soap.partner.ID[] localIds_";
  protected final String TEXT_64 = " = new com.salesforce.soap.partner.ID[newMax_";
  protected final String TEXT_65 = "-newBase_";
  protected final String TEXT_66 = "];" + NL + "" + NL + "\t\t\tfor (int i_";
  protected final String TEXT_67 = "=newBase_";
  protected final String TEXT_68 = ";i_";
  protected final String TEXT_69 = " < newMax_";
  protected final String TEXT_70 = ";i_";
  protected final String TEXT_71 = "++){" + NL + "\t\t\t\tlocalIds_";
  protected final String TEXT_72 = "[i_";
  protected final String TEXT_73 = "-newBase_";
  protected final String TEXT_74 = "] = ids_";
  protected final String TEXT_75 = "[i_";
  protected final String TEXT_76 = "];" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tso_";
  protected final String TEXT_77 = " = sfMgr_";
  protected final String TEXT_78 = ".retrieve(localIds_";
  protected final String TEXT_79 = ",\"";
  protected final String TEXT_80 = "\",\"";
  protected final String TEXT_81 = "\");" + NL + "    \t\t" + NL + "    \t\tif(so_";
  protected final String TEXT_82 = " != null){" + NL + "    \t\t" + NL + "\t\t\tfor (int i_";
  protected final String TEXT_83 = "=0;i_";
  protected final String TEXT_84 = "<so_";
  protected final String TEXT_85 = ".length;i_";
  protected final String TEXT_86 = "++){" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_87 = " ++;" + NL + "\t\t\t\torg.apache.axiom.om.OMElement[] fields_";
  protected final String TEXT_88 = " = so_";
  protected final String TEXT_89 = "[i_";
  protected final String TEXT_90 = "].getExtraElement();" + NL + "\t\t\t\tint len_";
  protected final String TEXT_91 = " = fields_";
  protected final String TEXT_92 = ".length;";
  protected final String TEXT_93 = "\t\t\t\t\t\t" + NL + "\t\t\t\tif (";
  protected final String TEXT_94 = " < len_";
  protected final String TEXT_95 = " && fields_";
  protected final String TEXT_96 = "[";
  protected final String TEXT_97 = "].getText() != null && !\"\".equals(fields_";
  protected final String TEXT_98 = "[";
  protected final String TEXT_99 = "].getText())){";
  protected final String TEXT_100 = NL + "\t\t\t\t\t";
  protected final String TEXT_101 = ".";
  protected final String TEXT_102 = " = fields_";
  protected final String TEXT_103 = "[";
  protected final String TEXT_104 = "].getText();";
  protected final String TEXT_105 = NL + "\t\t\t\t\t";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = " = ParserUtils.parseTo_Date(fields_";
  protected final String TEXT_108 = "[";
  protected final String TEXT_109 = "].getText(), ";
  protected final String TEXT_110 = ");";
  protected final String TEXT_111 = NL + "\t\t\t\t\t";
  protected final String TEXT_112 = ".";
  protected final String TEXT_113 = " = fields_";
  protected final String TEXT_114 = "[";
  protected final String TEXT_115 = "].getText().getBytes();";
  protected final String TEXT_116 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_117 = ".";
  protected final String TEXT_118 = " = ParserUtils.parseTo_";
  protected final String TEXT_119 = "(fields_";
