...
public class TVtigerCRMOutputMainJava
{
  ...
  protected final String TEXT_107 = ".lastError().toString());" + NL + "\t                ";
  protected final String TEXT_108 = NL + "                        System.err.println(vtMgr_";
  protected final String TEXT_109 = ".lastError().toString());";
