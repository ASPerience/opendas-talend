...
public class TNetezzaOutputEndJava {
  ...
  protected final String TEXT_129 = "                " + NL + "    try {" + NL + "\t\t\tpstmt_";
  protected final String TEXT_130 = ".executeBatch(); " + NL + "\t\t\tpstmt_";
  protected final String TEXT_131 = ".clearBatch();               \t" + NL + "\t    \t";
  protected final String TEXT_132 = NL + "\t    \t\tinsertedCount_";
  protected final String TEXT_133 = " +=pstmt_";
  protected final String TEXT_134 = ".getUpdateCount(); " + NL + "\t    \t";
  protected final String TEXT_135 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_136 = " += pstmt_";
  protected final String TEXT_137 = ".getUpdateCount();" + NL + "\t    \t";
  protected final String TEXT_138 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_139 = " += pstmt_";
  protected final String TEXT_140 = ".getUpdateCount();" + NL + "\t    \t";
  protected final String TEXT_141 = "            \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_142 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_143 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_144 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_145 = "  " + NL + "    " + NL + "        if(pstmt_";
  protected final String TEXT_146 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_147 = ".close();" + NL + "            " + NL + "        }        ";
  protected final String TEXT_148 = NL;
  protected final String TEXT_149 = NL + "    \t\tconn_";
  protected final String TEXT_150 = ".commit();" + NL + "    \t\t";
  protected final String TEXT_151 = "\t" + NL + "    \tconn_";
  protected final String TEXT_152 = " .close();" + NL + "    \t";
  protected final String TEXT_153 = NL + NL + "\tnb_line_deleted_";
