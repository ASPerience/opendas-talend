...
public class TSybaseSCDBeginJava {
  ...
  protected final String TEXT_12 = NL + "        java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");";
  ...
  protected final String TEXT_29 = NL + "    java.sql.Timestamp timestamp_";
  ...
  protected final String TEXT_152 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd\").parse(";
  protected final String TEXT_153 = " + \"-01-01\").getTime()));";
  ...
  protected final String TEXT_176 = NL + "        SCDSK_";
  protected final String TEXT_177 = " lookUpKey_";
  protected final String TEXT_178 = " = null;        ";
  protected final String TEXT_179 = NL + "    SCDStruct_";
  protected final String TEXT_180 = " lookUpValue_";
