...
public class TVtigerCRMInputBeginJava
{
  ...
  protected final String TEXT_52 = ".lastError().toString());" + NL + "\t    }";
  protected final String TEXT_53 = NL + "\t\torg.json.simple.JSONArray qr_";
  protected final String TEXT_54 = " = vtMgr_";
  protected final String TEXT_55 = ".doQuery(";
  protected final String TEXT_56 = ");" + NL + "\t\tif(vtMgr_";
  protected final String TEXT_57 = ".hasError(qr_";
  protected final String TEXT_58 = ")){" + NL + "\t    \tthrow new RuntimeException(vtMgr_";
  protected final String TEXT_59 = ".lastError().toString());" + NL + "\t    }" + NL + "\t\tjava.util.Iterator qrIterator_";
  protected final String TEXT_60 = " = qr_";
  protected final String TEXT_61 = ".iterator();" + NL + "" + NL + "\t\twhile (qrIterator_";
  protected final String TEXT_62 = ".hasNext()) {" + NL + "" + NL + "\t\t    org.json.simple.JSONObject row_";
  protected final String TEXT_63 = " = (org.json.simple.JSONObject) qrIterator_";
  protected final String TEXT_64 = ".next();" + NL + "\t\t\tnb_line_";
  protected final String TEXT_65 = " ++;" + NL + "\t\t    Object value_";
  protected final String TEXT_66 = " = null;";
  protected final String TEXT_67 = "\t\t\t\t\t\t" + NL + "\t\t\t// Get the real value according the columnName" + NL + "\t\t\tvalue_";
  protected final String TEXT_68 = " = row_";
  protected final String TEXT_69 = ".get(\"";
  protected final String TEXT_70 = "\");" + NL + "\t\t\tif (value_";
  protected final String TEXT_71 = " != null && !\"\".equals(value_";
  protected final String TEXT_72 = ".toString())){" + NL + "\t\t\t    String valueStr_";
  protected final String TEXT_73 = " = (String) value_";
  protected final String TEXT_74 = ";";
  protected final String TEXT_75 = NL + "\t\t\t\t";
  protected final String TEXT_76 = ".";
  protected final String TEXT_77 = " = valueStr_";
  protected final String TEXT_78 = ";";
  protected final String TEXT_79 = NL + "\t\t\t\t";
  protected final String TEXT_80 = ".";
  protected final String TEXT_81 = " = ParserUtils.parseTo_Date(valueStr_";
  protected final String TEXT_82 = ", ";
  protected final String TEXT_83 = ");";
  protected final String TEXT_84 = NL + "\t\t\t\t";
  protected final String TEXT_85 = ".";
  protected final String TEXT_86 = " = valueStr_";
  protected final String TEXT_87 = ".getBytes();";
  protected final String TEXT_88 = "\t\t\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_89 = ".";
  protected final String TEXT_90 = " = ParserUtils.parseTo_";
  protected final String TEXT_91 = "(valueStr_";
