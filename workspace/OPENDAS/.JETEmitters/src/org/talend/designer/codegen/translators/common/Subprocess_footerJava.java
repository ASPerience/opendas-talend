...
public class Subprocess_footerJava
{
  ...
  protected final String TEXT_13 = "Process(globalMap);" + NL + "\t    \t";
  protected final String TEXT_14 = NL;
  protected final String TEXT_15 = NL + "\t";
  protected final String TEXT_16 = "Process(globalMap);";
  protected final String TEXT_17 = NL + NL + "\t" + NL + "\t} catch(Exception e) {\t" + NL + "" + NL + "\t\tthrow new TalendException(e, currentComponent, globalMap);" + NL + "\t" + NL + "\t} catch(Error error) {" + NL + "\t";
  protected final String TEXT_18 = NL + "\t\trunStat.stopThreadStat();";
  protected final String TEXT_19 = NL + "\t\tthrow new Error(error);" + NL + "" + NL + "\t}";
  ...
  protected final String TEXT_26 = " finally{ ";
  protected final String TEXT_27 = NL + "     \t\t\t//free memory for \"";
  protected final String TEXT_28 = "\"" + NL + "     \t\t\tglobalMap.put(\"tHash_Lookup_";
  protected final String TEXT_29 = "\", null); ";
  protected final String TEXT_30 = "      \t" + NL + "      \t\t\t";
  protected final String TEXT_31 = " finally{ ";
  protected final String TEXT_32 = NL + "      \t\t\t//free memory for \"";
  protected final String TEXT_33 = "\"" + NL + "\t\t\t\tglobalMap.put(\"tHash_";
  ...
  protected final String TEXT_37 = "_SUBPROCESS_STATE\", 1);" + NL + "}";
  protected final String TEXT_38 = NL + "/**" + NL + " * End of Function: ";
  protected final String TEXT_39 = "Process " + NL + " */";
