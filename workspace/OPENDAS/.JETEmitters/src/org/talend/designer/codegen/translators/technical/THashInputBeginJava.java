...
public class THashInputBeginJava
{
  ...
  protected final String TEXT_6 = "\t" + NL + "org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<";
  protected final String TEXT_7 = "Struct> tHashFile_";
  protected final String TEXT_8 = " = (org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<";
  protected final String TEXT_9 = "Struct>)globalMap.get(\"tHashFile_";
  protected final String TEXT_10 = "\");" + NL + "" + NL + "java.util.Iterator<";
  protected final String TEXT_11 = "Struct> iterator_";
  protected final String TEXT_12 = " = tHashFile_";
  protected final String TEXT_13 = ".iterator();" + NL + "while (iterator_";
  protected final String TEXT_14 = ".hasNext()) {";
  protected final String TEXT_15 = NL + "    ";
  protected final String TEXT_16 = "Struct next_";
  protected final String TEXT_17 = " = iterator_";
  protected final String TEXT_18 = ".next();" + NL;
  protected final String TEXT_19 = NL + "\t";
  protected final String TEXT_20 = ".";
  protected final String TEXT_21 = " = next_";
