...
public class TTeradataMultiLoadMainJava
{
  ...
  protected final String TEXT_22 = ".write(\".BEGIN IMPORT MLOAD TABLES \"+tableFullName_";
  protected final String TEXT_23 = "+\" \"+";
  protected final String TEXT_24 = "+\";\\r\\n\");" + NL + "fw_";
  protected final String TEXT_25 = ".write(\".LAYOUT customer_layout;\\r\\n\");";
  protected final String TEXT_26 = NL + "fw_";
  protected final String TEXT_27 = ".write(\".FIELD \"+\"";
  protected final String TEXT_28 = "\"+\" * VARCHAR(";
  protected final String TEXT_29 = ");\\r\\n\");";
  protected final String TEXT_30 = NL + "fw_";
  protected final String TEXT_31 = ".write(\".DML LABEL DML_LABEL;\\r\\n\");" + NL;
  protected final String TEXT_32 = NL + "fw_";
  protected final String TEXT_33 = ".write(\"UPDATE \"+tableFullName_";
  protected final String TEXT_34 = "+\" SET \"+\"";
  protected final String TEXT_35 = "\"" + NL + "\t+\" WHERE \"+\"";
  protected final String TEXT_36 = "\"+\";\\r\\n\");";
  protected final String TEXT_37 = NL + "fw_";
  protected final String TEXT_38 = ".write(\"INSERT INTO \"+tableFullName_";
  protected final String TEXT_39 = "+\"(\"" + NL + "\t+\"";
  protected final String TEXT_40 = "\"+\") VAlUES(\"+\"";
  protected final String TEXT_41 = "\"+\");\\r\\n\");";
  protected final String TEXT_42 = NL + "fw_";
  protected final String TEXT_43 = ".write(\"DELETE FROM \"+tableFullName_";
  protected final String TEXT_44 = "+\" \"+";
  protected final String TEXT_45 = "+\" ;\\r\\n\");";
  protected final String TEXT_46 = NL + NL;
  protected final String TEXT_47 = NL + "fw_";
  protected final String TEXT_48 = ".write(\".IMPORT INFILE \\\"\"+";
  protected final String TEXT_49 = " +\"\\\"\");" + NL + "fw_";
  protected final String TEXT_50 = ".write(\" FORMAT VARText '\"+";
  protected final String TEXT_51 = "+\"' LAYOUT customer_layout APPLY DML_LABEL;\\r\\n\");" + NL + "fw_";
  protected final String TEXT_52 = ".write(\".END MLOAD;\\r\\n\");" + NL + "fw_";
  protected final String TEXT_53 = ".write(\".LOGOFF;\\r\\n\");" + NL;
  protected final String TEXT_54 = NL + "fw_";
  protected final String TEXT_55 = ".close();" + NL;
  protected final String TEXT_56 = NL + "String sb_";
  protected final String TEXT_57 = "= new String(\"";
  protected final String TEXT_58 = "mload -c \"+";
  protected final String TEXT_59 = "+\" < \\\"\"+";
  protected final String TEXT_60 = "+";
  protected final String TEXT_61 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_62 = "+\"\\\" 2>&1\");";
  protected final String TEXT_63 = "\t" + NL + "String sb_";
  protected final String TEXT_64 = "= new String(\"";
  protected final String TEXT_65 = "mload < \\\"\"+";
  protected final String TEXT_66 = "+";
  protected final String TEXT_67 = "+\".script\\\" > \\\"\"+";
  protected final String TEXT_68 = "+\"\\\" 2>&1\");";
  protected final String TEXT_69 = NL + "final Process process_";
  protected final String TEXT_70 = " = Runtime.getRuntime().exec(sb_";
  protected final String TEXT_71 = "); " + NL + "Thread normal_";
  protected final String TEXT_72 = " = new Thread() {" + NL + "    public void run() {" + NL + "    \ttry {" + NL + "    \t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_73 = ".getInputStream()));" + NL + "    \t\tString line = \"\";" + NL + "    \t\ttry {" + NL + "    \t\t\twhile((line = reader.readLine()) != null) {" + NL + "    \t\t\t   System.out.println(line);" + NL + "    \t        }" + NL + "    \t    } finally {" + NL + "    \t         reader.close();" + NL + "    \t    }" + NL + "        }catch(java.io.IOException ioe) {" + NL + "    \t\tioe.printStackTrace();" + NL + "    \t}" + NL + "    }" + NL + "};" + NL + "normal_";
  protected final String TEXT_74 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_75 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_76 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t   ioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_77 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_78 = ".waitFor();" + NL + "" + NL + "normal_";
  protected final String TEXT_79 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_80 = ".interrupt();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_81 = "_EXIT_VALUE\", process_";
  protected final String TEXT_82 = ".exitValue());" + NL;
  protected final String TEXT_83 = NL + "\tif(process_";
  protected final String TEXT_84 = ".exitValue()>=";
  protected final String TEXT_85 = ") {" + NL + "\t\tthrow new RuntimeException(\"Multiload returned exit code \"+process_";
  protected final String TEXT_86 = ".exitValue());" + NL + "\t}";
