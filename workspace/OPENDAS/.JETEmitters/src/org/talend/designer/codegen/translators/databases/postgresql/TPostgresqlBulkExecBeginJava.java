...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_107 = NL + "                if(whetherExist_";
  protected final String TEXT_108 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_109 = " = conn_";
  protected final String TEXT_110 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_111 = ".execute(\"";
  protected final String TEXT_112 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_113 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_119 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_120 = " = conn_";
  protected final String TEXT_121 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_122 = ".executeUpdate(\"";
  protected final String TEXT_123 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_124 = ".close();";
  protected final String TEXT_125 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_126 = " = conn_";
  protected final String TEXT_127 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_128 = " = stmtTruncCount_";
  protected final String TEXT_129 = ".executeQuery(\"";
  protected final String TEXT_130 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_131 = " = conn_";
  protected final String TEXT_132 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_133 = ".executeUpdate(\"";
  protected final String TEXT_134 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_135 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_136 = " += rsTruncCount_";
  protected final String TEXT_137 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_138 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_139 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_140 = ".close();            ";
  protected final String TEXT_141 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_142 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_143 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_144 = NL + "\t";
  protected final String TEXT_145 = NL + "        int keyCount_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_148 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        String tmpTableName_";
  protected final String TEXT_149 = " = tableName_";
  protected final String TEXT_150 = ";" + NL + "        tableName_";
  protected final String TEXT_151 = " = \"tmp_";
  protected final String TEXT_152 = "\" + \"_\" + pid ;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_153 = " = conn_";
  protected final String TEXT_154 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_155 = ".execute(\"";
  protected final String TEXT_156 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_157 = ".close();" + NL + "        " + NL + "        ";
  protected final String TEXT_158 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_159 = " =conn_";
  protected final String TEXT_160 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_161 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_162 = ".close();" + NL + "   \t\t";
  protected final String TEXT_163 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_164 = " = conn_";
  protected final String TEXT_165 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_166 = ".execute(bulkSQL_";
  protected final String TEXT_167 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_168 = ".close();" + NL + "        " + NL + "        tableName_";
  protected final String TEXT_169 = " = tmpTableName_";
  protected final String TEXT_170 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_171 = " = \"tmp_";
  protected final String TEXT_172 = "\" + \"_\" + pid;" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_173 = " = conn_";
  protected final String TEXT_174 = ".createStatement();" + NL + "        " + NL + "        stmtUpdateBulk_";
  ...
  protected final String TEXT_179 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  ...
  protected final String TEXT_185 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_186 = " =conn_";
  protected final String TEXT_187 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_188 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_189 = ".close();";
  protected final String TEXT_190 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_193 = ".execute(bulkSQL_";
  protected final String TEXT_194 = ");" + NL + "    stmtBulk_";
