...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_144 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        String tmpTableName_";
  ...
  protected final String TEXT_148 = "\" + \"_\" + pid;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_149 = " = conn_";
  protected final String TEXT_150 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_151 = ".execute(\"";
  protected final String TEXT_152 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_153 = ".close();";
  protected final String TEXT_154 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_155 = " =conn_";
  protected final String TEXT_156 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_157 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_158 = ".close();" + NL + "   \t\t";
  protected final String TEXT_159 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_162 = ".execute(bulkSQL_";
  protected final String TEXT_163 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_164 = ".close();" + NL + "        tableName_";
  protected final String TEXT_165 = " = tmpTableName_";
  protected final String TEXT_166 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_167 = " = \"tmp_";
  protected final String TEXT_168 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtUpdateBulk_";
  ...
  protected final String TEXT_182 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_183 = " =conn_";
  protected final String TEXT_184 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_185 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_186 = ".close();" + NL + "   \t\t";
  protected final String TEXT_187 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_190 = ".execute(bulkSQL_";
  protected final String TEXT_191 = ");" + NL + "    stmtBulk_";
