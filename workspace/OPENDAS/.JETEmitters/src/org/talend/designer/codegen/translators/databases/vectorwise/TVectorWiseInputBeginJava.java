...
public class TVectorWiseInputBeginJava
{
  ...
  protected final String TEXT_139 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_140 = ".setLength(rsmd_";
  protected final String TEXT_141 = ".getPrecision(i));" + NL + "                \tdcm_";
  protected final String TEXT_142 = ".setPrecision(rsmd_";
  protected final String TEXT_143 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_144 = ".setNullable(rsmd_";
  protected final String TEXT_145 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_146 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_147 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_148 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_149 = ".metadatas.add(dcm_";
  protected final String TEXT_150 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_151 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_152 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_153 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_154 = "++;" + NL + "\t\t        ";
  protected final String TEXT_155 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_166 = " = (List)rs_";
  protected final String TEXT_167 = ".getObject(";
  protected final String TEXT_168 = ");";
  protected final String TEXT_169 = NL + "\t\t                         ";
  protected final String TEXT_170 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_171 = ".getObject(";
  protected final String TEXT_172 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_173 = NL + "                                    ";
  protected final String TEXT_174 = ".";
  protected final String TEXT_175 = " = new Geometry(wktValue);";
  protected final String TEXT_176 = NL + "                                        ";
  protected final String TEXT_177 = ".";
  protected final String TEXT_178 = ".setEPSG(";
  protected final String TEXT_179 = ");";
  protected final String TEXT_180 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_181 = NL + "                                  ";
  protected final String TEXT_182 = ".";
  protected final String TEXT_183 = "=dcg_";
  protected final String TEXT_184 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_185 = ".";
  protected final String TEXT_186 = ", rs_";
  protected final String TEXT_187 = ", fixedColumnCount_";
  protected final String TEXT_188 = ");";
  protected final String TEXT_189 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_190 = ".getObject(";
  protected final String TEXT_191 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_192 = ".";
  protected final String TEXT_193 = " = new Geometry(sb.toString());";
