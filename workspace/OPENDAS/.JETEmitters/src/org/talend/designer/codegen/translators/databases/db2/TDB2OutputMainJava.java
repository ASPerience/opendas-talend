...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_382 = NL + "            try {" + NL + "                insertedCount_";
  ...
  protected final String TEXT_409 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_410 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_426 = "_QUERY\", query_";
  protected final String TEXT_427 = ".toString().trim());";
  protected final String TEXT_428 = NL + "    \t\t";
  protected final String TEXT_429 = NL + "    \t\tpstmt_";
  protected final String TEXT_430 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_435 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_436 = " = updatedCount_";
  protected final String TEXT_437 = " + pstmt_";
  protected final String TEXT_438 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_439 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_451 = " = rejectedCount_";
  protected final String TEXT_452 = " + 1;";
  protected final String TEXT_453 = NL + "                        ";
  protected final String TEXT_454 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_461 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_462 = " = pstmt_";
  protected final String TEXT_463 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_464 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_465 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_466 = " = rs_";
  protected final String TEXT_467 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_468 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_469 = NL + "                        ";
  protected final String TEXT_470 = NL + "                            query_";
  protected final String TEXT_471 = " = ";
  protected final String TEXT_472 = ";";
  protected final String TEXT_473 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_474 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_475 = ".";
  protected final String TEXT_476 = ", pstmtUpdate_";
  ...
  protected final String TEXT_488 = NL + "                    globalMap.put(\"";
  protected final String TEXT_489 = "_QUERY\", query_";
  protected final String TEXT_490 = ".toString().trim());";
  protected final String TEXT_491 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_492 = " = updatedCount_";
  protected final String TEXT_493 = " + pstmtUpdate_";
  protected final String TEXT_494 = ".executeUpdate(); " + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_499 = "Struct();";
  protected final String TEXT_500 = NL + "                                ";
  protected final String TEXT_501 = ".";
  protected final String TEXT_502 = " = ";
  protected final String TEXT_503 = ".";
  protected final String TEXT_504 = ";";
  protected final String TEXT_505 = NL + "                            rejectedCount_";
  protected final String TEXT_506 = " = rejectedCount_";
  protected final String TEXT_507 = " + 1;";
  protected final String TEXT_508 = NL + "                            ";
  protected final String TEXT_509 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_510 = ";";
  protected final String TEXT_511 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_512 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_525 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_526 = " = insertedCount_";
  protected final String TEXT_527 = " + pstmtInsert_";
  ...
  protected final String TEXT_573 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_574 = "=pstmtUpdate_";
  protected final String TEXT_575 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_576 = " = updatedCount_";
  protected final String TEXT_577 = " + updateFlag_";
  protected final String TEXT_578 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_579 = " = true;";
  protected final String TEXT_580 = NL + "                    throw(e);";
  ...
  protected final String TEXT_589 = NL + "                        rejectedCount_";
  protected final String TEXT_590 = " = rejectedCount_";
  protected final String TEXT_591 = " + 1;";
  protected final String TEXT_592 = NL + "                        ";
  protected final String TEXT_593 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_594 = ";";
  protected final String TEXT_595 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_596 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_597 = " == 0) {" + NL + "            \t";
  protected final String TEXT_598 = NL + "\t\t\t\tquery_";
  protected final String TEXT_599 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_600 = NL + "                        ";
  protected final String TEXT_601 = NL + "                            query_";
  protected final String TEXT_602 = " = ";
  protected final String TEXT_603 = ";";
  protected final String TEXT_604 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_605 = ".";
  protected final String TEXT_606 = ", pstmtInsert_";
  ...
  protected final String TEXT_612 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_613 = " = insertedCount_";
  protected final String TEXT_614 = " + pstmtInsert_";
  protected final String TEXT_615 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_633 = NL + "                }" + NL + "            } " + NL + "    " + NL + "            nb_line_";
  ...
  protected final String TEXT_714 = NL + "                try {" + NL + "                \t\tpstmt_";
  protected final String TEXT_715 = ".executeBatch();" + NL + "            \t    \t";
  protected final String TEXT_716 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_717 = " += pstmt_";
  protected final String TEXT_718 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_719 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_720 = " += pstmt_";
  protected final String TEXT_721 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_722 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_723 = " += pstmt_";
  protected final String TEXT_724 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_725 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_726 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_727 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_728 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_729 = NL + "                \tconn_";
  protected final String TEXT_730 = ".commit();                " + NL + "                \tcommitCounter_";
