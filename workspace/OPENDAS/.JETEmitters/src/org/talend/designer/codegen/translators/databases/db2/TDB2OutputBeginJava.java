...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_125 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_153 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_154 = ") || dbschema_";
  protected final String TEXT_155 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_156 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_166 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_167 = ".equalsIgnoreCase(";
  protected final String TEXT_168 = ")) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_197 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_198 = ".execute(\"";
  protected final String TEXT_199 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_200 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_222 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_223 = ", true);" + NL + "\t\t\t}";
  protected final String TEXT_224 = "            ";
  protected final String TEXT_225 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_228 = ".executeUpdate(\"";
  protected final String TEXT_229 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_230 = ".close();";
  protected final String TEXT_231 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_232 = " = conn_";
  protected final String TEXT_233 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_234 = " = stmtTruncCount_";
  protected final String TEXT_235 = ".executeQuery(\"";
  protected final String TEXT_236 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_237 = " = conn_";
  protected final String TEXT_238 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_239 = ".executeUpdate(\"";
  protected final String TEXT_240 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_241 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_242 = " += rsTruncCount_";
  protected final String TEXT_243 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_244 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_245 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_251 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_252 = " = conn_";
  protected final String TEXT_253 = ".prepareStatement(insert_";
  protected final String TEXT_254 = ");" + NL + "\t    ";
  protected final String TEXT_255 = NL + "\t    String update_";
  protected final String TEXT_256 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_257 = " + \"\\\" SET ";
  protected final String TEXT_258 = " WHERE ";
  protected final String TEXT_259 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_260 = " = conn_";
  protected final String TEXT_261 = ".prepareStatement(update_";
  protected final String TEXT_262 = ");" + NL + "\t    ";
  protected final String TEXT_263 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_264 = " = conn_";
  protected final String TEXT_265 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_266 = " + \"\\\" WHERE ";
  protected final String TEXT_267 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_268 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_269 = " + \"\\\" (";
  protected final String TEXT_270 = ") VALUES (";
  protected final String TEXT_271 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_272 = " = conn_";
  protected final String TEXT_273 = ".prepareStatement(insert_";
  protected final String TEXT_274 = ");" + NL + "\t    String update_";
  protected final String TEXT_275 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_276 = " + \"\\\" SET ";
  protected final String TEXT_277 = " WHERE ";
  protected final String TEXT_278 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_279 = " = conn_";
  protected final String TEXT_280 = ".prepareStatement(update_";
  protected final String TEXT_281 = ");" + NL + "\t    ";
  protected final String TEXT_282 = NL + "\t    String update_";
  protected final String TEXT_283 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_284 = " + \"\\\" SET ";
  protected final String TEXT_285 = " WHERE ";
  protected final String TEXT_286 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_297 = NL + "\t    String delete_";
  protected final String TEXT_298 = " = \"DELETE  FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_302 = ".prepareStatement(delete_";
  protected final String TEXT_303 = ");" + NL + "\t    ";
  protected final String TEXT_304 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_305 = " = null;" + NL + "       \t";
  protected final String TEXT_306 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_307 = " = insert_";
  protected final String TEXT_308 = ".split(\"\\\\?\");";
  protected final String TEXT_309 = NL + "\t\t\tupdate_";
  protected final String TEXT_310 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_311 = " = update_";
  protected final String TEXT_312 = ".split(\"\\\\?\");";
  protected final String TEXT_313 = NL + "\t\t\tupdate_";
  protected final String TEXT_314 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_315 = " = update_";
  protected final String TEXT_316 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_317 = " = insert_";
  protected final String TEXT_318 = ".split(\"\\\\?\");";
  protected final String TEXT_319 = NL + "\t\t\tdelete_";
  protected final String TEXT_320 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_321 = " = delete_";
  protected final String TEXT_322 = ".split(\"\\\\?\");";
  protected final String TEXT_323 = NL + "\t\t\treplace_";
  protected final String TEXT_324 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_325 = " = replace_";
  protected final String TEXT_326 = ".split(\"\\\\?\");";
  protected final String TEXT_327 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_328 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_329 = " = insertIgnore_";
  protected final String TEXT_330 = ".split(\"\\\\?\");";
  protected final String TEXT_331 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_332 = " = insert_";
  protected final String TEXT_333 = ".split(\"\\\\?\");";
  protected final String TEXT_334 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_335 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_336 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
