...
public class TXMLRPCPointageMainJava
{
  protected static String nl;
  public static synchronized TXMLRPCPointageMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TXMLRPCPointageMainJava result = new TXMLRPCPointageMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_8 = "\" + \" paramètres reçus : \" + ";
  protected final String TEXT_9 = ".toString());consoleOut_";
  protected final String TEXT_10 = ".flush();" + NL + "" + NL + "\t//Récupération des paramètres en entrée (ces paramètres viennent de tMomObjectInput)" + NL + "\tString title_";
  ...
  protected final String TEXT_20 = ".station;" + NL + "\tjava.util.Map pointageMap = (java.util.Map) ";
  protected final String TEXT_21 = ".attachement;" + NL + "\t" + NL + "\tObject[] tab = pointageMap.keySet().toArray();" + NL + "\tredstone.xmlrpc.XmlRpcStruct vals = new redstone.xmlrpc.XmlRpcStruct();" + NL + "\tfor(int i = 0; i < tab.length; i++) {";
  protected final String TEXT_22 = NL + "\t\t\tif(";
  protected final String TEXT_23 = ".equals(tab[i]))" + NL + "\t\t\t{" + NL + "\t\t\t\tvals.put(";
  protected final String TEXT_24 = ",pointageMap.get(tab[i]));" + NL + "\t\t\t}";
  protected final String TEXT_25 = NL + "\t}" + NL + "\t" + NL + "\t//Initialisation des paramètres en sortie" + NL + "\tString title_out_";
  ...
  protected final String TEXT_64 = NL + NL + "\t\tObject[] context_search = new Object[context_search_tmp.size()];" + NL + "\t\tfor(int i=0; i < context_search_tmp.size(); ++i)" + NL + "\t\t{" + NL + "\t\t\tcontext_search[i] = context_search_tmp.get(i);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tconsoleOut_";
  ...
  protected final String TEXT_79 = ".get(\"object\");" + NL + "\t\t\t" + NL + "\t\t\tObject retour = null;" + NL + "\t\t\tfor(int i=0; i < res_array.size(); ++i)" + NL + "\t\t\t{" + NL + "\t\t\t\tSystem.out.println(res_array.get(i).toString());" + NL + "\t\t\t\t" + NL + "\t\t\t\torg.opendas.modele.DASGeneric tmp_generic = new org.opendas.modele.DASGeneric();" + NL + "\t\t\t\tredstone.xmlrpc.XmlRpcStruct tmp_dict = null;" + NL + "\t\t\t\ttmp_dict = (redstone.xmlrpc.XmlRpcStruct) res_array.get(i);" + NL + "\t\t\t\ttmp_generic.setInfos(connexion";
  protected final String TEXT_80 = ".convert(tmp_dict));" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_93 = NL + "\t\t\t\tlistgen.add(tmp_generic);" + NL + "\t\t\t}" + NL + "\t\t\tresult.setObject(listgen);" + NL + "\t\t}" + NL + "\t\telse\t\t\t\t\t\t\t" + NL + "\t\t{" + NL + "\t\t\tSystem.out.println(\"ERREUR : Sur retour ASPerpgi\");" + NL + "\t\t\tresult.setCode(1);" + NL + "\t\t\tresult.setString(\"ERREUR : Sur retour ASPerpgi\");" + NL + "\t\t}" + NL + "\t" + NL + "\t}" + NL + "\tcatch(redstone.xmlrpc.XmlRpcException e)" + NL + "\t{" + NL + "\t\tSystem.out.println(\"ERREUR XMLRPC : \"+e.toString());" + NL + "\t\tresult.setCode(2);" + NL + "\t\tresult.setString(\"ERREUR XMLRPC : \"+e.toString());" + NL + "\t}" + NL + "\tcatch(Exception e)" + NL + "\t{" + NL + "\t\tSystem.out.println(\"ERREUR : \"+e.toString());" + NL + "\t\tresult.setCode(3);" + NL + "\t\tresult.setString(\"ERREUR : \"+e.toString());" + NL + "\t}" + NL + "\tSystem.out.println(\"result :\"+result);" + NL + "\t" + NL + "\t" + NL + "\t//transmission des paramètres au composant tMomObjectOutput (pas de sortie ici)" + NL + "\tObject[] results_";
  ...
  protected final String TEXT_111 = NL + "\t" + NL + "\t\t\t//on place les résultats dans les connexions de sortie" + NL + "\t\t\tif(";
