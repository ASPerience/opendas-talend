...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_90 = "\");" + NL + "\t\t\tString dbName_";
  protected final String TEXT_91 = " = ";
  protected final String TEXT_92 = ";" + NL + "\t\t\tString dbUser_";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = ";" + NL + "\t\t\tString dbPwd_";
  protected final String TEXT_95 = " = ";
  protected final String TEXT_96 = ";" + NL + "\t\t\tjava.util.Properties property_";
  protected final String TEXT_97 = " = new java.util.Properties();" + NL + "\t\t\tproperty_";
  protected final String TEXT_98 = ".setProperty(\"librefs\", dbName_";
  protected final String TEXT_99 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_100 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_101 = ");" + NL + "\t\t\tproperty_";
  protected final String TEXT_102 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_103 = ");" + NL + "\t\t\t";
  protected final String TEXT_104 = NL + "\t\t\tconn_";
  protected final String TEXT_105 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_106 = ", property_";
  protected final String TEXT_107 = ");";
  protected final String TEXT_108 = NL + "\t\t\tif(rs_";
  protected final String TEXT_109 = ".getString(";
  protected final String TEXT_110 = ")!=null&&(rs_";
  protected final String TEXT_111 = ".getString(";
  protected final String TEXT_112 = ")).length()>0){" + NL + "\t\t\t\t";
  protected final String TEXT_113 = ".";
  protected final String TEXT_114 = "=rs_";
  protected final String TEXT_115 = ".getString(";
  protected final String TEXT_116 = ").charAt(0);" + NL + "\t\t\t}else{\t\t\t  \t";
  protected final String TEXT_117 = NL + "\t\t\t\t\tif((rs_";
  protected final String TEXT_118 = ".getString(";
  protected final String TEXT_119 = "))==null){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_120 = ".";
  protected final String TEXT_121 = "=null;" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_122 = ".";
  protected final String TEXT_123 = "='\\0';" + NL + "\t\t\t  \t\t}";
  protected final String TEXT_124 = NL + "\t\t\t  \t\t" + NL + "\t\t\t  \t\tif((rs_";
  protected final String TEXT_125 = ".getString(";
  protected final String TEXT_126 = ")).equals(\"\")){" + NL + "\t\t\t  \t\t\t";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = " = '\\0';" + NL + "\t\t\t  \t\t}else{" + NL + "\t\t\t  \t\t\tthrow new RuntimeException(" + NL + "\t\t\t\t\t\t\t\"Value is empty for column : '";
  protected final String TEXT_129 = "', value is invalid or this column should be nullable or have a default value.\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t  \t\t";
  ...
  protected final String TEXT_180 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
