...
public class TSybaseOutputEndJava
{
  ...
  protected final String TEXT_32 = "  " + NL + "\t    }          \t    " + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_33 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_34 = NL + "    \tSystem.out.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_35 = "                \t" + NL + "\t}                                  ";
  protected final String TEXT_36 = "   " + NL + "        if(pstmt_";
  ...
  protected final String TEXT_40 = ".execute(\"SET IDENTITY_INSERT \"+ ";
  protected final String TEXT_41 = " +\" OFF\");" + NL + "        stmt_";
