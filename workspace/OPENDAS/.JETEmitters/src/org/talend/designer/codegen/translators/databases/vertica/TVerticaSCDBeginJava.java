...
public class TVerticaSCDBeginJava {
  ...
  protected final String TEXT_39 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_40 = " = dbMetaData_";
  protected final String TEXT_41 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_42 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_43 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_44 = " = rsTable_";
  protected final String TEXT_45 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_46 = ".equalsIgnoreCase(";
  protected final String TEXT_47 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_48 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            if(!whetherExist_";
  ...
  protected final String TEXT_55 = NL + "        " + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_56 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_57 = " = null;    ";
  protected final String TEXT_58 = NL + "        String searching_";
  protected final String TEXT_59 = " = \"";
  protected final String TEXT_60 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_61 = " = connection_";
  protected final String TEXT_62 = ".prepareStatement(searching_";
  protected final String TEXT_63 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_64 = " = null;";
  protected final String TEXT_65 = NL + "        String search_";
  protected final String TEXT_66 = " = \"";
  protected final String TEXT_67 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_68 = " = connection_";
  protected final String TEXT_69 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_70 = " = statement_";
  protected final String TEXT_71 = ".executeQuery(search_";
  protected final String TEXT_72 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_73 = ", SCDStruct_";
  protected final String TEXT_74 = "> cache_";
  protected final String TEXT_75 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_76 = ", SCDStruct_";
  protected final String TEXT_77 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_78 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_79 = " sk_";
  protected final String TEXT_80 = " = new SCDSK_";
  protected final String TEXT_81 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_82 = " row_";
  protected final String TEXT_83 = " = new SCDStruct_";
  protected final String TEXT_84 = "();";
  protected final String TEXT_85 = NL + "                    tmpValue_";
  ...
  protected final String TEXT_89 = " != null && tmpValue_";
  protected final String TEXT_90 = ".length() > 0) {";
  protected final String TEXT_91 = NL + "                        ";
  protected final String TEXT_92 = ".";
  protected final String TEXT_93 = " = tmpValue_";
  protected final String TEXT_94 = ".charAt(0);" + NL + "                    } else {";
  ...
  protected final String TEXT_103 = NL + "                            if((\"\").equals(tmpValue_";
  protected final String TEXT_104 = ")) {";
  protected final String TEXT_105 = NL + "                                ";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_108 = "' in '";
  protected final String TEXT_109 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_110 = NL + "                    }";
  protected final String TEXT_111 = NL + "                    timestamp_";
  protected final String TEXT_112 = " = resultSet_";
  protected final String TEXT_113 = ".getTimestamp(";
  protected final String TEXT_114 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_115 = " != null) {";
  protected final String TEXT_116 = NL + "                        ";
  protected final String TEXT_117 = ".";
  protected final String TEXT_118 = " = new java.util.Date(timestamp_";
  protected final String TEXT_119 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_120 = NL + "                        ";
  protected final String TEXT_121 = ".";
  protected final String TEXT_122 = " = null;" + NL + "                    }";
  protected final String TEXT_123 = NL + "                    if(resultSet_";
  protected final String TEXT_124 = ".getObject(";
  protected final String TEXT_125 = ") != null) {";
  protected final String TEXT_126 = NL + "                        ";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = " = resultSet_";
  protected final String TEXT_129 = ".get";
  protected final String TEXT_130 = "(";
  protected final String TEXT_131 = ");" + NL + "                    }";
  protected final String TEXT_132 = NL + "            cache_";
  protected final String TEXT_133 = ".put(sk_";
  protected final String TEXT_134 = ", row_";
  protected final String TEXT_135 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_136 = ".close();" + NL + "        statement_";
  protected final String TEXT_137 = ".close();";
  protected final String TEXT_138 = NL + "            System.out.println(\"[";
  protected final String TEXT_139 = "] comparison cache loaded\");";
  protected final String TEXT_140 = NL + "        ";
  protected final String TEXT_141 = " nextSurrogateKey_";
  protected final String TEXT_142 = " = 1;";
  protected final String TEXT_143 = NL + "            if(cache_";
  protected final String TEXT_144 = ".size() > 0) {";
  protected final String TEXT_145 = NL + "        String tmpQuery_";
  protected final String TEXT_146 = " = \"SELECT MAX(";
  protected final String TEXT_147 = ") FROM \" + tableName_";
  protected final String TEXT_148 = ";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_149 = " = connection_";
  protected final String TEXT_150 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_151 = " = tmpStmt_";
  protected final String TEXT_152 = ".executeQuery(tmpQuery_";
  protected final String TEXT_153 = ");";
  protected final String TEXT_154 = NL + "        if(tmpRS_";
  protected final String TEXT_155 = ".next() && tmpRS_";
  protected final String TEXT_156 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_157 = " = tmpRS_";
  protected final String TEXT_158 = ".get";
  protected final String TEXT_159 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_160 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_161 = ".close();";
  protected final String TEXT_162 = NL + "            }            ";
  protected final String TEXT_163 = NL + "    String insertionSQL_";
  protected final String TEXT_164 = " = \"";
  protected final String TEXT_165 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_166 = " = connection_";
  protected final String TEXT_167 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_168 = ");";
  protected final String TEXT_169 = NL + "            insertionStatement_";
  protected final String TEXT_170 = ".setTimestamp(";
  protected final String TEXT_171 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_172 = "\")));";
  protected final String TEXT_173 = NL + "            insertionStatement_";
  protected final String TEXT_174 = ".setNull(";
  protected final String TEXT_175 = ", java.sql.Types.DATE);";
  protected final String TEXT_176 = NL + "            insertionStatement_";
  protected final String TEXT_177 = ".setTimestamp(";
  protected final String TEXT_178 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd\").parse(";
  protected final String TEXT_179 = " + \"-01-01\").getTime()));";
  protected final String TEXT_180 = NL + "        String updateSQLForType1_";
  protected final String TEXT_181 = " = \"";
  protected final String TEXT_182 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_183 = " = connection_";
  protected final String TEXT_184 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_185 = ");        ";
  protected final String TEXT_186 = NL + "        String updateSQLForType2_";
  protected final String TEXT_187 = " = \"";
  protected final String TEXT_188 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_189 = " = connection_";
  protected final String TEXT_190 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_191 = ");";
  protected final String TEXT_192 = NL + "            updateForType2_";
  protected final String TEXT_193 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_194 = "\")));";
  protected final String TEXT_195 = NL + "        String updateSQLForType3_";
  protected final String TEXT_196 = " = \"";
  protected final String TEXT_197 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_198 = " = connection_";
  protected final String TEXT_199 = ".prepareStatement(updateSQLForType3_";
