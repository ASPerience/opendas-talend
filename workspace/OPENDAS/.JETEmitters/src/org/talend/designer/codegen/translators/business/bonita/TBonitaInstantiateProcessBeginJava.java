...
public class TBonitaInstantiateProcessBeginJava
{
  ...
  protected final String TEXT_11 = " = new javax.security.auth.login.LoginContext(\"Bonita\", new org.ow2.novabpm.util.SimpleCallbackHandler(";
  protected final String TEXT_12 = ", ";
  protected final String TEXT_13 = "));" + NL + "\t\tloginContext_";
  protected final String TEXT_14 = ".login();";
  protected final String TEXT_15 = NL + "\t\t\tprocessID_";
  protected final String TEXT_16 = " = new org.ow2.bonita.facade.uuid.ProcessDefinitionUUID(";
  protected final String TEXT_17 = ");";
  protected final String TEXT_18 = NL + "\t\t\tprocessID_";
  protected final String TEXT_19 = " = new org.ow2.bonita.facade.uuid.ProcessDefinitionUUID(";
  protected final String TEXT_20 = ", ";
  protected final String TEXT_21 = ");";
  protected final String TEXT_22 = NL + "\t} catch (javax.security.auth.login.LoginException le_";
  protected final String TEXT_23 = ") {//just login exception";
  protected final String TEXT_24 = NL + "\t\tthrow le_";
  protected final String TEXT_25 = ";\t\t";
  protected final String TEXT_26 = NL + "\t\tSystem.err.println(le_";
  protected final String TEXT_27 = ".getCause().getMessage());";
