...
public class TMomObjectOutput_SubjectListEndJava
{
  protected static String nl;
  public static synchronized TMomObjectOutput_SubjectListEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMomObjectOutput_SubjectListEndJava result = new TMomObjectOutput_SubjectListEndJava();
    nl = null;
    return result;
  }
