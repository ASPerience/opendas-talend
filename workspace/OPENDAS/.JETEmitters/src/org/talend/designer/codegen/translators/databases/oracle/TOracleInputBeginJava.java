...
public class TOracleInputBeginJava
{
  ...
  protected final String TEXT_262 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_263 = ".setLength(rsmd_";
  protected final String TEXT_264 = ".getPrecision(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_275 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_276 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_277 = "++;" + NL + "\t\t        ";
  protected final String TEXT_278 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_289 = " = (List)rs_";
  protected final String TEXT_290 = ".getObject(";
  protected final String TEXT_291 = ");";
  protected final String TEXT_292 = NL + "\t\t                         ";
  protected final String TEXT_293 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_294 = ".getObject(";
  protected final String TEXT_295 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_296 = NL + "                                    ";
  protected final String TEXT_297 = ".";
  protected final String TEXT_298 = " = new Geometry(wktValue);";
  protected final String TEXT_299 = NL + "                                        ";
  protected final String TEXT_300 = ".";
  protected final String TEXT_301 = ".setEPSG(";
  protected final String TEXT_302 = ");";
  protected final String TEXT_303 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_304 = NL + "                                  ";
  protected final String TEXT_305 = ".";
  protected final String TEXT_306 = "=dcg_";
  protected final String TEXT_307 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_308 = ".";
  protected final String TEXT_309 = ", rs_";
  protected final String TEXT_310 = ", fixedColumnCount_";
  protected final String TEXT_311 = ");";
  protected final String TEXT_312 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_313 = ".getObject(";
  protected final String TEXT_314 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_315 = ".";
  protected final String TEXT_316 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_325 = NL + NL + "\t" + NL + "\t" + NL;
