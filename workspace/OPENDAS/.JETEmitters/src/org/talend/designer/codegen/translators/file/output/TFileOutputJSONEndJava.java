...
public class TFileOutputJSONEndJava
{
  ...
  protected final String TEXT_12 = ".exists()){" + NL + "\t\tdir_";
  protected final String TEXT_13 = ".mkdirs();" + NL + "\t}";
  protected final String TEXT_14 = NL + "java.io.PrintWriter out";
  protected final String TEXT_15 = " = new java.io.PrintWriter(new java.io.BufferedWriter(new java.io.FileWriter(";
  protected final String TEXT_16 = ")));" + NL + "out";
  protected final String TEXT_17 = ".print(jsonOut";
  protected final String TEXT_18 = ");" + NL + "out";
  protected final String TEXT_19 = ".close();" + NL + "globalMap.put(\"";
