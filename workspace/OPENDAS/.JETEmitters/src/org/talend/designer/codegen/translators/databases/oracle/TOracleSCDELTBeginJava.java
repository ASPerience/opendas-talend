...
public class TOracleSCDELTBeginJava {
  ...
  protected final String TEXT_7 = NL + "        java.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");";
  ...
  protected final String TEXT_42 = ".getBytes()));" + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_46 = NL + "        " + NL + "        String schema_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";";
  protected final String TEXT_49 = NL + "    String tableName_";
  protected final String TEXT_50 = " = null;" + NL + "    String sourceTable_";
  ...
  protected final String TEXT_56 = ";" + NL + "        sourceTable_";
  protected final String TEXT_57 = " = schema_";
  protected final String TEXT_58 = " + \".\" + ";
  protected final String TEXT_59 = ";" + NL + "    } else {" + NL + "        tableName_";
  ...
  protected final String TEXT_104 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_105 = ".execute(\"";
  protected final String TEXT_106 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_107 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_119 = NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_120 = " = conn_";
  protected final String TEXT_121 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_122 = ".executeUpdate(\"";
  protected final String TEXT_123 = "\");" + NL + "            stmtTrunc_";
  protected final String TEXT_124 = ".close();";
  protected final String TEXT_125 = NL + "        System.out.println(\"[";
  protected final String TEXT_126 = "] table action ";
  protected final String TEXT_127 = " done\\n\");";
  protected final String TEXT_128 = NL + "    java.util.Date currentDate_";
  protected final String TEXT_129 = " = new java.util.Date((Long)start_Hash.get(\"";
  protected final String TEXT_130 = "\"));" + NL + "    String dateString_";
  protected final String TEXT_131 = " = routines.system.FormatterUtils.format_Date(currentDate_";
  protected final String TEXT_132 = ", \"yyyy-MM-dd HH:mm:ss\");" + NL + "    String dateValue_";
  protected final String TEXT_133 = " = \"to_date('\" + dateString_";
  protected final String TEXT_134 = " + \"', 'yyyy-mm-dd HH24:MI:SS')\";    ";
  protected final String TEXT_135 = NL + "        String updateForType1_";
  protected final String TEXT_136 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_137 = " + \" d SET (";
  protected final String TEXT_138 = ") = (SELECT ";
  protected final String TEXT_139 = " FROM \" + sourceTable_";
  protected final String TEXT_140 = " + \" t WHERE ";
  protected final String TEXT_141 = " AND (";
  protected final String TEXT_142 = ")) WHERE EXISTS (SELECT 1 FROM \" + sourceTable_";
  protected final String TEXT_143 = " + \" t WHERE ";
  protected final String TEXT_144 = " AND (";
  protected final String TEXT_145 = "))\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_148 = ".executeUpdate(updateForType1_";
  protected final String TEXT_149 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_150 = ".close();";
  protected final String TEXT_151 = NL + "            System.out.println(\"[";
  protected final String TEXT_152 = "] type1 update sql\\n\" + updateForType1_";
  protected final String TEXT_153 = " + \"\\ndone\");";
  protected final String TEXT_154 = NL + "        String updateForType2_";
  protected final String TEXT_155 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_156 = " + \" d SET ";
  protected final String TEXT_157 = " = \" + " + NL + "        dateValue_";
  protected final String TEXT_158 = " " + NL + "        + \"";
  protected final String TEXT_159 = ", ";
  protected final String TEXT_160 = " = 0";
  protected final String TEXT_161 = " WHERE EXISTS (SELECT 1 FROM \" + sourceTable_";
  protected final String TEXT_162 = " + " + NL + "        \" t WHERE ";
  protected final String TEXT_163 = " AND (";
  protected final String TEXT_164 = ")) AND d.";
  protected final String TEXT_165 = " \"" + NL + "        +";
  protected final String TEXT_166 = NL + "         \" IS NULL\";";
  protected final String TEXT_167 = NL + "         \"= to_date ('\" + ";
  protected final String TEXT_168 = " +\"-01-01', 'yyyy-mm-dd')\";";
  protected final String TEXT_169 = "        " + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_170 = " = conn_";
  protected final String TEXT_171 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_172 = ".executeUpdate(updateForType2_";
  protected final String TEXT_173 = ");" + NL + "        stmtType2Update_";
  ...
  protected final String TEXT_182 = ") SELECT ";
  protected final String TEXT_183 = "\" + ";
  protected final String TEXT_184 = " + \".NEXTVAL, ";
  protected final String TEXT_185 = "t.";
  protected final String TEXT_186 = ", \" " + NL + "        + ";
  protected final String TEXT_187 = NL + "        dateValue_";
  protected final String TEXT_188 = NL + "        \"t.";
  protected final String TEXT_189 = "\"  ";
  protected final String TEXT_190 = "                " + NL + "         + ";
  protected final String TEXT_191 = NL + "         \", NULL\"";
  protected final String TEXT_192 = NL + "         \", to_date('\"+";
  protected final String TEXT_193 = "+\"-01-01', 'yyyy-mm-dd')\" ";
  protected final String TEXT_194 = NL + "         +\"";
  protected final String TEXT_195 = ", 1";
  protected final String TEXT_196 = ", d.";
  protected final String TEXT_197 = " + 1";
  protected final String TEXT_198 = " FROM \" + " + NL + "        sourceTable_";
  protected final String TEXT_199 = " + \" t, \" + tableName_";
  protected final String TEXT_200 = " + \" d WHERE ";
  protected final String TEXT_201 = " AND (";
  protected final String TEXT_202 = ") AND d.";
  protected final String TEXT_203 = " = \"" + NL + "        " + NL + "                 " + NL + "        + dateValue_";
  protected final String TEXT_204 = ";  " + NL + "     " + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_207 = ".executeUpdate(insertForType2_";
  protected final String TEXT_208 = ");" + NL + "        stmtType2Insert_";
  protected final String TEXT_209 = ".close();";
  protected final String TEXT_210 = NL + "            System.out.println(\"[";
  protected final String TEXT_211 = "] type2 new active row slq\\n\" + insertForType2_";
  protected final String TEXT_212 = " + \"\\ndone\");";
  protected final String TEXT_213 = NL + "    String insert_";
  protected final String TEXT_214 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_215 = " + \"(";
  protected final String TEXT_216 = ", ";
  protected final String TEXT_217 = ") SELECT ";
  protected final String TEXT_218 = "\" + ";
  protected final String TEXT_219 = " + \".NEXTVAL, ";
  protected final String TEXT_220 = "t.";
  protected final String TEXT_221 = "\"" + NL + "    ";
  protected final String TEXT_222 = " + \", \"" + NL + "    \t+\t " + NL + "    \t";
  protected final String TEXT_223 = NL + "    \t dateValue_";
  protected final String TEXT_224 = NL + "    \t";
  protected final String TEXT_225 = NL + "    \t\"t.";
  protected final String TEXT_226 = "\"" + NL + "    \t";
  protected final String TEXT_227 = NL + "    \t+" + NL + "    \t";
  protected final String TEXT_228 = NL + "    \t\t\", NULL\"\t" + NL + "    \t";
  protected final String TEXT_229 = NL + "    \t\t \", to_date('\"+";
  protected final String TEXT_230 = "+\"-01-01', 'yyyy-mm-dd')\"" + NL + "    \t";
  protected final String TEXT_231 = "     " + NL + "     ";
  protected final String TEXT_232 = NL + "    " + NL + "    + \"";
  protected final String TEXT_233 = ", 1";
  protected final String TEXT_234 = ", 1";
  protected final String TEXT_235 = " FROM \" +" + NL + "     " + NL + "    sourceTable_";
  protected final String TEXT_236 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_237 = " + \" d ON ";
  protected final String TEXT_238 = " WHERE (";
  protected final String TEXT_239 = ")\";" + NL + "    " + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_242 = ".executeUpdate(insert_";
  protected final String TEXT_243 = ");" + NL + "    stmtInsert_";
  protected final String TEXT_244 = ".close();";
  protected final String TEXT_245 = NL + "        System.out.println(\"[";
  protected final String TEXT_246 = "] new rows sql\\n\" + insert_";
