...
public class TFileOutputPropertiesBeginJava
{
  ...
  protected final String TEXT_14 = NL + "\torg.ini4j.Wini ini_";
  protected final String TEXT_15 = " = new org.ini4j.Wini(new java.io.File(";
  protected final String TEXT_16 = "));" + NL + "\tini_";
  protected final String TEXT_17 = ".getConfig().setFileEncoding(java.nio.charset.Charset.forName(";
