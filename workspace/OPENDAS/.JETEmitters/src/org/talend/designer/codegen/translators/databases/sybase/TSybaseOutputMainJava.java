...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_354 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_355 = " = conn_";
  protected final String TEXT_356 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_357 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_358 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_359 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_360 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_361 = " = buffersSize_";
  protected final String TEXT_362 = ";";
  protected final String TEXT_363 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_364 = " = buffersSize_";
  protected final String TEXT_365 = ";";
  protected final String TEXT_366 = NL + "        whetherReject_";
  protected final String TEXT_367 = " = false;";
  protected final String TEXT_368 = NL + "                    ";
  protected final String TEXT_369 = NL + "                        query_";
  protected final String TEXT_370 = " = ";
  protected final String TEXT_371 = ";";
  protected final String TEXT_372 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = ", pstmt_";
  protected final String TEXT_375 = ", ";
  protected final String TEXT_376 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_377 = NL + "                globalMap.put(\"";
  protected final String TEXT_378 = "_QUERY\", query_";
  protected final String TEXT_379 = ".toString().trim());";
  protected final String TEXT_380 = NL + "    \t\tpstmt_";
  protected final String TEXT_381 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_382 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_383 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_384 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_385 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_386 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_387 = " = insertedCount_";
  protected final String TEXT_388 = " + pstmt_";
  protected final String TEXT_389 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_390 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_391 = " = true;";
  protected final String TEXT_392 = NL + "                    throw(e);";
  protected final String TEXT_393 = NL + "                        ";
  protected final String TEXT_394 = " = new ";
  protected final String TEXT_395 = "Struct();";
  protected final String TEXT_396 = NL + "                            ";
  protected final String TEXT_397 = ".";
  protected final String TEXT_398 = " = ";
  protected final String TEXT_399 = ".";
  protected final String TEXT_400 = ";";
  protected final String TEXT_401 = NL + "                        rejectedCount_";
  protected final String TEXT_402 = " = rejectedCount_";
  protected final String TEXT_403 = " + 1;";
  protected final String TEXT_404 = NL + "                        ";
  protected final String TEXT_405 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_406 = ";";
  protected final String TEXT_407 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_408 = NL + "            }";
  protected final String TEXT_409 = NL + "                    ";
  protected final String TEXT_410 = NL + "                        query_";
  protected final String TEXT_411 = " = ";
  protected final String TEXT_412 = ";";
  protected final String TEXT_413 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_414 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_421 = NL + "                        query_";
  ...
  protected final String TEXT_433 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_434 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_435 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_436 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_437 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_438 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_439 = " = updatedCount_";
  protected final String TEXT_440 = " + pstmt_";
  protected final String TEXT_441 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_442 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_443 = " = true;";
  protected final String TEXT_444 = NL + "                    throw(e);";
  ...
  protected final String TEXT_453 = NL + "                        rejectedCount_";
  protected final String TEXT_454 = " = rejectedCount_";
  protected final String TEXT_455 = " + 1;";
  protected final String TEXT_456 = NL + "                        ";
  protected final String TEXT_457 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_458 = ";";
  protected final String TEXT_459 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_460 = NL + "            }";
  protected final String TEXT_461 = NL + "\t\t\t\t\t";
  protected final String TEXT_462 = NL + "                    \t";
  protected final String TEXT_463 = NL + "                    ";
  protected final String TEXT_464 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_465 = " = pstmt_";
  protected final String TEXT_466 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_467 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_468 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_469 = " = rs_";
  protected final String TEXT_470 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_471 = " > 0) {";
  protected final String TEXT_472 = NL + "                        ";
  protected final String TEXT_473 = NL + "                            query_";
  protected final String TEXT_474 = " = ";
  protected final String TEXT_475 = ";";
  protected final String TEXT_476 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_477 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_478 = ".";
  protected final String TEXT_479 = ", pstmtUpdate_";
  ...
  protected final String TEXT_488 = NL + "                            query_";
  protected final String TEXT_489 = " = ";
  protected final String TEXT_490 = ";";
  protected final String TEXT_491 = NL + "                    globalMap.put(\"";
  protected final String TEXT_492 = "_QUERY\", query_";
  protected final String TEXT_493 = ".toString().trim());";
  protected final String TEXT_494 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_495 = " = updatedCount_";
  protected final String TEXT_496 = " + pstmtUpdate_";
  protected final String TEXT_497 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_515 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_516 = NL + "                        ";
  protected final String TEXT_517 = NL + "                            query_";
  protected final String TEXT_518 = " = ";
  protected final String TEXT_519 = ";";
  protected final String TEXT_520 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_521 = ".";
  protected final String TEXT_522 = ", pstmtInsert_";
  protected final String TEXT_523 = ", ";
  protected final String TEXT_524 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_525 = NL + "                    globalMap.put(\"";
  protected final String TEXT_526 = "_QUERY\", query_";
  protected final String TEXT_527 = ".toString().trim());";
  protected final String TEXT_528 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_529 = " = insertedCount_";
  protected final String TEXT_530 = " + pstmtInsert_";
  protected final String TEXT_531 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_532 = " = true;";
  protected final String TEXT_533 = NL + "                        throw(e);";
  protected final String TEXT_534 = NL + "                            ";
  protected final String TEXT_535 = " = new ";
  protected final String TEXT_536 = "Struct();";
  protected final String TEXT_537 = NL + "                                ";
  protected final String TEXT_538 = ".";
  protected final String TEXT_539 = " = ";
  protected final String TEXT_540 = ".";
  protected final String TEXT_541 = ";";
  protected final String TEXT_542 = NL + "                            rejectedCount_";
  protected final String TEXT_543 = " = rejectedCount_";
  ...
  protected final String TEXT_548 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_549 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_550 = "++;";
  protected final String TEXT_551 = NL + "            int updateFlag_";
  protected final String TEXT_552 = " = 0;";
  protected final String TEXT_553 = NL + "                    ";
  protected final String TEXT_554 = NL + "                        query_";
  protected final String TEXT_555 = " = ";
  protected final String TEXT_556 = ";";
  protected final String TEXT_557 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_558 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_559 = ".";
  protected final String TEXT_560 = ", pstmtUpdate_";
  ...
  protected final String TEXT_572 = NL + "                globalMap.put(\"";
  protected final String TEXT_573 = "_QUERY\", query_";
  protected final String TEXT_574 = ".toString().trim());";
  protected final String TEXT_575 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_576 = "=pstmtUpdate_";
  protected final String TEXT_577 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_578 = " = updatedCount_";
  protected final String TEXT_579 = "+updateFlag_";
  protected final String TEXT_580 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_597 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_598 = NL + "            }" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_614 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_615 = " = insertedCount_";
  protected final String TEXT_616 = " + pstmtInsert_";
  protected final String TEXT_617 = ".executeUpdate(); " + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_635 = NL + "                }" + NL + "            }" + NL + "            " + NL + "            nb_line_";
  ...
  protected final String TEXT_655 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_656 = " = deletedCount_";
  protected final String TEXT_657 = " + pstmt_";
  protected final String TEXT_658 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_677 = NL + "            nb_line_";
  protected final String TEXT_678 = "++;";
  protected final String TEXT_679 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_690 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_691 = " <= batchSizeCounter_";
  protected final String TEXT_692 = ") {                ";
  protected final String TEXT_693 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_694 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_695 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_696 = " += pstmt_";
  protected final String TEXT_697 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_698 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_699 = " += pstmt_";
  protected final String TEXT_700 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_701 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_702 = " += pstmt_";
  protected final String TEXT_703 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_704 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_705 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_706 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_707 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_708 = NL + "                }";
  protected final String TEXT_709 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_710 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_711 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_712 = " <= commitCounter_";
  protected final String TEXT_713 = ") {" + NL + "                ";
  protected final String TEXT_714 = NL + "                try {" + NL + "                \t";
  protected final String TEXT_715 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_716 = " > 0 ) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_717 = NL + "                \t\tpstmt_";
  protected final String TEXT_718 = ".executeBatch();" + NL + "            \t    \t";
  protected final String TEXT_719 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_720 = " += pstmt_";
  protected final String TEXT_721 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_722 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_723 = " += pstmt_";
  protected final String TEXT_724 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_725 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_726 = " += pstmt_";
  protected final String TEXT_727 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_728 = "  " + NL + "            \t    \t";
  protected final String TEXT_729 = NL + "\t                \tbatchSizeCounter_";
  protected final String TEXT_730 = " = 0;  " + NL + "\t                \t";
  protected final String TEXT_731 = NL + "            \t   ";
  protected final String TEXT_732 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_733 = "          \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_734 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_735 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_736 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_737 = NL + "                \tconn_";
  protected final String TEXT_738 = ".commit();                " + NL + "                \tcommitCounter_";
