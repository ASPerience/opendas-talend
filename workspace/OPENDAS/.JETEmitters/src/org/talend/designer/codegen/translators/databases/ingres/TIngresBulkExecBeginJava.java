...
public class TIngresBulkExecBeginJava {
  ...
  protected final String TEXT_18 = NL + "\t\tjava.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat(\"dd-MMM-yyyy HH:mm:ss\");" + NL + "\t\tString formattedDate = formatter.format(new java.util.Date());" + NL + "\t\tStringBuffer sqlBuffer = new StringBuffer();" + NL + "\t\tsqlBuffer.append(\"/* SQL generated by Talend at \" + formattedDate + \"*/\");" + NL + "\t\tsqlBuffer.append(\"\\n\");" + NL + "\t\tsqlBuffer.append(\"\\n\\\\SQL\");" + NL + "\t\tsqlBuffer.append(\"\\n\\nSET AUTOCOMMIT OFF\");" + NL + "\t\tsqlBuffer.append(\"\\n\\\\p\\\\g\");" + NL + "\t\tsqlBuffer.append(\"\\n\\nSET NOJOURNALING\");" + NL + "\t\tsqlBuffer.append(\"\\n\\\\p\\\\g\");" + NL + "\t\tsqlBuffer.append(\"\\n\\nSET SESSION AUTHORIZATION \" + ";
  protected final String TEXT_19 = ");" + NL + "\t\tsqlBuffer.append(\"\\n\\\\p\\\\g\");";
  protected final String TEXT_20 = NL + "                    // SQL statement added when TRUNCATE_BY_INGRESNET requested" + NL + "                    sqlBuffer.append(\"\\n\\n\");" + NL + "                    sqlBuffer.append(\"MODIFY \" + ";
  protected final String TEXT_21 = " + \" TO TRUNCATED;\");";
  protected final String TEXT_22 = NL + "\t\tsqlBuffer.append(\"\\n\\n\");" + NL + "" + NL + "\t\t// Call Ingres DB manager object to retrieve SQL for COPY" + NL + "" + NL + "\t\tString sqlString  = \"";
  protected final String TEXT_23 = "\";" + NL + "\t\tsqlBuffer.append(sqlString);" + NL + "\t\tsqlBuffer.append(\"\\nFROM \");" + NL + "\t\tsqlBuffer.append(\"\\n\");" + NL + "\t\tsqlBuffer.append(\"'\" + ";
  protected final String TEXT_24 = " + \"'\");" + NL + "\t\tsqlBuffer.append(\"\\n\");" + NL + "\t\tsqlBuffer.append(\"WITH\");" + NL + "\t\tsqlBuffer.append(\"\\n ROLLBACK=\" + \"";
  protected final String TEXT_25 = "\");\t\t" + NL + "\t\tsqlBuffer.append(\",\\n ON_ERROR=\" + \"";
  protected final String TEXT_26 = "\");\t" + NL + "\t\t" + NL + "\t\t// error count parameter should only be set if Terminate On Error has been selected. " + NL + "" + NL + "\t\t";
  protected final String TEXT_27 = NL + NL + "                        // If user has entered an Error Count value less than 1, co-erce the value " + NL + "                        // to 1 (lesser values do not make sense). " + NL + "" + NL + " " + NL + "" + NL + "\t\t\t\tsqlBuffer.append(\",\\n ERROR_COUNT=\" + ";
  protected final String TEXT_28 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_29 = NL + "\t\t";
  protected final String TEXT_30 = NL + "\t\t\tsqlBuffer.append(\",\\n LOG=\" + \"'\" + ";
  protected final String TEXT_31 = " + \"'\");\t" + NL + "\t\t";
  protected final String TEXT_32 = NL + "\t\t";
  protected final String TEXT_33 = NL + "\t\t\tsqlBuffer.append(\",\\n ALLOCATION=\" + ";
  protected final String TEXT_34 = ");" + NL + "\t\t";
  protected final String TEXT_35 = NL + "\t\t";
  protected final String TEXT_36 = NL + "\t\t\tsqlBuffer.append(\",\\n EXTEND=\" + ";
  protected final String TEXT_37 = ");" + NL + "\t\t\t";
  protected final String TEXT_38 = NL + "\t\t";
  protected final String TEXT_39 = NL + "\t\t\tsqlBuffer.append(\",\\n FILLFACTOR=\" + ";
  protected final String TEXT_40 = ");" + NL + "\t\t\t";
  protected final String TEXT_41 = "\t\t" + NL + "\t\t";
  protected final String TEXT_42 = NL + "\t\t\tsqlBuffer.append(\",\\n MINPAGES=\" + ";
  protected final String TEXT_43 = ");" + NL + "\t\t\t";
  protected final String TEXT_44 = NL + "\t\t";
  protected final String TEXT_45 = NL + "\t\t\tsqlBuffer.append(\",\\n MAXPAGES=\" + ";
  protected final String TEXT_46 = ");" + NL + "\t\t\t";
  protected final String TEXT_47 = NL + "\t\t";
  protected final String TEXT_48 = NL + "\t\t\tsqlBuffer.append(\",\\n LEAFFILL=\" + ";
  protected final String TEXT_49 = ");" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "\t\t";
  protected final String TEXT_51 = NL + "\t\t\tsqlBuffer.append(\",\\n NONLEAFFILL=\" + ";
  protected final String TEXT_52 = ");" + NL + "\t\t\t";
  protected final String TEXT_53 = NL + "\t\t";
  protected final String TEXT_54 = NL + "\t\t\tsqlBuffer.append(\",\\n ROW_ESTIMATE=\" + ";
  protected final String TEXT_55 = ");" + NL + "\t\t\t";
  protected final String TEXT_56 = NL + "\t\tsqlBuffer.append(\";\\n\");" + NL + "" + NL + "            // Note the \"go block\" extends from MODIFY though COPY and COMMIT ... this helps the" + NL + "            // MODIFY to be rolled back if an error occurs in the COPY. " + NL + "            // Following ROLLBACK is only effective when this happens." + NL + "" + NL + "            sqlBuffer.append(\"\\nCOMMIT\");" + NL + "            sqlBuffer.append(\"\\n\\\\p\\\\g\");" + NL + "" + NL + "            sqlBuffer.append(\"\\n\\nROLLBACK\");" + NL + "            sqlBuffer.append(\"\\n\\\\p\\\\g\");" + NL + "" + NL + "\t\tsqlBuffer.append(\"\\n\\n/* End of SQL file generated by Talend */\");" + NL + "" + NL + "\t/***********************************************************************/" + NL + "\t/** Retrieve current TEMP directory.                                  **/" + NL + "\t/***********************************************************************/\t" + NL + "\t\t\t" + NL + "      String tempDirectoryPath = System.getProperty(\"java.io.tmpdir\");" + NL + "      String fileNameAndPath = \"\";" + NL + "      String sqlFileAndPath = \"\";" + NL + "      String executableFilePath = \"\";" + NL + "      String executableExtension = \"\";" + NL + "      String timestamp = \"\";" + NL + "" + NL + "\t/***********************************************************************/" + NL + "\t/** Determine OS to create correct executable extension               **/" + NL + "\t/***********************************************************************/" + NL + "\t\t" + NL + "\t\tString OS = System.getProperty(\"os.name\").toLowerCase();" + NL + "\t\tif (OS.indexOf(\"windows\") > -1 || OS.indexOf(\"nt\") > -1 )" + NL + "\t\t{" + NL + "\t\t\texecutableExtension = \".bat\";" + NL + "\t\t}" + NL + "\t\telse " + NL + "\t\t{" + NL + "\t\t\texecutableExtension = \".sh\";" + NL + "\t\t}" + NL + "" + NL + "\t/***********************************************************************/" + NL + "\t/** Write SQL file and executable to TEMP DIR.                        **/" + NL + "\t/***********************************************************************/" + NL + "\t\ttry {" + NL + "\t\t      java.text.SimpleDateFormat timestampFormatter = new java.text.SimpleDateFormat(\"yyyyMMddHHmmss\");" + NL + "                  timestamp = timestampFormatter.format(new java.util.Date());" + NL + "                  fileNameAndPath = tempDirectoryPath + \"ingres_sql_\" + timestamp;" + NL + "" + NL + "\t\t\tsqlFileAndPath     = fileNameAndPath + \".sql\";" + NL + "\t\t\texecutableFilePath = fileNameAndPath + executableExtension;" + NL + "" + NL + "\t\t\tjava.io.FileWriter fstream = new java.io.FileWriter(sqlFileAndPath);" + NL + "\t\t\tjava.io.BufferedWriter out = new java.io.BufferedWriter(" + NL + "\t\t\t\t\tfstream);" + NL + "\t\t\tout.write(sqlBuffer.toString());" + NL + "\t\t\tout.close();" + NL + "" + NL + "\t\t\tfstream = new java.io.FileWriter(executableFilePath);" + NL + "\t\t\tout = new java.io.BufferedWriter(fstream);" + NL;
  protected final String TEXT_57 = NL + "                      // Set Ingres environment variables which allow the table " + NL + "                      // truncate statement to be rolled back if the copy fails." + NL + "                      out.write(\"set II_TM_ON_ERROR=NOCONTINUE\\n\");" + NL + "                      out.write(\"set II_TM_SWITCH=true\\n\");";
  protected final String TEXT_58 = NL + NL + "\t\t\tout.write(\"sql \" +  db_for_Copy";
  protected final String TEXT_59 = " + \" < \" + sqlFileAndPath );" + NL + "\t\t\tout.close();" + NL + "\t\t} catch (Exception e) {" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t}\t" + NL + "\t/***********************************************************************/" + NL + "\t/** Trigger executable to execute SQL against DB.                     **/" + NL + "\t/***********************************************************************/" + NL + "\t\t" + NL + "\t\tRuntime runtime_";
  protected final String TEXT_60 = " = Runtime.getRuntime();" + NL + "\t\tfinal Process ps_";
  protected final String TEXT_61 = " = runtime_";
  protected final String TEXT_62 = ".exec(executableFilePath);          " + NL + "\t\t";
  protected final String TEXT_63 = NL + NL + "\t/***********************************************************************/" + NL + "\t/** Create two threads to monitor above process without blocking      **/" + NL + "\t/** logic executing. One thread prints standard console output, the   **/" + NL + "\t/** other prints the error stream.                                    **/" + NL + "\t/***********************************************************************/" + NL + "\t" + NL + "\t" + NL + "\t// standard output monitor " + NL + "\tThread normal_";
  protected final String TEXT_64 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_65 = ".getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_66 = NL + "\t\t\t\t\t        System.out.println(line);" + NL + "\t\t\t\t\t        ";
  protected final String TEXT_67 = NL + "\t\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_68 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_69 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t        ";
  protected final String TEXT_70 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\tnormal_";
  protected final String TEXT_71 = ".start();" + NL + "" + NL + "\t// error output monitor" + NL + "\tThread error_";
  ...
  protected final String TEXT_73 = ".getErrorStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_74 = NL + "\t\t\t\t\t        System.err.println(line);" + NL + "\t\t\t\t\t        ";
  protected final String TEXT_75 = NL + "\t\t\t\t\t        globalMap.put(\"";
  protected final String TEXT_76 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_77 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t        ";
  protected final String TEXT_78 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\terror_";
  protected final String TEXT_79 = ".start();" + NL + "\t" + NL + "\tps_";
  protected final String TEXT_80 = ".waitFor();" + NL + "\tnormal_";
  protected final String TEXT_81 = ".interrupt();" + NL + "\terror_";
  protected final String TEXT_82 = ".interrupt();" + NL;
  protected final String TEXT_83 = NL + NL + "       \t/***********************************************************************/" + NL + "\t/** Delete working files if not requested to keep them.               **/" + NL + "\t/***********************************************************************/" + NL + "            try {" + NL + "" + NL + "                java.io.File f = new java.io.File(sqlFileAndPath);" + NL + "" + NL + "                boolean deletedOK = f.delete();" + NL + "" + NL + "                if (!deletedOK )" + NL + "                    throw new IllegalArgumentException(\"Failed to delete \" + sqlFileAndPath);" + NL + "" + NL + "                f = new java.io.File(executableFilePath);" + NL + "" + NL + "                deletedOK = f.delete();" + NL + "" + NL + "                if (!deletedOK )" + NL + "                    throw new IllegalArgumentException(\"Failed to delete \" + sqlFileAndPath);" + NL + "                    " + NL + "                } catch (Exception e) {" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t    }";
