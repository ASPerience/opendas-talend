...
public class TSugarCRMInputBeginJava
{
  ...
  protected final String TEXT_34 = ", 0, 100); " + NL + "" + NL + "        // read the record from remote, one time 100 records." + NL + "        while (getEntryListResult_";
  protected final String TEXT_35 = ".getResult_count() != 0) {" + NL + "            org.talend.sugarws.Entry_value[] entry_value_";
  protected final String TEXT_36 = " = getEntryListResult_";
  protected final String TEXT_37 = ".getEntry_list();" + NL + "            // get every record" + NL + "            for (int i_";
  protected final String TEXT_38 = " = 0; i_";
  protected final String TEXT_39 = " < entry_value_";
  protected final String TEXT_40 = ".length; i_";
  protected final String TEXT_41 = "++) {" + NL + "                org.talend.sugarws.Name_value[] nameValue_";
  protected final String TEXT_42 = " = entry_value_";
  protected final String TEXT_43 = "[i_";
  protected final String TEXT_44 = "].getName_value_list(); " + NL + "        \t\tnb_line_";
  protected final String TEXT_45 = "++;" + NL + "                " + NL + "//////////       " + NL;
  protected final String TEXT_46 = NL + NL + "\t\t\t";
  protected final String TEXT_47 = NL + "\t\t\tString crmReturnValue_";
  protected final String TEXT_48 = ";";
  protected final String TEXT_49 = NL + "\t\t\t\t\t\t" + NL + "\t\t\tcrmReturnValue_";
  protected final String TEXT_50 = " = util_";
  protected final String TEXT_51 = ".getFieldbyOrder(";
  protected final String TEXT_52 = ", filedArr_";
  protected final String TEXT_53 = ", nameValue_";
  protected final String TEXT_54 = ");" + NL + "\t\t\tif(!\"\".equals(crmReturnValue_";
  protected final String TEXT_55 = ")){\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\t\t";
  protected final String TEXT_57 = ".";
  protected final String TEXT_58 = " = crmReturnValue_";
  protected final String TEXT_59 = ";";
  protected final String TEXT_60 = NL + "\t\t\t\t\t";
  protected final String TEXT_61 = ".";
  protected final String TEXT_62 = " = ParserUtils.parseTo_Date(crmReturnValue_";
  protected final String TEXT_63 = ", ";
  protected final String TEXT_64 = ");";
  protected final String TEXT_65 = NL + "\t\t\t\t\t";
  protected final String TEXT_66 = ".";
  protected final String TEXT_67 = " = crmReturnValue_";
  protected final String TEXT_68 = ".getBytes();" + NL + "\t";
  protected final String TEXT_69 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_70 = ".";
  protected final String TEXT_71 = " = ParserUtils.parseTo_";
  protected final String TEXT_72 = "(crmReturnValue_";
