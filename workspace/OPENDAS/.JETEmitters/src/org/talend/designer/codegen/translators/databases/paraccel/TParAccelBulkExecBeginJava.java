...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_170 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_173 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_176 = ".execute(xpxSQL_";
  protected final String TEXT_177 = ");" + NL + "    stmtXPX_";
  protected final String TEXT_178 = ".close();    ";
  protected final String TEXT_179 = NL + "    stmtBulk_";
  protected final String TEXT_180 = ".execute(bulkSQL_";
  protected final String TEXT_181 = ");" + NL + "    stmtBulk_";
