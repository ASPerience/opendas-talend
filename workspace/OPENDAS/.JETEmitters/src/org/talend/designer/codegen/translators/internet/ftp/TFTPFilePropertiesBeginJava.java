...
public class TFTPFilePropertiesBeginJava
{
  ...
  protected final String TEXT_120 = NL + "  String remoteDir_";
  protected final String TEXT_121 = " = ";
  protected final String TEXT_122 = ".replaceAll(\"\\\\\\\\\", \"/\");";
  protected final String TEXT_123 = NL + "  ";
  protected final String TEXT_124 = " = new ";
  protected final String TEXT_125 = "Struct();" + NL + "  String remoteFile_";
  protected final String TEXT_126 = " = ";
  protected final String TEXT_127 = " + \"/\" + ";
  protected final String TEXT_128 = ";" + NL + "" + NL + "  if (ftp_";
  protected final String TEXT_129 = ".exists(remoteFile_";
  protected final String TEXT_130 = ")) {";
  protected final String TEXT_131 = NL + "    ";
  protected final String TEXT_132 = ".abs_path = (remoteFile_";
  protected final String TEXT_133 = ").replaceAll(\"//\", \"/\");";
  protected final String TEXT_134 = NL + "    ";
  protected final String TEXT_135 = ".dirname = ";
  protected final String TEXT_136 = ";";
  protected final String TEXT_137 = NL + "    ";
  protected final String TEXT_138 = ".basename = ";
  protected final String TEXT_139 = ";";
  protected final String TEXT_140 = NL + "    ";
  protected final String TEXT_141 = ".size = ftp_";
  protected final String TEXT_142 = ".size(remoteFile_";
  protected final String TEXT_143 = ");";
  protected final String TEXT_144 = NL + "    ";
  protected final String TEXT_145 = ".mtime = ftp_";
  protected final String TEXT_146 = ".modtime(remoteFile_";
  protected final String TEXT_147 = ").getTime();";
  protected final String TEXT_148 = NL + "    ";
  protected final String TEXT_149 = ".mtime_string =ftp_";
  protected final String TEXT_150 = ".modtime(remoteFile_";
  protected final String TEXT_151 = ").toString();" + NL;
  protected final String TEXT_152 = NL + "      // Calculation of the Message Digest MD5" + NL + "      java.security.MessageDigest dgs_";
  protected final String TEXT_153 = " = java.security.MessageDigest.getInstance(\"MD5\");" + NL + "      dgs_";
  protected final String TEXT_154 = ".update(ftp_";
  protected final String TEXT_155 = ".get(remoteFile_";
  protected final String TEXT_156 = "));";
  protected final String TEXT_157 = NL + "      ";
  protected final String TEXT_158 = ".md5 =new java.math.BigInteger(1, dgs_";
  protected final String TEXT_159 = ".digest()).toString(16);";
