...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_268 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_314 = "\";" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_315 = " = conn_";
  protected final String TEXT_316 = ".prepareStatement(update_";
  protected final String TEXT_317 = ");" + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_324 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_325 = " = conn_";
  protected final String TEXT_326 = ".prepareStatement(delete_";
  protected final String TEXT_327 = ");" + NL + "\t    ";
  protected final String TEXT_328 = NL + "        StringBuffer query_";
  protected final String TEXT_329 = " = null;" + NL + "       \t";
  protected final String TEXT_330 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_340 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_341 = " = insert_";
  protected final String TEXT_342 = ".split(\"\\\\?\");";
  protected final String TEXT_343 = NL + "\t\t\tdelete_";
  protected final String TEXT_344 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_345 = " = delete_";
  protected final String TEXT_346 = ".split(\"\\\\?\");";
  protected final String TEXT_347 = NL + "\t\t\treplace_";
  protected final String TEXT_348 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_349 = " = replace_";
  protected final String TEXT_350 = ".split(\"\\\\?\");";
  protected final String TEXT_351 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_352 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_353 = " = insertIgnore_";
  ...
  protected final String TEXT_359 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_360 = " = buffersSize_";
  protected final String TEXT_361 = ";";
  protected final String TEXT_362 = NL + "\t\t\t\t\tbatchSize_";
  protected final String TEXT_363 = " = buffersSize_";
  ...
  protected final String TEXT_382 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_383 = "++;    \t\t " + NL + "\t\t\t";
  protected final String TEXT_384 = NL + "    \t\t  \tbatchSizeCounter_";
  ...
  protected final String TEXT_576 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_577 = "=pstmtUpdate_";
  protected final String TEXT_578 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_579 = " = updatedCount_";
  protected final String TEXT_580 = " + updateFlag_";
  protected final String TEXT_581 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_598 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_599 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_600 = " == 0) {" + NL + "            \t";
  protected final String TEXT_601 = NL + "\t\t\t\tquery_";
  protected final String TEXT_602 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_603 = NL + "                        ";
  protected final String TEXT_604 = NL + "                            query_";
  protected final String TEXT_605 = " = ";
  protected final String TEXT_606 = ";";
  protected final String TEXT_607 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_618 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_635 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_636 = NL + "                }" + NL + "                " + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_656 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_657 = " = deletedCount_";
  ...
  protected final String TEXT_678 = NL + "            nb_line_";
  protected final String TEXT_679 = "++;";
  protected final String TEXT_680 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_691 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_692 = " <= batchSizeCounter_";
  protected final String TEXT_693 = ") {                ";
  protected final String TEXT_694 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_695 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_696 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_697 = " += pstmt_";
  protected final String TEXT_698 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_699 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_700 = " += pstmt_";
  protected final String TEXT_701 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_702 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_703 = " += pstmt_";
  protected final String TEXT_704 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_705 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_706 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_707 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_708 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_709 = NL + "                }";
  protected final String TEXT_710 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_711 = NL + "            commitCounter_";
  protected final String TEXT_712 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_713 = "<=commitCounter_";
  protected final String TEXT_714 = ") {" + NL + "            " + NL + "                conn_";
  protected final String TEXT_715 = ".commit();" + NL + "                " + NL + "                commitCounter_";
  protected final String TEXT_716 = " = 0;" + NL + "            " + NL + "            }" + NL + "        ";
