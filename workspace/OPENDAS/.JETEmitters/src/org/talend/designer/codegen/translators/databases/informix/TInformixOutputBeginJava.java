...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_135 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_163 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_176 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_187 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_207 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_208 = ".execute(\"";
  protected final String TEXT_209 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_210 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".createStatement();";
  ...
  protected final String TEXT_232 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_233 = ", true);" + NL + "\t\t\t}";
  protected final String TEXT_234 = "            ";
  protected final String TEXT_235 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_236 = " = conn_";
  protected final String TEXT_237 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_238 = ".executeUpdate(\"";
  protected final String TEXT_239 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_240 = ".close();";
  protected final String TEXT_241 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_244 = " = stmtTruncCount_";
  protected final String TEXT_245 = ".executeQuery(\"";
  protected final String TEXT_246 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_247 = " = conn_";
  protected final String TEXT_248 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_249 = ".executeUpdate(\"";
  protected final String TEXT_250 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_251 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_252 = " += rsTruncCount_";
  protected final String TEXT_253 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_254 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_255 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_261 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_281 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_282 = " = conn_";
  protected final String TEXT_283 = ".prepareStatement(insert_";
  protected final String TEXT_284 = ");" + NL + "\t    String update_";
  protected final String TEXT_285 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_286 = " + \" SET ";
  protected final String TEXT_287 = " WHERE ";
  protected final String TEXT_288 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_289 = " = conn_";
  protected final String TEXT_290 = ".prepareStatement(update_";
  ...
  protected final String TEXT_307 = NL + "\t    String delete_";
  protected final String TEXT_308 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_312 = ".prepareStatement(delete_";
  protected final String TEXT_313 = ");" + NL + "\t    ";
  protected final String TEXT_314 = NL + "        StringBuffer query_";
  protected final String TEXT_315 = " = null;" + NL + "       \t";
  protected final String TEXT_316 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_317 = " = insert_";
  protected final String TEXT_318 = ".split(\"\\\\?\");";
  protected final String TEXT_319 = NL + "\t\t\tupdate_";
  protected final String TEXT_320 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_321 = " = update_";
  protected final String TEXT_322 = ".split(\"\\\\?\");";
  protected final String TEXT_323 = NL + "\t\t\tupdate_";
  protected final String TEXT_324 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_325 = " = update_";
  protected final String TEXT_326 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_327 = " = insert_";
  protected final String TEXT_328 = ".split(\"\\\\?\");";
  protected final String TEXT_329 = NL + "\t\t\tdelete_";
  protected final String TEXT_330 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_331 = " = delete_";
  protected final String TEXT_332 = ".split(\"\\\\?\");";
  protected final String TEXT_333 = NL + "\t\t\treplace_";
  protected final String TEXT_334 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_335 = " = replace_";
  protected final String TEXT_336 = ".split(\"\\\\?\");";
  protected final String TEXT_337 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_338 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_339 = " = insertIgnore_";
  ...
  protected final String TEXT_344 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_345 = " = ";
  protected final String TEXT_346 = ";" + NL + "        " + NL + "        int commitCounter_";
