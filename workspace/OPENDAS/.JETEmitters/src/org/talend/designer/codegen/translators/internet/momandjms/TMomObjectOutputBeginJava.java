...
public class TMomObjectOutputBeginJava
{
  protected static String nl;
  public static synchronized TMomObjectOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMomObjectOutputBeginJava result = new TMomObjectOutputBeginJava();
    nl = null;
    return result;
  }
