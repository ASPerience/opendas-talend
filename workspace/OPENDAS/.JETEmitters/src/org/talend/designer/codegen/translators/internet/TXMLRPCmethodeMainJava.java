...
public class TXMLRPCmethodeMainJava
{
  protected static String nl;
  public static synchronized TXMLRPCmethodeMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TXMLRPCmethodeMainJava result = new TXMLRPCmethodeMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_31 = ".station;" + NL + "/* ECRIRE NOUVELLE REQUÊTE" + NL + "" + NL + "\t// exemple pour le renvoi de SSCC :" + NL + "" + NL + "" + NL + "" + NL + "" + NL + "" + NL + "" + NL + "\t//Paramétrage de la requête name_get" + NL + "\tObject[] params_";
  ...
  protected final String TEXT_51 = "};" + NL + "\t//les 4 premiers champs ne serviront qu'à former l'objet previousRequest contenu dans la réponse au DAS" + NL + "\t//le dernier champ (ssccObject_";
  protected final String TEXT_52 = "), est l'objet attachement qui sera envoyé avec le ServerRequest pour répondre au DAS" + NL + "\t" + NL + "\t" + NL + "*/" + NL + "" + NL + "      for (int i_";
